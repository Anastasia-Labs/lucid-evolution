...
**Fees** are calculated automatically based on your transaction's size and any execution units used (for smart contracts). Evolution library handles this calculation for you, and fees are *-for now-* always (looking at you [babel fees](https://iohk.io/en/blog/posts/2021/02/25/babel-fees/)) paid in ADA (lovelace).
...
- Values use BigInt notation (append `n` to numbers)
