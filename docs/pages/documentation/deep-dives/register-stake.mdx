...
For script stake credentials that require a certificate witness, attach the certificate validator and pass the registration redeemer:
...
Omitting the redeemer uses the witnessless stake-registration certificate. Passing a redeemer uses the witnessed registration certificate and attaches the matching certificate validator.
