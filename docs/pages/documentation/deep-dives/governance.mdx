...
The Conway era introduces significant on-chain governance features to the Cardano blockchain,
...
<Tabs items={['for ADA holders', 'for DReps']}>
  <Tabs.Tab>
    As an ADA holder, you can participate in governance by delegating your voting power or voting directly.
    
    <Tabs items={['Delegate Voting Power', 'Predefined Strategies', 'Complete Examples']}>
      <Tabs.Tab>
...
<details>
  ...
  `Certificate.new_vote_deleg_cert` method in CML. 
