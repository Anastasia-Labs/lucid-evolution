...
const scriptInputs: UTxO[] = [
    { txHash: "a", outputIndex: 0, address: "scriptAddress", assets: { lovelace } },
    { txHash: "b", outputIndex: 1, address: "scriptAddress", assets: { lovelace } },
    { txHash: "c", outputIndex: 2, address: "scriptAddress", assets: { lovelace } },
];
const randomInputs: UTxO[] = [
    { txHash: "d", outputIndex: 3, address: "randomAddress", assets: { lovelace } },
    { txHash: "e", outputIndex: 4, address: "randomAddress", assets: { lovelace } },
    { txHash: "f", outputIndex: 5, address: "randomAddress", assets: { lovelace } },
];
