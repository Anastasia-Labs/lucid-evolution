...
<div className="fade-in">
  <Hero
    ...
    subtitle="A highly scalable, production-ready transaction builder and off-chain framework for dApps and developers on Cardano"
    ctaText="Start here"
    ctaLink="/install"
    ctaText2="Learn more"
...
<Steps>
<span style={{color: '#AD1F1E'}}>→</span> <span style={{color: '#AD1F1E'}}>**Instantiate**</span> Lucid Evolution and choose a provider
<Cards>
  <Cards.Card
