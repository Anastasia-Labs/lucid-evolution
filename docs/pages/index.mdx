...
<FAQBox title="How can I get help with Lucid Evolution?">
...
style={{
        position: "relative",
        height: isMobile ? 'auto' : componentHeight,
        overflow: "hidden",
        borderRadius: "8px",
...
style={{
          ...
          height: isMobile ? "30px" : headerHeight,
...
make_payment.ts
      ...
      <div
        style={{
          ...
          height: isMobile ? 'auto' : `calc(100% - ${headerHeight})`,
        }}
      >
        <pre
          style={{
            backgroundColor: "transparent",
            height: isMobile ? 'auto' : codeHeight,
            overflow: "auto",
            margin: 0,
        ...
        <div
          style={{
            ...
            minHeight: isMobile ? '120px' : terminalHeight,
            overflow: "hidden",
            display: "flex",
