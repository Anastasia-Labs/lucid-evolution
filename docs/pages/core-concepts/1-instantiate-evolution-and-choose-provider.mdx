---
title: "1 - Instantiate Lucid Evolution"
---
...
We support the `Mainnet`, `Preprod`, and `Preview` networks, with Mainnet being the default selection if no network is specified. 
...
*Reminder*: In Lucid Evolution, `Lucid.new()` has been replaced with `Lucid()`, as it's now a factory function instead of a class.
