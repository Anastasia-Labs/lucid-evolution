...
console.log("Transaction Submitted:", txHash);`}
            ...
            <div className="w-[calc(100dvw-32px)] md:w-[22dvw]">
              ...
              <FaqBox title="Improved APIs" open>
                <p>
                  ...
                  streamlined for common operations. With Lucid-Evolution, you take advantage of
                  built-in support for popular features, reducing the need for external
                  dependencies.
                </p>
              </FaqBox>
              ...
              <FaqBox title="Latest CML">
                <p>
                  We are keeping up with the latest version of the <Link href="https://dcspark.github.io/cardano-multiplatform-lib">Cardano Multi-platform Library (CML)</Link>.
                </p>
              </FaqBox>
              ...
              <FaqBox title="Developer Centric">
                <div className="space-y-2">
                  ...
                  <p>
                    You can get support for your questions through our dedicated <Link href="https://discord.gg/s89P9gpEff">Discord</Link> channel.
                  </p>
                </div>
              </FaqBox>
            </div>
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div>
          <Steps>
            ...
            <p>Initialize a new <code className="border-[rgba(0,0,0,0.04)] bg-[rgba(0,0,0,0.03)] break-words rounded-md py-0.5 px-[0.25em] text-[0.9em] dark:border-white/10 dark:bg-white/10" dir="ltr">TypeScript</code> project</p>

            <h3>Install the packages you need</h3>
            <Cards>
              <Cards.Card
                title="Intallation Guide"
                href="/install"
              />
            </Cards>
      ...
      <div className="flex flex-col gap-6 items-center text-center w-[calc(100dvw-32px)] md:w-full">
        <h2 className="font-bold text-4xl tracking-tight">
          See <span className="text-[#ad1f1e]">Lucid-Evolution</span> in Motion
        </h2>
      ...
      <div className="flex flex-col items-center w-full gap-3">
        ...
        <div className="w-[calc(100dvw-32px)] md:min-w-2/5 md:max-w-2/5">
          ...
          <FaqBox title="How can I get help?">
            <div className="space-y-2">
              <p>
                You can join the Anastasia-Labs <Link href="https://discord.gg/s89P9gpEff">Discord channel</Link>
                to get help from the community and our team.
              </p>
              <p>
                We also have a dedicated channel for Lucid-Evolution where you can ask questions,
                share your ideas, and get help with your projects
              </p>
            </div>
          </FaqBox>
        </div>
