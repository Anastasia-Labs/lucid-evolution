 ...
 * @category Methods
 */
export const free: (instance: CML.AddrAttributes) => Effect.Effect<void, AddrAttributesError> = Effect.fn(
 ...
 */
export const newBootstrapEra: (hdap: CML.HDAddressPayload, protocolMagic: CML.ProtocolMagic) => Effect.Effect<CML.AddrAttributes, AddrAttributesError> = Effect.fn(function* (hdap: CML.HDAddressPayload, protocolMagic: CML.ProtocolMagic) {
 ...
 */
export const newBootstrapEraUnsafe = (hdap: CML.HDAddressPayload, protocolMagic: CML.ProtocolMagic): CML.AddrAttributes =>
 ...
 * @category Constructors
 */
export const newSingleKey: (pubk: CML.Bip32PublicKey, hdap: CML.HDAddressPayload | undefined, protocolMagic: CML.ProtocolMagic) => Effect.Effect<CML.AddrAttributes, AddrAttributesError> = Effect.fn(function* (pubk: CML.Bip32PublicKey, hdap: CML.HDAddressPayload | undefined, protocolMagic: CML.ProtocolMagic) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newSingleKeyUnsafe = (pubk: CML.Bip32PublicKey, hdap: CML.HDAddressPayload | undefined, protocolMagic: CML.ProtocolMagic): CML.AddrAttributes =>
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.AddrAttributes) => Effect.Effect<Uint8Array, AddrAttributesError> = Effect.fn(
  (instance: CML.AddrAttributes) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.AddrAttributes, AddrAttributesError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.AddrAttributes =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.AddrAttributes) => Effect.Effect<string, AddrAttributesError> = Effect.fn(
  (instance: CML.AddrAttributes) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.AddrAttributes, AddrAttributesError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const setStakeDistribution: (instance: CML.AddrAttributes, stakeDistribution: CML.StakeDistribution) => Effect.Effect<void, AddrAttributesError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setStakeDistributionUnsafe = (instance: CML.AddrAttributes, stakeDistribution: CML.StakeDistribution): void =>
 ...
 * @category Methods
 */
export const stakeDistribution: (instance: CML.AddrAttributes) => Effect.Effect<CML.StakeDistribution | undefined, AddrAttributesError> = Effect.fn(
  (instance: CML.AddrAttributes) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const stakeDistributionUnsafe = (instance: CML.AddrAttributes): CML.StakeDistribution | undefined =>
 ...
 * @category Methods
 */
export const setDerivationPath: (instance: CML.AddrAttributes, derivationPath: CML.HDAddressPayload) => Effect.Effect<void, AddrAttributesError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setDerivationPathUnsafe = (instance: CML.AddrAttributes, derivationPath: CML.HDAddressPayload): void =>
 ...
 * @category Methods
 */
export const derivationPath: (instance: CML.AddrAttributes) => Effect.Effect<CML.HDAddressPayload | undefined, AddrAttributesError> = Effect.fn(
  (instance: CML.AddrAttributes) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const derivationPathUnsafe = (instance: CML.AddrAttributes): CML.HDAddressPayload | undefined =>
 ...
 * @category Methods
 */
export const setProtocolMagic: (instance: CML.AddrAttributes, protocolMagic: CML.ProtocolMagic) => Effect.Effect<void, AddrAttributesError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setProtocolMagicUnsafe = (instance: CML.AddrAttributes, protocolMagic: CML.ProtocolMagic): void =>
 ...
 * @category Methods
 */
export const protocolMagic: (instance: CML.AddrAttributes) => Effect.Effect<CML.ProtocolMagic | undefined, AddrAttributesError> = Effect.fn(
  (instance: CML.AddrAttributes) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const protocolMagicUnsafe = (instance: CML.AddrAttributes): CML.ProtocolMagic | undefined =>
 ...
 * @category Constructors
 */
export const _new: () => Effect.Effect<CML.AddrAttributes, AddrAttributesError> = Effect.fn(function* () {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (): CML.AddrAttributes =>
  Effect.runSync(_new());
