 ...
 */
export const newBootstrapEraUnsafe = (hdap: CML.HDAddressPayload, protocolMagic: CML.ProtocolMagic) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newSingleKeyUnsafe = (pubk: CML.Bip32PublicKey, hdap: CML.HDAddressPayload | undefined, protocolMagic: CML.ProtocolMagic) =>
