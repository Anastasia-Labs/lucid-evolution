 ...
 * @category Methods
 */
export const free: (instance: CML.IntList) => Effect.Effect<void, IntListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.IntList, IntListError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.IntList =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.IntList) => Effect.Effect<number, IntListError> = Effect.fn(
  (instance: CML.IntList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.IntList, index: number) => Effect.Effect<CML.Int, IntListError> = Effect.fn(
 ...
 * @category Methods
 */
export const add: (instance: CML.IntList, elem: CML.Int) => Effect.Effect<void, IntListError> = Effect.fn(
