 ...
 * @category Methods
 */
export const free: (instance: CML.LegacyDaedalusPrivateKey) => Effect.Effect<void, LegacyDaedalusPrivateKeyError> = Effect.fn(
 ...
 * @category Methods
 */
export const chaincode: (instance: CML.LegacyDaedalusPrivateKey) => Effect.Effect<Uint8Array, LegacyDaedalusPrivateKeyError> = Effect.fn(
  (instance: CML.LegacyDaedalusPrivateKey) =>
    Effect.try({
