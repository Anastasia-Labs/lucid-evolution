...
) => Effect.Effect<void, ScriptAllError> = Effect.fn(
  (instance: CML.ScriptAll) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.ScriptAll,
) => Effect.Effect<Uint8Array, ScriptAllError> = Effect.fn(
  (instance: CML.ScriptAll) =>
    Effect.try({
...
) => Effect.Effect<CML.ScriptAll, ScriptAllError> = Effect.fn(function* (
  cborBytes: Uint8Array,
) {
...
export const toCborHex: (
  instance: CML.ScriptAll,
) => Effect.Effect<string, ScriptAllError> = Effect.fn(
  (instance: CML.ScriptAll) =>
    Effect.try({
...
export const toJsValue: (
  instance: CML.ScriptAll,
) => Effect.Effect<any, ScriptAllError> = Effect.fn((instance: CML.ScriptAll) =>
  Effect.try({
...
export const nativeScripts: (
  instance: CML.ScriptAll,
) => Effect.Effect<CML.NativeScriptList, ScriptAllError> = Effect.fn(
  (instance: CML.ScriptAll) =>
    Effect.try({
...
export const _newUnsafe = (
  nativeScripts: CML.NativeScriptList,
): CML.ScriptAll => Effect.runSync(_new(nativeScripts));
