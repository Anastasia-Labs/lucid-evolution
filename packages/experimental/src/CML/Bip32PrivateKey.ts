 ...
 * @category Methods
 */
export const free: (instance: CML.Bip32PrivateKey) => Effect.Effect<void, Bip32PrivateKeyError> = Effect.fn(
 ...
 * @category Methods
 */
export const derive: (instance: CML.Bip32PrivateKey, index: number) => Effect.Effect<CML.Bip32PrivateKey, Bip32PrivateKeyError> = Effect.fn(
 ...
 */
export const from_128Xprv: (bytes: Uint8Array) => Effect.Effect<CML.Bip32PrivateKey, Bip32PrivateKeyError> = Effect.fn(function* (bytes: Uint8Array) {
 ...
 * @category Methods
 */
export const to_128Xprv: (instance: CML.Bip32PrivateKey) => Effect.Effect<Uint8Array, Bip32PrivateKeyError> = Effect.fn(
  (instance: CML.Bip32PrivateKey) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const generateEd25519Bip32: () => Effect.Effect<CML.Bip32PrivateKey, Bip32PrivateKeyError> = Effect.fn(function* () {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toRawKey: (instance: CML.Bip32PrivateKey) => Effect.Effect<CML.PrivateKey, Bip32PrivateKeyError> = Effect.fn(
  (instance: CML.Bip32PrivateKey) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toPublic: (instance: CML.Bip32PrivateKey) => Effect.Effect<CML.Bip32PublicKey, Bip32PrivateKeyError> = Effect.fn(
  (instance: CML.Bip32PrivateKey) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.Bip32PrivateKey, Bip32PrivateKeyError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.Bip32PrivateKey) => Effect.Effect<Uint8Array, Bip32PrivateKeyError> = Effect.fn(
  (instance: CML.Bip32PrivateKey) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.Bip32PrivateKey, Bip32PrivateKeyError> = Effect.fn(function* (bech32Str: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.Bip32PrivateKey) => Effect.Effect<string, Bip32PrivateKeyError> = Effect.fn(
  (instance: CML.Bip32PrivateKey) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromBip39Entropy: (entropy: Uint8Array, password: Uint8Array) => Effect.Effect<CML.Bip32PrivateKey, Bip32PrivateKeyError> = Effect.fn(function* (entropy: Uint8Array, password: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromBip39EntropyUnsafe = (entropy: Uint8Array, password: Uint8Array): CML.Bip32PrivateKey =>
 ...
 * @category Methods
 */
export const chaincode: (instance: CML.Bip32PrivateKey) => Effect.Effect<Uint8Array, Bip32PrivateKeyError> = Effect.fn(
  (instance: CML.Bip32PrivateKey) =>
    Effect.try({
