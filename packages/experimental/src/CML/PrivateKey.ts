...
) => Effect.Effect<void, PrivateKeyError> = Effect.fn(
  (instance: CML.PrivateKey) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toPublic: (
  instance: CML.PrivateKey,
) => Effect.Effect<CML.PublicKey, PrivateKeyError> = Effect.fn(
  (instance: CML.PrivateKey) =>
    Effect.try({
 ...
 */
export const generateEd25519: () => Effect.Effect<
  CML.PrivateKey,
  PrivateKeyError
> = Effect.fn(function* () {
 ...
 * @category Constructors
 */
export const generateEd25519extended: () => Effect.Effect<
  CML.PrivateKey,
  PrivateKeyError
> = Effect.fn(function* () {
  return yield* Effect.try({
...
export const fromBech32: (
  bech32Str: string,
) => Effect.Effect<CML.PrivateKey, PrivateKeyError> = Effect.fn(function* (
  bech32Str: string,
) {
  return yield* Effect.try({
...
export const toBech32: (
  instance: CML.PrivateKey,
) => Effect.Effect<string, PrivateKeyError> = Effect.fn(
  (instance: CML.PrivateKey) =>
    Effect.try({
...
export const toRawBytes: (
  instance: CML.PrivateKey,
) => Effect.Effect<Uint8Array, PrivateKeyError> = Effect.fn(
  (instance: CML.PrivateKey) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromExtendedBytes: (
  bytes: Uint8Array,
) => Effect.Effect<CML.PrivateKey, PrivateKeyError> = Effect.fn(function* (
  bytes: Uint8Array,
) {
...
export const sign: (
  instance: CML.PrivateKey,
  message: Uint8Array,
) => Effect.Effect<CML.Ed25519Signature, PrivateKeyError> = Effect.fn(
