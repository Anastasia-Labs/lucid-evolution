 ...
 * @category Methods
 */
export const free: (instance: CML.VotingProcedures) => Effect.Effect<void, VotingProceduresError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.VotingProcedures, VotingProceduresError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.VotingProcedures =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.VotingProcedures) => Effect.Effect<number, VotingProceduresError> = Effect.fn(
  (instance: CML.VotingProcedures) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const insert: (instance: CML.VotingProcedures, key: CML.Voter, value: CML.MapGovActionIdToVotingProcedure) => Effect.Effect<CML.MapGovActionIdToVotingProcedure | undefined, VotingProceduresError> = Effect.fn(
  (instance: CML.VotingProcedures, key: CML.Voter, value: CML.MapGovActionIdToVotingProcedure) =>
    Effect.try({
 ...
 * @category Methods
 */
export const get: (instance: CML.VotingProcedures, key: CML.Voter) => Effect.Effect<CML.MapGovActionIdToVotingProcedure | undefined, VotingProceduresError> = Effect.fn(
  (instance: CML.VotingProcedures, key: CML.Voter) =>
    Effect.try({
 ...
 * @category Methods
 */
export const keys: (instance: CML.VotingProcedures) => Effect.Effect<CML.VoterList, VotingProceduresError> = Effect.fn(
  (instance: CML.VotingProcedures) =>
    Effect.try({
      try: () => instance.keys(),
      catch: () =>
