...
) => Effect.Effect<void, PlutusV3ScriptError> = Effect.fn(
  (instance: CML.PlutusV3Script) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const hash: (
  instance: CML.PlutusV3Script,
) => Effect.Effect<CML.ScriptHash, PlutusV3ScriptError> = Effect.fn(
  (instance: CML.PlutusV3Script) =>
    Effect.try({
      try: () => instance.hash(),
      catch: () =>
...
export const toRawBytes: (
  instance: CML.PlutusV3Script,
) => Effect.Effect<Uint8Array, PlutusV3ScriptError> = Effect.fn(
  (instance: CML.PlutusV3Script) =>
    Effect.try({
...
export const fromRawBytes: (
  bytes: Uint8Array,
) => Effect.Effect<CML.PlutusV3Script, PlutusV3ScriptError> = Effect.fn(
...
export const toHex: (
  instance: CML.PlutusV3Script,
) => Effect.Effect<string, PlutusV3ScriptError> = Effect.fn(
  (instance: CML.PlutusV3Script) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.PlutusV3Script => Effect.runSync(fromCborBytes(cborBytes));
...
export const toJsValue: (
  instance: CML.PlutusV3Script,
) => Effect.Effect<any, PlutusV3ScriptError> = Effect.fn(
  (instance: CML.PlutusV3Script) =>
    Effect.try({
