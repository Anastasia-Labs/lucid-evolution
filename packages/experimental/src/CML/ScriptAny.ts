 ...
 * @category Methods
 */
export const free: (instance: CML.ScriptAny) => Effect.Effect<void, ScriptAnyError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.ScriptAny) => Effect.Effect<Uint8Array, ScriptAnyError> = Effect.fn(
  (instance: CML.ScriptAny) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.ScriptAny) => Effect.Effect<Uint8Array, ScriptAnyError> = Effect.fn(
  (instance: CML.ScriptAny) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.ScriptAny): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.ScriptAny, ScriptAnyError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.ScriptAny) => Effect.Effect<string, ScriptAnyError> = Effect.fn(
  (instance: CML.ScriptAny) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.ScriptAny) => Effect.Effect<string, ScriptAnyError> = Effect.fn(
  (instance: CML.ScriptAny) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.ScriptAny, ScriptAnyError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.ScriptAny) => Effect.Effect<string, ScriptAnyError> = Effect.fn(
  (instance: CML.ScriptAny) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.ScriptAny) => Effect.Effect<any, ScriptAnyError> = Effect.fn(
  (instance: CML.ScriptAny) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.ScriptAny, ScriptAnyError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const nativeScripts: (instance: CML.ScriptAny) => Effect.Effect<CML.NativeScriptList, ScriptAnyError> = Effect.fn(
  (instance: CML.ScriptAny) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const nativeScriptsUnsafe = (instance: CML.ScriptAny): CML.NativeScriptList =>
 ...
 * @category Constructors
 */
export const _new: (nativeScripts: CML.NativeScriptList) => Effect.Effect<CML.ScriptAny, ScriptAnyError> = Effect.fn(function* (nativeScripts: CML.NativeScriptList) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (nativeScripts: CML.NativeScriptList): CML.ScriptAny =>
