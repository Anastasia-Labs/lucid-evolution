 ...
 * @category Methods
 */
export const free: (instance: CML.RequiredWitnessSet) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category Methods
 */
export const addVkeyKeyHash: (instance: CML.RequiredWitnessSet, hash: CML.Ed25519KeyHash) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addVkeyKeyHashUnsafe = (instance: CML.RequiredWitnessSet, hash: CML.Ed25519KeyHash): void =>
 ...
 * @category Methods
 */
export const addBootstrap: (instance: CML.RequiredWitnessSet, address: CML.ByronAddress) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addBootstrapUnsafe = (instance: CML.RequiredWitnessSet, address: CML.ByronAddress): void =>
 ...
 * @category Methods
 */
export const addScriptRef: (instance: CML.RequiredWitnessSet, scriptHash: CML.ScriptHash) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addScriptRefUnsafe = (instance: CML.RequiredWitnessSet, scriptHash: CML.ScriptHash): void =>
 ...
 * @category Methods
 */
export const addScriptHash: (instance: CML.RequiredWitnessSet, scriptHash: CML.ScriptHash) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
  (instance: CML.RequiredWitnessSet, scriptHash: CML.ScriptHash) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const addScriptHashUnsafe = (instance: CML.RequiredWitnessSet, scriptHash: CML.ScriptHash): void =>
 ...
 * @category Methods
 */
export const addPlutusDatumHash: (instance: CML.RequiredWitnessSet, plutusDatum: CML.DatumHash) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addPlutusDatumHashUnsafe = (instance: CML.RequiredWitnessSet, plutusDatum: CML.DatumHash): void =>
 ...
 * @category Methods
 */
export const addRedeemerTag: (instance: CML.RequiredWitnessSet, redeemer: CML.RedeemerWitnessKey) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addRedeemerTagUnsafe = (instance: CML.RequiredWitnessSet, redeemer: CML.RedeemerWitnessKey): void =>
 ...
 * @category Methods
 */
export const addAll: (instance: CML.RequiredWitnessSet, requirements: CML.RequiredWitnessSet) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addAllUnsafe = (instance: CML.RequiredWitnessSet, requirements: CML.RequiredWitnessSet): void =>
 ...
 */
export const _new: () => Effect.Effect<CML.RequiredWitnessSet, RequiredWitnessSetError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.RequiredWitnessSet =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const withdrawalRequiredWits: (instance: CML.RequiredWitnessSet, address: CML.RewardAddress) => Effect.Effect<void, RequiredWitnessSetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const withdrawalRequiredWitsUnsafe = (instance: CML.RequiredWitnessSet, address: CML.RewardAddress): void =>
