 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionBodyList) => Effect.Effect<void, TransactionBodyListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.TransactionBodyList, TransactionBodyListError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.TransactionBodyList =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.TransactionBodyList) => Effect.Effect<number, TransactionBodyListError> = Effect.fn(
  (instance: CML.TransactionBodyList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.TransactionBodyList, index: number) => Effect.Effect<CML.TransactionBody, TransactionBodyListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const getUnsafe = (instance: CML.TransactionBodyList, index: number): CML.TransactionBody =>
 ...
 * @category Methods
 */
export const add: (instance: CML.TransactionBodyList, elem: CML.TransactionBody) => Effect.Effect<void, TransactionBodyListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addUnsafe = (instance: CML.TransactionBodyList, elem: CML.TransactionBody): void =>
