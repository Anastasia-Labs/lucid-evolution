 ...
 * @category Methods
 */
export const free: (instance: CML.MapAssetNameToU64) => Effect.Effect<void, MapAssetNameToU64Error> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.MapAssetNameToU64, MapAssetNameToU64Error> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.MapAssetNameToU64 =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.MapAssetNameToU64) => Effect.Effect<number, MapAssetNameToU64Error> = Effect.fn(
  (instance: CML.MapAssetNameToU64) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const insert: (instance: CML.MapAssetNameToU64, key: CML.AssetName, value: bigint) => Effect.Effect<bigint | undefined, MapAssetNameToU64Error> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const insertUnsafe = (instance: CML.MapAssetNameToU64, key: CML.AssetName, value: bigint): bigint | undefined =>
 ...
 * @category Methods
 */
export const get: (instance: CML.MapAssetNameToU64, key: CML.AssetName) => Effect.Effect<bigint | undefined, MapAssetNameToU64Error> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const getUnsafe = (instance: CML.MapAssetNameToU64, key: CML.AssetName): bigint | undefined =>
 ...
 * @category Methods
 */
export const keys: (instance: CML.MapAssetNameToU64) => Effect.Effect<CML.AssetNameList, MapAssetNameToU64Error> = Effect.fn(
  (instance: CML.MapAssetNameToU64) =>
    Effect.try({
      try: () => instance.keys(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const keysUnsafe = (instance: CML.MapAssetNameToU64): CML.AssetNameList =>
