 ...
 * @category Methods
 */
export const free: (instance: CML.PlutusData) => Effect.Effect<void, PlutusDataError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCardanoNodeFormat: (instance: CML.PlutusData) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCardanoNodeFormatUnsafe = (instance: CML.PlutusData): CML.PlutusData =>
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.PlutusData) => Effect.Effect<Uint8Array, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.PlutusData) => Effect.Effect<Uint8Array, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.PlutusData): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.PlutusData) => Effect.Effect<string, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.PlutusData) => Effect.Effect<string, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.PlutusData) => Effect.Effect<string, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.PlutusData) => Effect.Effect<any, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newConstrPlutusData: (constrPlutusData: CML.ConstrPlutusData) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (constrPlutusData: CML.ConstrPlutusData) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newConstrPlutusDataUnsafe = (constrPlutusData: CML.ConstrPlutusData): CML.PlutusData =>
 ...
 * @category Constructors
 */
export const newMap: (map: CML.PlutusMap) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (map: CML.PlutusMap) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newList: (list: CML.PlutusDataList) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (list: CML.PlutusDataList) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newInteger: (bigInt: CML.BigInteger) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (bigInt: CML.BigInteger) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newBytes: (bytes: Uint8Array) => Effect.Effect<CML.PlutusData, PlutusDataError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const kind: (instance: CML.PlutusData) => Effect.Effect<CML.PlutusDataKind, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asConstrPlutusData: (instance: CML.PlutusData) => Effect.Effect<CML.ConstrPlutusData | undefined, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asConstrPlutusDataUnsafe = (instance: CML.PlutusData): CML.ConstrPlutusData | undefined =>
 ...
 * @category Methods
 */
export const asMap: (instance: CML.PlutusData) => Effect.Effect<CML.PlutusMap | undefined, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
      try: () => instance.as_map(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const asMapUnsafe = (instance: CML.PlutusData): CML.PlutusMap | undefined =>
 ...
 * @category Methods
 */
export const asList: (instance: CML.PlutusData) => Effect.Effect<CML.PlutusDataList | undefined, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asListUnsafe = (instance: CML.PlutusData): CML.PlutusDataList | undefined =>
 ...
 * @category Methods
 */
export const asInteger: (instance: CML.PlutusData) => Effect.Effect<CML.BigInteger | undefined, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asIntegerUnsafe = (instance: CML.PlutusData): CML.BigInteger | undefined =>
 ...
 * @category Methods
 */
export const asBytes: (instance: CML.PlutusData) => Effect.Effect<Uint8Array | undefined, PlutusDataError> = Effect.fn(
  (instance: CML.PlutusData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asBytesUnsafe = (instance: CML.PlutusData): Uint8Array | undefined =>
