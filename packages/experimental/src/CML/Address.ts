 ...
 * @category Methods
 */
export const free: (instance: CML.Address) => Effect.Effect<void, AddressError> = Effect.fn(
 ...
 * @category Methods
 */
export const toJson: (instance: CML.Address) => Effect.Effect<string, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.Address) => Effect.Effect<any, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
 ...
 */
export const fromJson: (json: string) => Effect.Effect<CML.Address, AddressError> = Effect.fn(function* (json: string) {
 ...
 * @category Methods
 */
export const header: (instance: CML.Address) => Effect.Effect<number, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
      try: () => instance.header(),
      catch: () =>
 ...
 * @category Constructors
 */
export const headerMatchesKind: (header: number, kind: CML.AddressHeaderKind) => Effect.Effect<boolean, AddressError> = Effect.fn(function* (header: number, kind: CML.AddressHeaderKind) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const headerMatchesKindUnsafe = (header: number, kind: CML.AddressHeaderKind): boolean =>
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.Address, prefix: string) => Effect.Effect<string, AddressError> = Effect.fn(
 ...
 * @category Constructors
 */
export const fromBech32: (bechStr: string) => Effect.Effect<CML.Address, AddressError> = Effect.fn(function* (bechStr: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const isValidBech32: (bechStr: string) => Effect.Effect<boolean, AddressError> = Effect.fn(function* (bechStr: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const isValid: (bechStr: string) => Effect.Effect<boolean, AddressError> = Effect.fn(function* (bechStr: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const networkId: (instance: CML.Address) => Effect.Effect<number, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
 ...
 * @category Methods
 */
export const paymentCred: (instance: CML.Address) => Effect.Effect<CML.Credential | undefined, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
 ...
 * @category Methods
 */
export const stakingCred: (instance: CML.Address) => Effect.Effect<CML.Credential | undefined, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
 ...
 * @category Methods
 */
export const kind: (instance: CML.Address) => Effect.Effect<CML.AddressKind, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.Address) => Effect.Effect<Uint8Array, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (data: Uint8Array) => Effect.Effect<CML.Address, AddressError> = Effect.fn(function* (data: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.Address) => Effect.Effect<string, AddressError> = Effect.fn(
  (instance: CML.Address) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (hex: string) => Effect.Effect<CML.Address, AddressError> = Effect.fn(function* (hex: string) {
  return yield* Effect.try({
