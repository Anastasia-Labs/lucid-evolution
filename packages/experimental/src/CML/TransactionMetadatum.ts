 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionMetadatum) => Effect.Effect<void, TransactionMetadatumError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.TransactionMetadatum) => Effect.Effect<Uint8Array, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.TransactionMetadatum, TransactionMetadatumError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.TransactionMetadatum =>
 ...
 * @category Methods
 */
export const toJson: (instance: CML.TransactionMetadatum) => Effect.Effect<string, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsonValue: (instance: CML.TransactionMetadatum) => Effect.Effect<any, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.TransactionMetadatum, TransactionMetadatumError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newMap: (map: CML.MetadatumMap) => Effect.Effect<CML.TransactionMetadatum, TransactionMetadatumError> = Effect.fn(function* (map: CML.MetadatumMap) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newList: (elements: CML.MetadatumList) => Effect.Effect<CML.TransactionMetadatum, TransactionMetadatumError> = Effect.fn(function* (elements: CML.MetadatumList) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newListUnsafe = (elements: CML.MetadatumList): CML.TransactionMetadatum =>
 ...
 * @category Constructors
 */
export const newInt: (int: CML.Int) => Effect.Effect<CML.TransactionMetadatum, TransactionMetadatumError> = Effect.fn(function* (int: CML.Int) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newBytes: (bytes: Uint8Array) => Effect.Effect<CML.TransactionMetadatum, TransactionMetadatumError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newText: (text: string) => Effect.Effect<CML.TransactionMetadatum, TransactionMetadatumError> = Effect.fn(function* (text: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const kind: (instance: CML.TransactionMetadatum) => Effect.Effect<CML.TransactionMetadatumKind, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asMap: (instance: CML.TransactionMetadatum) => Effect.Effect<CML.MetadatumMap | undefined, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
      try: () => instance.as_map(),
      catch: () =>
 ...
 * @category Methods
 */
export const asList: (instance: CML.TransactionMetadatum) => Effect.Effect<CML.MetadatumList | undefined, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
 ...
 * @category Methods
 */
export const asInt: (instance: CML.TransactionMetadatum) => Effect.Effect<CML.Int | undefined, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
      try: () => instance.as_int(),
      catch: () =>
 ...
 * @category Methods
 */
export const asBytes: (instance: CML.TransactionMetadatum) => Effect.Effect<Uint8Array | undefined, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
 ...
 * @category Methods
 */
export const asText: (instance: CML.TransactionMetadatum) => Effect.Effect<string | undefined, TransactionMetadatumError> = Effect.fn(
  (instance: CML.TransactionMetadatum) =>
    Effect.try({
