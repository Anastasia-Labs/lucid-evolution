...
) => Effect.Effect<void, TransactionInputError> = Effect.fn(
  (instance: CML.TransactionInput) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.TransactionInput,
) => Effect.Effect<Uint8Array, TransactionInputError> = Effect.fn(
  (instance: CML.TransactionInput) =>
    Effect.try({
...
) => Effect.Effect<CML.TransactionInput, TransactionInputError> = Effect.fn(
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.TransactionInput => Effect.runSync(fromCborBytes(cborBytes));
...
export const toCborHex: (
  instance: CML.TransactionInput,
) => Effect.Effect<string, TransactionInputError> = Effect.fn(
  (instance: CML.TransactionInput) =>
    Effect.try({
...
export const toJsValue: (
  instance: CML.TransactionInput,
) => Effect.Effect<any, TransactionInputError> = Effect.fn(
  (instance: CML.TransactionInput) =>
    Effect.try({
...
export const transactionId: (
  instance: CML.TransactionInput,
) => Effect.Effect<CML.TransactionHash, TransactionInputError> = Effect.fn(
  (instance: CML.TransactionInput) =>
    Effect.try({
...
export const index: (
  instance: CML.TransactionInput,
) => Effect.Effect<bigint, TransactionInputError> = Effect.fn(
  (instance: CML.TransactionInput) =>
    Effect.try({
      try: () => instance.index(),
      catch: () =>
...
export const _new: (
  ...
  function* (transactionId: CML.TransactionHash, index: bigint) {
    return yield* Effect.try({
...
export const _newUnsafe = (
  transactionId: CML.TransactionHash,
  index: bigint,
): CML.TransactionInput => Effect.runSync(_new(transactionId, index));
