 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.VoteDelegCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeStakeCredential = (instance: CML.VoteDelegCert): CML.Credential =>
