...
export const free = Effect.fn(
  (instance: CML.CIP36DelegationList): Effect.Effect<void, CIP36DelegationListError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const len = Effect.fn(
  (instance: CML.CIP36DelegationList): Effect.Effect<number, CIP36DelegationListError> =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
        new CIP36DelegationListError({
...
export const get = Effect.fn(
  (instance: CML.CIP36DelegationList, index: number): Effect.Effect<CML.CIP36Delegation, CIP36DelegationListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeGet = (instance: CML.CIP36DelegationList, index: number): CML.CIP36Delegation =>
...
export const add = Effect.fn(
  (instance: CML.CIP36DelegationList, elem: CML.CIP36Delegation): Effect.Effect<void, CIP36DelegationListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeAdd = (instance: CML.CIP36DelegationList, elem: CML.CIP36Delegation): void =>
