 ...
 * @category Errors
 */
export class TransactionWitnessSetListError extends Data.TaggedError("TransactionWitnessSetListError")<{
  message?: string;
}> {}
 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionWitnessSetList) => Effect.Effect<void, TransactionWitnessSetListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.TransactionWitnessSetList, TransactionWitnessSetListError> = Effect.fn(function* () {
  return yield* Effect.try({
    try: () => CML.TransactionWitnessSetList.new(),
    catch: () => new TransactionWitnessSetListError({
 ...
 * @category Methods
 */
export const len: (instance: CML.TransactionWitnessSetList) => Effect.Effect<number, TransactionWitnessSetListError> = Effect.fn(
  (instance: CML.TransactionWitnessSetList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.TransactionWitnessSetList, index: number) => Effect.Effect<CML.TransactionWitnessSet, TransactionWitnessSetListError> = Effect.fn(
  (instance: CML.TransactionWitnessSetList, index: number) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const getUnsafe = (instance: CML.TransactionWitnessSetList, index: number): CML.TransactionWitnessSet =>
 ...
 * @category Methods
 */
export const add: (instance: CML.TransactionWitnessSetList, elem: CML.TransactionWitnessSet) => Effect.Effect<void, TransactionWitnessSetListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addUnsafe = (instance: CML.TransactionWitnessSetList, elem: CML.TransactionWitnessSet): void =>
