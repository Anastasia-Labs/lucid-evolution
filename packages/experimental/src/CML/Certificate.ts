 ...
 * @category ConstructorsUnsafe
 */
export const newStakeDelegationUnsafe = (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newPoolRetirementUnsafe = (pool: CML.Ed25519KeyHash, epoch: bigint) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newRegCertUnsafe = (stakeCredential: CML.Credential, deposit: bigint) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newUnregCertUnsafe = (stakeCredential: CML.Credential, deposit: bigint) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newVoteDelegCertUnsafe = (stakeCredential: CML.Credential, dRep: CML.DRep) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newStakeVoteDelegCertUnsafe = (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, dRep: CML.DRep) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newStakeRegDelegCertUnsafe = (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, deposit: bigint) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newVoteRegDelegCertUnsafe = (stakeCredential: CML.Credential, dRep: CML.DRep, deposit: bigint) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newStakeVoteRegDelegCertUnsafe = (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, dRep: CML.DRep, deposit: bigint) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newAuthCommitteeHotCertUnsafe = (committeeColdCredential: CML.Credential, committeeHotCredential: CML.Credential) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newResignCommitteeColdCertUnsafe = (committeeColdCredential: CML.Credential, anchor: CML.Anchor) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newRegDrepCertUnsafe = (drepCredential: CML.Credential, deposit: bigint, anchor: CML.Anchor) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newUnregDrepCertUnsafe = (drepCredential: CML.Credential, deposit: bigint) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newUpdateDrepCertUnsafe = (drepCredential: CML.Credential, anchor: CML.Anchor) =>
