...
export const toCborBytes = Effect.fn(
  (instance: CML.CIP25Metadata): Effect.Effect<Uint8Array, CIP25MetadataError> =>
    Effect.try({
...
export const key_721 = Effect.fn(
  (instance: CML.CIP25Metadata): Effect.Effect<CML.CIP25LabelMetadata, CIP25MetadataError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeKey_721 = (instance: CML.CIP25Metadata): CML.CIP25LabelMetadata =>
...
export const toMetadata = Effect.fn(
  (instance: CML.CIP25Metadata): Effect.Effect<CML.Metadata, CIP25MetadataError> =>
    Effect.try({
...
export const addToMetadata = Effect.fn(
  (instance: CML.CIP25Metadata, metadata: CML.Metadata): Effect.Effect<void, CIP25MetadataError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeAddToMetadata = (instance: CML.CIP25Metadata, metadata: CML.Metadata): void =>
