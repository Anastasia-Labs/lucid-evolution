 ...
 * @category Methods
 */
export const free: (instance: CML.CIP25Metadata) => Effect.Effect<void, CIP25MetadataError> = Effect.fn(
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP25Metadata) => Effect.Effect<string, CIP25MetadataError> = Effect.fn(
  (instance: CML.CIP25Metadata) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP25Metadata) => Effect.Effect<any, CIP25MetadataError> = Effect.fn(
  (instance: CML.CIP25Metadata) =>
    Effect.try({
 ...
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP25Metadata, CIP25MetadataError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
    try: () => CML.CIP25Metadata.from_json(json),
    catch: () => new CIP25MetadataError({
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP25Metadata) => Effect.Effect<Uint8Array, CIP25MetadataError> = Effect.fn(
  (instance: CML.CIP25Metadata) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborBytes: (data: Uint8Array) => Effect.Effect<CML.CIP25Metadata, CIP25MetadataError> = Effect.fn(function* (data: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const key_721: (instance: CML.CIP25Metadata) => Effect.Effect<CML.CIP25LabelMetadata, CIP25MetadataError> = Effect.fn(
  (instance: CML.CIP25Metadata) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const key_721Unsafe = (instance: CML.CIP25Metadata): CML.CIP25LabelMetadata =>
  Effect.runSync(key_721(instance));
 ...
 * @category Constructors
 */
export const _new: (key_721: CML.CIP25LabelMetadata) => Effect.Effect<CML.CIP25Metadata, CIP25MetadataError> = Effect.fn(function* (key_721: CML.CIP25LabelMetadata) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (key_721: CML.CIP25LabelMetadata): CML.CIP25Metadata =>
 ...
 * @category Methods
 */
export const toMetadata: (instance: CML.CIP25Metadata) => Effect.Effect<CML.Metadata, CIP25MetadataError> = Effect.fn(
  (instance: CML.CIP25Metadata) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromMetadata: (metadata: CML.Metadata) => Effect.Effect<CML.CIP25Metadata, CIP25MetadataError> = Effect.fn(function* (metadata: CML.Metadata) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const addToMetadata: (instance: CML.CIP25Metadata, metadata: CML.Metadata) => Effect.Effect<void, CIP25MetadataError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addToMetadataUnsafe = (instance: CML.CIP25Metadata, metadata: CML.Metadata): void =>
  Effect.runSync(addToMetadata(instance, metadata));
