 ...
 * @category Methods
 */
export const free: (instance: CML.PlutusV2Script) => Effect.Effect<void, PlutusV2ScriptError> = Effect.fn(
 ...
 * @category Methods
 */
export const hash: (instance: CML.PlutusV2Script) => Effect.Effect<CML.ScriptHash, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
      try: () => instance.hash(),
      catch: () =>
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.PlutusV2Script) => Effect.Effect<Uint8Array, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
 ...
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.PlutusV2Script, PlutusV2ScriptError> = Effect.fn(function* (bytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toHex: (instance: CML.PlutusV2Script) => Effect.Effect<string, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.PlutusV2Script, PlutusV2ScriptError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.PlutusV2Script) => Effect.Effect<Uint8Array, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.PlutusV2Script) => Effect.Effect<Uint8Array, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.PlutusV2Script): Uint8Array =>
 ...
 * @category Constructors
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.PlutusV2Script, PlutusV2ScriptError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.PlutusV2Script =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.PlutusV2Script) => Effect.Effect<string, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.PlutusV2Script) => Effect.Effect<string, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.PlutusV2Script): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.PlutusV2Script, PlutusV2ScriptError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.PlutusV2Script) => Effect.Effect<string, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.PlutusV2Script) => Effect.Effect<any, PlutusV2ScriptError> = Effect.fn(
  (instance: CML.PlutusV2Script) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.PlutusV2Script, PlutusV2ScriptError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
