 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionBody) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.TransactionBody) => Effect.Effect<Uint8Array, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.TransactionBody) => Effect.Effect<Uint8Array, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.TransactionBody): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.TransactionBody, TransactionBodyError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
    try: () => CML.TransactionBody.from_cbor_bytes(cborBytes),
    catch: () => new TransactionBodyError({
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.TransactionBody =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.TransactionBody) => Effect.Effect<string, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.TransactionBody) => Effect.Effect<string, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.TransactionBody): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.TransactionBody, TransactionBodyError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.TransactionBody) => Effect.Effect<string, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.TransactionBody) => Effect.Effect<any, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.TransactionBody, TransactionBodyError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const inputs: (instance: CML.TransactionBody) => Effect.Effect<CML.TransactionInputList, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
      try: () => instance.inputs(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const inputsUnsafe = (instance: CML.TransactionBody): CML.TransactionInputList =>
  Effect.runSync(inputs(instance));
 ...
 * @category Methods
 */
export const outputs: (instance: CML.TransactionBody) => Effect.Effect<CML.TransactionOutputList, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const outputsUnsafe = (instance: CML.TransactionBody): CML.TransactionOutputList =>
  Effect.runSync(outputs(instance));
 ...
 * @category Methods
 */
export const fee: (instance: CML.TransactionBody) => Effect.Effect<bigint, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
      try: () => instance.fee(),
      catch: () =>
 ...
 * @category Methods
 */
export const setTtl: (instance: CML.TransactionBody, ttl: bigint) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setTtlUnsafe = (instance: CML.TransactionBody, ttl: bigint): void =>
 ...
 * @category Methods
 */
export const ttl: (instance: CML.TransactionBody) => Effect.Effect<bigint | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
      try: () => instance.ttl(),
      catch: () =>
 ...
 * @category Methods
 */
export const setCerts: (instance: CML.TransactionBody, certs: CML.CertificateList) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setCertsUnsafe = (instance: CML.TransactionBody, certs: CML.CertificateList): void =>
  Effect.runSync(setCerts(instance, certs));
 ...
 * @category Methods
 */
export const certs: (instance: CML.TransactionBody) => Effect.Effect<CML.CertificateList | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
      try: () => instance.certs(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const certsUnsafe = (instance: CML.TransactionBody): CML.CertificateList | undefined =>
  Effect.runSync(certs(instance));
 ...
 * @category Methods
 */
export const setWithdrawals: (instance: CML.TransactionBody, withdrawals: CML.MapRewardAccountToCoin) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setWithdrawalsUnsafe = (instance: CML.TransactionBody, withdrawals: CML.MapRewardAccountToCoin): void =>
  Effect.runSync(setWithdrawals(instance, withdrawals));
 ...
 * @category Methods
 */
export const withdrawals: (instance: CML.TransactionBody) => Effect.Effect<CML.MapRewardAccountToCoin | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const withdrawalsUnsafe = (instance: CML.TransactionBody): CML.MapRewardAccountToCoin | undefined =>
 ...
 * @category Methods
 */
export const setAuxiliaryDataHash: (instance: CML.TransactionBody, auxiliaryDataHash: CML.AuxiliaryDataHash) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setAuxiliaryDataHashUnsafe = (instance: CML.TransactionBody, auxiliaryDataHash: CML.AuxiliaryDataHash): void =>
  Effect.runSync(setAuxiliaryDataHash(instance, auxiliaryDataHash));
 ...
 * @category Methods
 */
export const auxiliaryDataHash: (instance: CML.TransactionBody) => Effect.Effect<CML.AuxiliaryDataHash | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const auxiliaryDataHashUnsafe = (instance: CML.TransactionBody): CML.AuxiliaryDataHash | undefined =>
 ...
 * @category Methods
 */
export const setValidityIntervalStart: (instance: CML.TransactionBody, validityIntervalStart: bigint) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setValidityIntervalStartUnsafe = (instance: CML.TransactionBody, validityIntervalStart: bigint): void =>
 ...
 * @category Methods
 */
export const validityIntervalStart: (instance: CML.TransactionBody) => Effect.Effect<bigint | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const validityIntervalStartUnsafe = (instance: CML.TransactionBody): bigint | undefined =>
  Effect.runSync(validityIntervalStart(instance));
 ...
 * @category Methods
 */
export const setMint: (instance: CML.TransactionBody, mint: CML.Mint) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setMintUnsafe = (instance: CML.TransactionBody, mint: CML.Mint): void =>
  Effect.runSync(setMint(instance, mint));
 ...
 * @category Methods
 */
export const mint: (instance: CML.TransactionBody) => Effect.Effect<CML.Mint | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
      try: () => instance.mint(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const mintUnsafe = (instance: CML.TransactionBody): CML.Mint | undefined =>
  Effect.runSync(mint(instance));
 ...
 * @category Methods
 */
export const setScriptDataHash: (instance: CML.TransactionBody, scriptDataHash: CML.ScriptDataHash) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setScriptDataHashUnsafe = (instance: CML.TransactionBody, scriptDataHash: CML.ScriptDataHash): void =>
  Effect.runSync(setScriptDataHash(instance, scriptDataHash));
 ...
 * @category Methods
 */
export const scriptDataHash: (instance: CML.TransactionBody) => Effect.Effect<CML.ScriptDataHash | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const scriptDataHashUnsafe = (instance: CML.TransactionBody): CML.ScriptDataHash | undefined =>
  Effect.runSync(scriptDataHash(instance));
 ...
 * @category Methods
 */
export const setCollateralInputs: (instance: CML.TransactionBody, collateralInputs: CML.TransactionInputList) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setCollateralInputsUnsafe = (instance: CML.TransactionBody, collateralInputs: CML.TransactionInputList): void =>
  Effect.runSync(setCollateralInputs(instance, collateralInputs));
 ...
 * @category Methods
 */
export const collateralInputs: (instance: CML.TransactionBody) => Effect.Effect<CML.TransactionInputList | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const collateralInputsUnsafe = (instance: CML.TransactionBody): CML.TransactionInputList | undefined =>
 ...
 * @category Methods
 */
export const setRequiredSigners: (instance: CML.TransactionBody, requiredSigners: CML.Ed25519KeyHashList) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setRequiredSignersUnsafe = (instance: CML.TransactionBody, requiredSigners: CML.Ed25519KeyHashList): void =>
  Effect.runSync(setRequiredSigners(instance, requiredSigners));
 ...
 * @category Methods
 */
export const requiredSigners: (instance: CML.TransactionBody) => Effect.Effect<CML.Ed25519KeyHashList | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const requiredSignersUnsafe = (instance: CML.TransactionBody): CML.Ed25519KeyHashList | undefined =>
 ...
 * @category Methods
 */
export const setNetworkId: (instance: CML.TransactionBody, networkId: CML.NetworkId) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setNetworkIdUnsafe = (instance: CML.TransactionBody, networkId: CML.NetworkId): void =>
 ...
 * @category Methods
 */
export const networkId: (instance: CML.TransactionBody) => Effect.Effect<CML.NetworkId | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const networkIdUnsafe = (instance: CML.TransactionBody): CML.NetworkId | undefined =>
 ...
 * @category Methods
 */
export const setCollateralReturn: (instance: CML.TransactionBody, collateralReturn: CML.TransactionOutput) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setCollateralReturnUnsafe = (instance: CML.TransactionBody, collateralReturn: CML.TransactionOutput): void =>
  Effect.runSync(setCollateralReturn(instance, collateralReturn));
 ...
 * @category Methods
 */
export const collateralReturn: (instance: CML.TransactionBody) => Effect.Effect<CML.TransactionOutput | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const collateralReturnUnsafe = (instance: CML.TransactionBody): CML.TransactionOutput | undefined =>
 ...
 * @category Methods
 */
export const setTotalCollateral: (instance: CML.TransactionBody, totalCollateral: bigint) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setTotalCollateralUnsafe = (instance: CML.TransactionBody, totalCollateral: bigint): void =>
  Effect.runSync(setTotalCollateral(instance, totalCollateral));
 ...
 * @category Methods
 */
export const totalCollateral: (instance: CML.TransactionBody) => Effect.Effect<bigint | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const totalCollateralUnsafe = (instance: CML.TransactionBody): bigint | undefined =>
  Effect.runSync(totalCollateral(instance));
 ...
 * @category Methods
 */
export const setReferenceInputs: (instance: CML.TransactionBody, referenceInputs: CML.TransactionInputList) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setReferenceInputsUnsafe = (instance: CML.TransactionBody, referenceInputs: CML.TransactionInputList): void =>
  Effect.runSync(setReferenceInputs(instance, referenceInputs));
 ...
 * @category Methods
 */
export const referenceInputs: (instance: CML.TransactionBody) => Effect.Effect<CML.TransactionInputList | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const referenceInputsUnsafe = (instance: CML.TransactionBody): CML.TransactionInputList | undefined =>
 ...
 * @category Methods
 */
export const setVotingProcedures: (instance: CML.TransactionBody, votingProcedures: CML.VotingProcedures) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setVotingProceduresUnsafe = (instance: CML.TransactionBody, votingProcedures: CML.VotingProcedures): void =>
  Effect.runSync(setVotingProcedures(instance, votingProcedures));
 ...
 * @category Methods
 */
export const votingProcedures: (instance: CML.TransactionBody) => Effect.Effect<CML.VotingProcedures | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const votingProceduresUnsafe = (instance: CML.TransactionBody): CML.VotingProcedures | undefined =>
 ...
 * @category Methods
 */
export const setProposalProcedures: (instance: CML.TransactionBody, proposalProcedures: CML.ProposalProcedureList) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody, proposalProcedures: CML.ProposalProcedureList) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const setProposalProceduresUnsafe = (instance: CML.TransactionBody, proposalProcedures: CML.ProposalProcedureList): void =>
  Effect.runSync(setProposalProcedures(instance, proposalProcedures));
 ...
 * @category Methods
 */
export const proposalProcedures: (instance: CML.TransactionBody) => Effect.Effect<CML.ProposalProcedureList | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const proposalProceduresUnsafe = (instance: CML.TransactionBody): CML.ProposalProcedureList | undefined =>
 ...
 * @category Methods
 */
export const setCurrentTreasuryValue: (instance: CML.TransactionBody, currentTreasuryValue: bigint) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setCurrentTreasuryValueUnsafe = (instance: CML.TransactionBody, currentTreasuryValue: bigint): void =>
 ...
 * @category Methods
 */
export const currentTreasuryValue: (instance: CML.TransactionBody) => Effect.Effect<bigint | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const currentTreasuryValueUnsafe = (instance: CML.TransactionBody): bigint | undefined =>
  Effect.runSync(currentTreasuryValue(instance));
 ...
 * @category Methods
 */
export const setDonation: (instance: CML.TransactionBody, donation: bigint) => Effect.Effect<void, TransactionBodyError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setDonationUnsafe = (instance: CML.TransactionBody, donation: bigint): void =>
  Effect.runSync(setDonation(instance, donation));
 ...
 * @category Methods
 */
export const donation: (instance: CML.TransactionBody) => Effect.Effect<bigint | undefined, TransactionBodyError> = Effect.fn(
  (instance: CML.TransactionBody) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const donationUnsafe = (instance: CML.TransactionBody): bigint | undefined =>
  Effect.runSync(donation(instance));
 ...
 * @category Constructors
 */
export const _new: (inputs: CML.TransactionInputList, outputs: CML.TransactionOutputList, fee: bigint) => Effect.Effect<CML.TransactionBody, TransactionBodyError> = Effect.fn(function* (inputs: CML.TransactionInputList, outputs: CML.TransactionOutputList, fee: bigint) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (inputs: CML.TransactionInputList, outputs: CML.TransactionOutputList, fee: bigint): CML.TransactionBody =>
