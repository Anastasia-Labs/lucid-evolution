...
export const free = Effect.fn(
  (instance: CML.StakeCredentialList): Effect.Effect<void, StakeCredentialListError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const len = Effect.fn(
  (instance: CML.StakeCredentialList): Effect.Effect<number, StakeCredentialListError> =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
        new StakeCredentialListError({
...
export const get = Effect.fn(
  (instance: CML.StakeCredentialList, index: number): Effect.Effect<CML.Credential, StakeCredentialListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeGet = (instance: CML.StakeCredentialList, index: number): CML.Credential =>
...
export const add = Effect.fn(
  (instance: CML.StakeCredentialList, elem: CML.Credential): Effect.Effect<void, StakeCredentialListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeAdd = (instance: CML.StakeCredentialList, elem: CML.Credential): void =>
