 ...
 * @category Methods
 */
export const free: (instance: CML.CIP36Delegation) => Effect.Effect<void, CIP36DelegationError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP36Delegation) => Effect.Effect<Uint8Array, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.CIP36Delegation) => Effect.Effect<Uint8Array, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.CIP36Delegation, CIP36DelegationError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.CIP36Delegation =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.CIP36Delegation) => Effect.Effect<string, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.CIP36Delegation) => Effect.Effect<string, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.CIP36Delegation, CIP36DelegationError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP36Delegation) => Effect.Effect<string, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP36Delegation) => Effect.Effect<any, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP36Delegation, CIP36DelegationError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const votingPubKey: (instance: CML.CIP36Delegation) => Effect.Effect<CML.PublicKey, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
 ...
 * @category Methods
 */
export const weight: (instance: CML.CIP36Delegation) => Effect.Effect<number, CIP36DelegationError> = Effect.fn(
  (instance: CML.CIP36Delegation) =>
    Effect.try({
      try: () => instance.weight(),
      catch: () =>
 ...
 * @category Constructors
 */
export const _new: (votingPubKey: CML.PublicKey, weight: number) => Effect.Effect<CML.CIP36Delegation, CIP36DelegationError> = Effect.fn(function* (votingPubKey: CML.PublicKey, weight: number) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (votingPubKey: CML.PublicKey, weight: number): CML.CIP36Delegation =>
