 ...
 * @category Methods
 */
export const free: (instance: CML.AuxiliaryDataHash) => Effect.Effect<void, AuxiliaryDataHashError> = Effect.fn(
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.AuxiliaryDataHash, prefix: string) => Effect.Effect<string, AuxiliaryDataHashError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const toBech32Unsafe = (instance: CML.AuxiliaryDataHash, prefix: string): string =>
 ...
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.AuxiliaryDataHash, AuxiliaryDataHashError> = Effect.fn(function* (bech32Str: string) {
  return yield* Effect.try({
    try: () => CML.AuxiliaryDataHash.from_bech32(bech32Str),
    catch: () => new AuxiliaryDataHashError({
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.AuxiliaryDataHash) => Effect.Effect<Uint8Array, AuxiliaryDataHashError> = Effect.fn(
  (instance: CML.AuxiliaryDataHash) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.AuxiliaryDataHash, AuxiliaryDataHashError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.AuxiliaryDataHash) => Effect.Effect<string, AuxiliaryDataHashError> = Effect.fn(
  (instance: CML.AuxiliaryDataHash) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.AuxiliaryDataHash, AuxiliaryDataHashError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
