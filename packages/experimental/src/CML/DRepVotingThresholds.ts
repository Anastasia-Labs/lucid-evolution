...
) => Effect.Effect<void, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<Uint8Array, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.DRepVotingThresholds => Effect.runSync(fromCborBytes(cborBytes));
...
export const toCborHex: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<string, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
...
export const fromCborHexUnsafe = (
  cborBytes: string,
): CML.DRepVotingThresholds => Effect.runSync(fromCborHex(cborBytes));
...
export const toJsValue: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<any, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
 ...
 * @category Methods
 */
export const motionNoConfidence: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<CML.UnitInterval, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
 ...
 * @category Methods
 */
export const committeeNoConfidence: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<CML.UnitInterval, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
 ...
 * @category Methods
 */
export const hardForkInitiation: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<CML.UnitInterval, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
 ...
 * @category Methods
 */
export const ppGovernanceGroup: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<CML.UnitInterval, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
 ...
 * @category Methods
 */
export const treasuryWithdrawal: (
  instance: CML.DRepVotingThresholds,
) => Effect.Effect<CML.UnitInterval, DRepVotingThresholdsError> = Effect.fn(
  (instance: CML.DRepVotingThresholds) =>
    Effect.try({
