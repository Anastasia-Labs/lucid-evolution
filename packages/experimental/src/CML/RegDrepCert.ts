 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.RegDrepCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeDrepCredential = (instance: CML.RegDrepCert): CML.Credential =>
 ...
 * @category Methods
 */
export const unsafeAnchor = (instance: CML.RegDrepCert): CML.Anchor | undefined =>
 ...
 * @category Constructors
 */
export const unsafe_new = (drepCredential: CML.Credential, deposit: bigint, anchor: CML.Anchor) =>
