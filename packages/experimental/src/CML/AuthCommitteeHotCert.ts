 ...
 * @category Methods
 */
export const free: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<void, AuthCommitteeHotCertError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<Uint8Array, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborBytesUnsafe = (instance: CML.AuthCommitteeHotCert): Uint8Array =>
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<Uint8Array, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.AuthCommitteeHotCert): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.AuthCommitteeHotCert, AuthCommitteeHotCertError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.AuthCommitteeHotCert =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<string, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<string, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.AuthCommitteeHotCert): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.AuthCommitteeHotCert, AuthCommitteeHotCertError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborHexUnsafe = (cborBytes: string): CML.AuthCommitteeHotCert =>
 ...
 * @category Methods
 */
export const toJson: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<string, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<any, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.AuthCommitteeHotCert, AuthCommitteeHotCertError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const committeeColdCredential: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<CML.Credential, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const committeeColdCredentialUnsafe = (instance: CML.AuthCommitteeHotCert): CML.Credential =>
 ...
 * @category Methods
 */
export const committeeHotCredential: (instance: CML.AuthCommitteeHotCert) => Effect.Effect<CML.Credential, AuthCommitteeHotCertError> = Effect.fn(
  (instance: CML.AuthCommitteeHotCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const committeeHotCredentialUnsafe = (instance: CML.AuthCommitteeHotCert): CML.Credential =>
 ...
 * @category Constructors
 */
export const _new: (committeeColdCredential: CML.Credential, committeeHotCredential: CML.Credential) => Effect.Effect<CML.AuthCommitteeHotCert, AuthCommitteeHotCertError> = Effect.fn(function* (committeeColdCredential: CML.Credential, committeeHotCredential: CML.Credential) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (committeeColdCredential: CML.Credential, committeeHotCredential: CML.Credential): CML.AuthCommitteeHotCert =>
