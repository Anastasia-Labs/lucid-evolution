 ...
 * @category Methods
 */
export const free: (instance: CML.AnchorDocHash) => Effect.Effect<void, AnchorDocHashError> = Effect.fn(
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.AnchorDocHash, prefix: string) => Effect.Effect<string, AnchorDocHashError> = Effect.fn(
 ...
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.AnchorDocHash, AnchorDocHashError> = Effect.fn(function* (bech32Str: string) {
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.AnchorDocHash) => Effect.Effect<Uint8Array, AnchorDocHashError> = Effect.fn(
  (instance: CML.AnchorDocHash) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.AnchorDocHash, AnchorDocHashError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.AnchorDocHash) => Effect.Effect<string, AnchorDocHashError> = Effect.fn(
  (instance: CML.AnchorDocHash) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.AnchorDocHash, AnchorDocHashError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
