 ...
 * @category Methods
 */
export const unsafeGet = (instance: CML.TransactionMetadatumLabels, index: number): bigint =>
 ...
 * @category Methods
 */
export const unsafeAdd = (instance: CML.TransactionMetadatumLabels, elem: bigint): void =>
