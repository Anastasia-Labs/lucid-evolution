 ...
 * @category Constructors
 */
export const unsafe_new = (address: CML.Address, amount: CML.Value, datumOption: CML.DatumOption, scriptReference: CML.Script) =>
 ...
 * @category Methods
 */
export const unsafeSetAmount = (instance: CML.TransactionOutput, amount: CML.Value): void =>
 ...
 * @category Methods
 */
export const unsafeDatum = (instance: CML.TransactionOutput): CML.DatumOption | undefined =>
 ...
 * @category Methods
 */
export const unsafeDatumHash = (instance: CML.TransactionOutput): CML.DatumHash | undefined =>
 ...
 * @category Methods
 */
export const unsafeScriptRef = (instance: CML.TransactionOutput): CML.Script | undefined =>
 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.TransactionOutput): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.TransactionOutput): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.TransactionOutput): string =>
 ...
 * @category Constructors
 */
export const unsafeNewAlonzoFormatTxOut = (alonzoFormatTxOut: CML.AlonzoFormatTxOut) =>
 ...
 * @category Constructors
 */
export const unsafeNewConwayFormatTxOut = (conwayFormatTxOut: CML.ConwayFormatTxOut) =>
 ...
 * @category Methods
 */
export const unsafeKind = (instance: CML.TransactionOutput): CML.TransactionOutputKind =>
 ...
 * @category Methods
 */
export const unsafeAsAlonzoFormatTxOut = (instance: CML.TransactionOutput): CML.AlonzoFormatTxOut | undefined =>
 ...
 * @category Methods
 */
export const unsafeAsConwayFormatTxOut = (instance: CML.TransactionOutput): CML.ConwayFormatTxOut | undefined =>
