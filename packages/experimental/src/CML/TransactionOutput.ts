 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionOutput) => Effect.Effect<void, TransactionOutputError> = Effect.fn(
 ...
 */
export const _new: (address: CML.Address, amount: CML.Value, datumOption: CML.DatumOption, scriptReference: CML.Script) => Effect.Effect<CML.TransactionOutput, TransactionOutputError> = Effect.fn(function* (address: CML.Address, amount: CML.Value, datumOption: CML.DatumOption, scriptReference: CML.Script) {
 ...
 */
export const _newUnsafe = (address: CML.Address, amount: CML.Value, datumOption: CML.DatumOption, scriptReference: CML.Script): CML.TransactionOutput =>
 ...
 * @category Methods
 */
export const address: (instance: CML.TransactionOutput) => Effect.Effect<CML.Address, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Methods
 */
export const amount: (instance: CML.TransactionOutput) => Effect.Effect<CML.Value, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
      try: () => instance.amount(),
      catch: () =>
 ...
 * @category Methods
 */
export const setAmount: (instance: CML.TransactionOutput, amount: CML.Value) => Effect.Effect<void, TransactionOutputError> = Effect.fn(
 ...
 * @category Methods
 */
export const datum: (instance: CML.TransactionOutput) => Effect.Effect<CML.DatumOption | undefined, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
      try: () => instance.datum(),
      catch: () =>
 ...
 * @category Methods
 */
export const datumHash: (instance: CML.TransactionOutput) => Effect.Effect<CML.DatumHash | undefined, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Methods
 */
export const scriptRef: (instance: CML.TransactionOutput) => Effect.Effect<CML.Script | undefined, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.TransactionOutput) => Effect.Effect<Uint8Array, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.TransactionOutput) => Effect.Effect<Uint8Array, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.TransactionOutput, TransactionOutputError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.TransactionOutput =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.TransactionOutput) => Effect.Effect<string, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.TransactionOutput) => Effect.Effect<string, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.TransactionOutput, TransactionOutputError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.TransactionOutput) => Effect.Effect<string, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.TransactionOutput) => Effect.Effect<any, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.TransactionOutput, TransactionOutputError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newAlonzoFormatTxOut: (alonzoFormatTxOut: CML.AlonzoFormatTxOut) => Effect.Effect<CML.TransactionOutput, TransactionOutputError> = Effect.fn(function* (alonzoFormatTxOut: CML.AlonzoFormatTxOut) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newAlonzoFormatTxOutUnsafe = (alonzoFormatTxOut: CML.AlonzoFormatTxOut): CML.TransactionOutput =>
 ...
 * @category Constructors
 */
export const newConwayFormatTxOut: (conwayFormatTxOut: CML.ConwayFormatTxOut) => Effect.Effect<CML.TransactionOutput, TransactionOutputError> = Effect.fn(function* (conwayFormatTxOut: CML.ConwayFormatTxOut) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newConwayFormatTxOutUnsafe = (conwayFormatTxOut: CML.ConwayFormatTxOut): CML.TransactionOutput =>
 ...
 * @category Methods
 */
export const kind: (instance: CML.TransactionOutput) => Effect.Effect<CML.TransactionOutputKind, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asAlonzoFormatTxOut: (instance: CML.TransactionOutput) => Effect.Effect<CML.AlonzoFormatTxOut | undefined, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
 ...
 * @category Methods
 */
export const asConwayFormatTxOut: (instance: CML.TransactionOutput) => Effect.Effect<CML.ConwayFormatTxOut | undefined, TransactionOutputError> = Effect.fn(
  (instance: CML.TransactionOutput) =>
    Effect.try({
