 ...
 * @category Methods
 */
export const unsafeWithProposal = (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure): CML.ProposalBuilder =>
 ...
 * @category Methods
 */
export const unsafeWithNativeScriptProposal = (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, nativeScript: CML.NativeScript, witnessInfo: CML.NativeScriptWitnessInfo): CML.ProposalBuilder =>
 ...
 * @category Methods
 */
export const unsafeWithPlutusProposal = (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList, datum: CML.PlutusData): CML.ProposalBuilder =>
 ...
 * @category Methods
 */
export const unsafeWithPlutusProposalInlineDatum = (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList): CML.ProposalBuilder =>
 ...
 * @category Methods
 */
export const unsafeBuild = (instance: CML.ProposalBuilder): CML.ProposalBuilderResult =>
