 ...
 * @category Methods
 */
export const free: (instance: CML.ProposalBuilder) => Effect.Effect<void, ProposalBuilderError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.ProposalBuilder, ProposalBuilderError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.ProposalBuilder =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const withProposal: (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure) => Effect.Effect<CML.ProposalBuilder, ProposalBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const withNativeScriptProposal: (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, nativeScript: CML.NativeScript, witnessInfo: CML.NativeScriptWitnessInfo) => Effect.Effect<CML.ProposalBuilder, ProposalBuilderError> = Effect.fn(
  (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, nativeScript: CML.NativeScript, witnessInfo: CML.NativeScriptWitnessInfo) =>
    Effect.try({
 ...
 * @category Methods
 */
export const withPlutusProposal: (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList, datum: CML.PlutusData) => Effect.Effect<CML.ProposalBuilder, ProposalBuilderError> = Effect.fn(
  (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList, datum: CML.PlutusData) =>
    Effect.try({
 ...
 * @category Methods
 */
export const withPlutusProposalInlineDatum: (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList) => Effect.Effect<CML.ProposalBuilder, ProposalBuilderError> = Effect.fn(
  (instance: CML.ProposalBuilder, proposal: CML.ProposalProcedure, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList) =>
    Effect.try({
 ...
 * @category Methods
 */
export const build: (instance: CML.ProposalBuilder) => Effect.Effect<CML.ProposalBuilderResult, ProposalBuilderError> = Effect.fn(
  (instance: CML.ProposalBuilder) =>
    Effect.try({
      try: () => instance.build(),
      catch: () =>
