 ...
 * @category Methods
 */
export const free: (instance: CML.DNSName) => Effect.Effect<void, DNSNameError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.DNSName) => Effect.Effect<Uint8Array, DNSNameError> = Effect.fn(
  (instance: CML.DNSName) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.DNSName) => Effect.Effect<Uint8Array, DNSNameError> = Effect.fn(
  (instance: CML.DNSName) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.DNSName, DNSNameError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.DNSName) => Effect.Effect<string, DNSNameError> = Effect.fn(
  (instance: CML.DNSName) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.DNSName) => Effect.Effect<string, DNSNameError> = Effect.fn(
  (instance: CML.DNSName) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.DNSName, DNSNameError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.DNSName) => Effect.Effect<string, DNSNameError> = Effect.fn(
  (instance: CML.DNSName) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.DNSName) => Effect.Effect<any, DNSNameError> = Effect.fn(
  (instance: CML.DNSName) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.DNSName, DNSNameError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const get: (instance: CML.DNSName) => Effect.Effect<string, DNSNameError> = Effect.fn(
  (instance: CML.DNSName) =>
    Effect.try({
      try: () => instance.get(),
      catch: () =>
