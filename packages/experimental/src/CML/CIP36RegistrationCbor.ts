...
export const free = Effect.fn(
  (instance: CML.CIP36RegistrationCbor): Effect.Effect<void, CIP36RegistrationCborError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toJson = Effect.fn(
  (instance: CML.CIP36RegistrationCbor): Effect.Effect<string, CIP36RegistrationCborError> =>
    Effect.try({
...
export const toJsValue = Effect.fn(
  (instance: CML.CIP36RegistrationCbor): Effect.Effect<any, CIP36RegistrationCborError> =>
    Effect.try({
...
export const keyRegistration = Effect.fn(
  (instance: CML.CIP36RegistrationCbor): Effect.Effect<CML.CIP36KeyRegistration, CIP36RegistrationCborError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeKeyRegistration = (instance: CML.CIP36RegistrationCbor): CML.CIP36KeyRegistration =>
...
export const registrationWitness = Effect.fn(
  (instance: CML.CIP36RegistrationCbor): Effect.Effect<CML.CIP36RegistrationWitness, CIP36RegistrationCborError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeRegistrationWitness = (instance: CML.CIP36RegistrationCbor): CML.CIP36RegistrationWitness =>
 ...
 * @category Constructors
 */
export const _new = Effect.fn(function* (keyRegistration: CML.CIP36KeyRegistration, registrationWitness: CML.CIP36RegistrationWitness) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const unsafe_new = (keyRegistration: CML.CIP36KeyRegistration, registrationWitness: CML.CIP36RegistrationWitness) =>
