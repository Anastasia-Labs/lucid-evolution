 ...
 * @category Errors
 */
export class FilesDetailsListError extends Data.TaggedError("FilesDetailsListError")<{
  message?: string;
}> {}
 ...
 * @category Methods
 */
export const free: (instance: CML.FilesDetailsList) => Effect.Effect<void, FilesDetailsListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.FilesDetailsList, FilesDetailsListError> = Effect.fn(function* () {
  return yield* Effect.try({
    try: () => CML.FilesDetailsList.new(),
    catch: () => new FilesDetailsListError({
 ...
 */
export const _newUnsafe = (): CML.FilesDetailsList =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.FilesDetailsList) => Effect.Effect<number, FilesDetailsListError> = Effect.fn(
  (instance: CML.FilesDetailsList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.FilesDetailsList, index: number) => Effect.Effect<CML.CIP25FilesDetails, FilesDetailsListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const getUnsafe = (instance: CML.FilesDetailsList, index: number): CML.CIP25FilesDetails =>
 ...
 * @category Methods
 */
export const add: (instance: CML.FilesDetailsList, elem: CML.CIP25FilesDetails) => Effect.Effect<void, FilesDetailsListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addUnsafe = (instance: CML.FilesDetailsList, elem: CML.CIP25FilesDetails): void =>
