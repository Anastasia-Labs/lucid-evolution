 ...
 * @category Methods
 */
export const free: (instance: CML.Script) => Effect.Effect<void, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
 ...
 * @category Methods
 */
export const hash: (instance: CML.Script) => Effect.Effect<CML.ScriptHash, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
      try: () => instance.hash(),
      catch: () =>
 ...
 * @category Methods
 */
export const language: (instance: CML.Script) => Effect.Effect<CML.Language | undefined, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.Script) => Effect.Effect<Uint8Array, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.Script) => Effect.Effect<Uint8Array, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.Script, ScriptError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.Script) => Effect.Effect<string, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.Script) => Effect.Effect<string, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.Script, ScriptError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.Script) => Effect.Effect<string, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.Script) => Effect.Effect<any, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.Script, ScriptError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newNative: (script: CML.NativeScript) => Effect.Effect<CML.Script, ScriptError> = Effect.fn(function* (script: CML.NativeScript) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newPlutusV1: (script: CML.PlutusV1Script) => Effect.Effect<CML.Script, ScriptError> = Effect.fn(function* (script: CML.PlutusV1Script) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newPlutusV2: (script: CML.PlutusV2Script) => Effect.Effect<CML.Script, ScriptError> = Effect.fn(function* (script: CML.PlutusV2Script) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newPlutusV3: (script: CML.PlutusV3Script) => Effect.Effect<CML.Script, ScriptError> = Effect.fn(function* (script: CML.PlutusV3Script) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const kind: (instance: CML.Script) => Effect.Effect<CML.ScriptKind, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asNative: (instance: CML.Script) => Effect.Effect<CML.NativeScript | undefined, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const asPlutusV1: (instance: CML.Script) => Effect.Effect<CML.PlutusV1Script | undefined, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const asPlutusV2: (instance: CML.Script) => Effect.Effect<CML.PlutusV2Script | undefined, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const asPlutusV3: (instance: CML.Script) => Effect.Effect<CML.PlutusV3Script | undefined, ScriptError> = Effect.fn(
  (instance: CML.Script) =>
    Effect.try({
