 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.PlutusV1Script): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.PlutusV1Script): string =>
