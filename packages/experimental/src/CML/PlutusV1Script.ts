 ...
 * @category Methods
 */
export const free: (instance: CML.PlutusV1Script) => Effect.Effect<void, PlutusV1ScriptError> = Effect.fn(
 ...
 * @category Methods
 */
export const hash: (instance: CML.PlutusV1Script) => Effect.Effect<CML.ScriptHash, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
      try: () => instance.hash(),
      catch: () =>
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.PlutusV1Script) => Effect.Effect<Uint8Array, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
 ...
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.PlutusV1Script, PlutusV1ScriptError> = Effect.fn(function* (bytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toHex: (instance: CML.PlutusV1Script) => Effect.Effect<string, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.PlutusV1Script, PlutusV1ScriptError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.PlutusV1Script) => Effect.Effect<Uint8Array, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.PlutusV1Script) => Effect.Effect<Uint8Array, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.PlutusV1Script, PlutusV1ScriptError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.PlutusV1Script =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.PlutusV1Script) => Effect.Effect<string, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.PlutusV1Script) => Effect.Effect<string, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.PlutusV1Script, PlutusV1ScriptError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.PlutusV1Script) => Effect.Effect<string, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.PlutusV1Script) => Effect.Effect<any, PlutusV1ScriptError> = Effect.fn(
  (instance: CML.PlutusV1Script) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.PlutusV1Script, PlutusV1ScriptError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
