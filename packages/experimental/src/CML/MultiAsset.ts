 ...
 * @category Methods
 */
export const free: (instance: CML.MultiAsset) => Effect.Effect<void, MultiAssetError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.MultiAsset, MultiAssetError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.MultiAsset =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const policyCount: (instance: CML.MultiAsset) => Effect.Effect<number, MultiAssetError> = Effect.fn(
  (instance: CML.MultiAsset) =>
    Effect.try({
 ...
 * @category Methods
 */
export const insertAssets: (instance: CML.MultiAsset, policyId: CML.ScriptHash, assets: CML.MapAssetNameToCoin) => Effect.Effect<CML.MapAssetNameToCoin | undefined, MultiAssetError> = Effect.fn(
  (instance: CML.MultiAsset, policyId: CML.ScriptHash, assets: CML.MapAssetNameToCoin) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const insertAssetsUnsafe = (instance: CML.MultiAsset, policyId: CML.ScriptHash, assets: CML.MapAssetNameToCoin): CML.MapAssetNameToCoin | undefined =>
 ...
 * @category Methods
 */
export const getAssets: (instance: CML.MultiAsset, key: CML.ScriptHash) => Effect.Effect<CML.MapAssetNameToCoin | undefined, MultiAssetError> = Effect.fn(
  (instance: CML.MultiAsset, key: CML.ScriptHash) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const getAssetsUnsafe = (instance: CML.MultiAsset, key: CML.ScriptHash): CML.MapAssetNameToCoin | undefined =>
 ...
 * @category Methods
 */
export const get: (instance: CML.MultiAsset, policyId: CML.ScriptHash, asset: CML.AssetName) => Effect.Effect<bigint | undefined, MultiAssetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const getUnsafe = (instance: CML.MultiAsset, policyId: CML.ScriptHash, asset: CML.AssetName): bigint | undefined =>
 ...
 * @category Methods
 */
export const set: (instance: CML.MultiAsset, policyId: CML.ScriptHash, asset: CML.AssetName, value: bigint) => Effect.Effect<bigint | undefined, MultiAssetError> = Effect.fn(
  (instance: CML.MultiAsset, policyId: CML.ScriptHash, asset: CML.AssetName, value: bigint) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const setUnsafe = (instance: CML.MultiAsset, policyId: CML.ScriptHash, asset: CML.AssetName, value: bigint): bigint | undefined =>
 ...
 * @category Methods
 */
export const keys: (instance: CML.MultiAsset) => Effect.Effect<CML.PolicyIdList, MultiAssetError> = Effect.fn(
  (instance: CML.MultiAsset) =>
    Effect.try({
      try: () => instance.keys(),
      catch: () =>
 ...
 * @category Methods
 */
export const checkedAdd: (instance: CML.MultiAsset, rhs: CML.MultiAsset) => Effect.Effect<CML.MultiAsset, MultiAssetError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const checkedAddUnsafe = (instance: CML.MultiAsset, rhs: CML.MultiAsset): CML.MultiAsset =>
 ...
 * @category Methods
 */
export const checkedSub: (instance: CML.MultiAsset, rhs: CML.MultiAsset) => Effect.Effect<CML.MultiAsset, MultiAssetError> = Effect.fn(
  (instance: CML.MultiAsset, rhs: CML.MultiAsset) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const checkedSubUnsafe = (instance: CML.MultiAsset, rhs: CML.MultiAsset): CML.MultiAsset =>
 ...
 * @category Methods
 */
export const clampedSub: (instance: CML.MultiAsset, rhs: CML.MultiAsset) => Effect.Effect<CML.MultiAsset, MultiAssetError> = Effect.fn(
  (instance: CML.MultiAsset, rhs: CML.MultiAsset) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const clampedSubUnsafe = (instance: CML.MultiAsset, rhs: CML.MultiAsset): CML.MultiAsset =>
