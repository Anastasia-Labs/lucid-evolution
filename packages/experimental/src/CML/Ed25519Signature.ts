 ...
 * @category Methods
 */
export const free: (instance: CML.Ed25519Signature) => Effect.Effect<void, Ed25519SignatureError> = Effect.fn(
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.Ed25519Signature) => Effect.Effect<string, Ed25519SignatureError> = Effect.fn(
  (instance: CML.Ed25519Signature) =>
    Effect.try({
 ...
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.Ed25519Signature, Ed25519SignatureError> = Effect.fn(function* (bech32Str: string) {
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.Ed25519Signature) => Effect.Effect<Uint8Array, Ed25519SignatureError> = Effect.fn(
  (instance: CML.Ed25519Signature) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.Ed25519Signature, Ed25519SignatureError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.Ed25519Signature) => Effect.Effect<string, Ed25519SignatureError> = Effect.fn(
  (instance: CML.Ed25519Signature) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.Ed25519Signature, Ed25519SignatureError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
