 ...
 * @category Errors
 */
export class TxRedeemerBuilderError extends Data.TaggedError("TxRedeemerBuilderError")<{
  message?: string;
}> {}
 ...
 * @category Methods
 */
export const free: (instance: CML.TxRedeemerBuilder) => Effect.Effect<void, TxRedeemerBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const build: (instance: CML.TxRedeemerBuilder) => Effect.Effect<CML.Redeemers, TxRedeemerBuilderError> = Effect.fn(
  (instance: CML.TxRedeemerBuilder) =>
    Effect.try({
      try: () => instance.build(),
      catch: () =>
 ...
 * @category Methods
 */
export const setExunits: (instance: CML.TxRedeemerBuilder, redeemer: CML.RedeemerWitnessKey, exUnits: CML.ExUnits) => Effect.Effect<void, TxRedeemerBuilderError> = Effect.fn(
  (instance: CML.TxRedeemerBuilder, redeemer: CML.RedeemerWitnessKey, exUnits: CML.ExUnits) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const setExunitsUnsafe = (instance: CML.TxRedeemerBuilder, redeemer: CML.RedeemerWitnessKey, exUnits: CML.ExUnits): void =>
 ...
 * @category Methods
 */
export const draftBody: (instance: CML.TxRedeemerBuilder) => Effect.Effect<CML.TransactionBody, TxRedeemerBuilderError> = Effect.fn(
  (instance: CML.TxRedeemerBuilder) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const draftBodyUnsafe = (instance: CML.TxRedeemerBuilder): CML.TransactionBody =>
  Effect.runSync(draftBody(instance));
 ...
 * @category Methods
 */
export const auxiliaryData: (instance: CML.TxRedeemerBuilder) => Effect.Effect<CML.AuxiliaryData | undefined, TxRedeemerBuilderError> = Effect.fn(
  (instance: CML.TxRedeemerBuilder) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const auxiliaryDataUnsafe = (instance: CML.TxRedeemerBuilder): CML.AuxiliaryData | undefined =>
 ...
 * @category Methods
 */
export const draftTx: (instance: CML.TxRedeemerBuilder) => Effect.Effect<CML.Transaction, TxRedeemerBuilderError> = Effect.fn(
  (instance: CML.TxRedeemerBuilder) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const draftTxUnsafe = (instance: CML.TxRedeemerBuilder): CML.Transaction =>
  Effect.runSync(draftTx(instance));
