 ...
 * @category Methods
 */
export const unsafeSetExunits = (instance: CML.TxRedeemerBuilder, redeemer: CML.RedeemerWitnessKey, exUnits: CML.ExUnits): void =>
 ...
 * @category Methods
 */
export const unsafeDraftBody = (instance: CML.TxRedeemerBuilder): CML.TransactionBody =>
 ...
 * @category Methods
 */
export const unsafeAuxiliaryData = (instance: CML.TxRedeemerBuilder): CML.AuxiliaryData | undefined =>
 ...
 * @category Methods
 */
export const unsafeDraftTx = (instance: CML.TxRedeemerBuilder): CML.Transaction =>
