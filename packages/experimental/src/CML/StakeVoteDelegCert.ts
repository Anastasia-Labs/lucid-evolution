 ...
 * @category Methods
 */
export const free: (instance: CML.StakeVoteDelegCert) => Effect.Effect<void, StakeVoteDelegCertError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.StakeVoteDelegCert) => Effect.Effect<Uint8Array, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.StakeVoteDelegCert) => Effect.Effect<Uint8Array, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.StakeVoteDelegCert, StakeVoteDelegCertError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.StakeVoteDelegCert =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.StakeVoteDelegCert) => Effect.Effect<string, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.StakeVoteDelegCert) => Effect.Effect<string, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.StakeVoteDelegCert, StakeVoteDelegCertError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.StakeVoteDelegCert) => Effect.Effect<string, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.StakeVoteDelegCert) => Effect.Effect<any, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.StakeVoteDelegCert, StakeVoteDelegCertError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const stakeCredential: (instance: CML.StakeVoteDelegCert) => Effect.Effect<CML.Credential, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const pool: (instance: CML.StakeVoteDelegCert) => Effect.Effect<CML.Ed25519KeyHash, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
      try: () => instance.pool(),
      catch: () =>
 ...
 * @category Methods
 */
export const dRep: (instance: CML.StakeVoteDelegCert) => Effect.Effect<CML.DRep, StakeVoteDelegCertError> = Effect.fn(
  (instance: CML.StakeVoteDelegCert) =>
    Effect.try({
      try: () => instance.d_rep(),
      catch: () =>
 ...
 * @category Constructors
 */
export const _new: (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, dRep: CML.DRep) => Effect.Effect<CML.StakeVoteDelegCert, StakeVoteDelegCertError> = Effect.fn(function* (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, dRep: CML.DRep) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, dRep: CML.DRep): CML.StakeVoteDelegCert =>
