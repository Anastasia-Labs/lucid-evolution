 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.StakeVoteDelegCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.StakeVoteDelegCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.StakeVoteDelegCert): string =>
 ...
 * @category Methods
 */
export const unsafeStakeCredential = (instance: CML.StakeVoteDelegCert): CML.Credential =>
 ...
 * @category Methods
 */
export const unsafePool = (instance: CML.StakeVoteDelegCert): CML.Ed25519KeyHash =>
 ...
 * @category Constructors
 */
export const unsafe_new = (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, dRep: CML.DRep) =>
