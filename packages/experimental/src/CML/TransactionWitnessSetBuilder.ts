 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const addVkey: (instance: CML.TransactionWitnessSetBuilder, vkeyWitness: CML.Vkeywitness) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const addBootstrap: (instance: CML.TransactionWitnessSetBuilder, bootstrap: CML.BootstrapWitness) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder, bootstrap: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category Methods
 */
export const addScript: (instance: CML.TransactionWitnessSetBuilder, script: CML.Script) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const getNativeScript: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.NativeScriptList, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const getPlutusV1Script: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.PlutusV1ScriptList, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const getPlutusV2Script: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.PlutusV2ScriptList, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const addPlutusDatum: (instance: CML.TransactionWitnessSetBuilder, plutusDatum: CML.PlutusData) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const getPlutusDatum: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.PlutusDataList, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const addRedeemer: (instance: CML.TransactionWitnessSetBuilder, redeemer: CML.LegacyRedeemer) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const getRedeemer: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.LegacyRedeemerList, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const addRequiredWits: (instance: CML.TransactionWitnessSetBuilder, requiredWits: CML.RequiredWitnessSet) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder, requiredWits: CML.RequiredWitnessSet) =>
    Effect.try({
 ...
 */
export const _new: () => Effect.Effect<CML.TransactionWitnessSetBuilder, TransactionWitnessSetBuilderError> = Effect.fn(function* () {
 ...
 * @category Methods
 */
export const addExisting: (instance: CML.TransactionWitnessSetBuilder, witSet: CML.TransactionWitnessSet) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder, witSet: CML.TransactionWitnessSet) =>
    Effect.try({
 ...
 * @category Methods
 */
export const build: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.TransactionWitnessSet, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
      try: () => instance.build(),
      catch: () =>
 ...
 * @category Methods
 */
export const remainingWits: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.RequiredWitnessSet, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const tryBuild: (instance: CML.TransactionWitnessSetBuilder) => Effect.Effect<CML.TransactionWitnessSet, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const mergeFakeWitness: (instance: CML.TransactionWitnessSetBuilder, requiredWits: CML.RequiredWitnessSet) => Effect.Effect<void, TransactionWitnessSetBuilderError> = Effect.fn(
  (instance: CML.TransactionWitnessSetBuilder, requiredWits: CML.RequiredWitnessSet) =>
    Effect.try({
