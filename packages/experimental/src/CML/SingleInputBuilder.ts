 ...
 * @category Constructors
 */
export const unsafe_new = (input: CML.TransactionInput, utxoInfo: CML.TransactionOutput) =>
 ...
 * @category Constructors
 */
export const unsafeFromTransactionUnspentOutput = (utxo: CML.TransactionUnspentOutput) =>
 ...
 * @category Methods
 */
export const unsafePaymentKey = (instance: CML.SingleInputBuilder): CML.InputBuilderResult =>
 ...
 * @category Methods
 */
export const unsafeNativeScript = (instance: CML.SingleInputBuilder, _nativeScript: CML.NativeScript, witnessInfo: CML.NativeScriptWitnessInfo): CML.InputBuilderResult =>
 ...
 * @category Methods
 */
export const unsafePlutusScript = (instance: CML.SingleInputBuilder, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList, datum: CML.PlutusData): CML.InputBuilderResult =>
 ...
 * @category Methods
 */
export const unsafePlutusScriptInlineDatum = (instance: CML.SingleInputBuilder, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList): CML.InputBuilderResult =>
