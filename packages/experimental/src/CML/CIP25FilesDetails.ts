...
export const free = Effect.fn(
  (instance: CML.CIP25FilesDetails): Effect.Effect<void, CIP25FilesDetailsError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes = Effect.fn(
  (instance: CML.CIP25FilesDetails): Effect.Effect<Uint8Array, CIP25FilesDetailsError> =>
    Effect.try({
...
export const toCborHex = Effect.fn(
  (instance: CML.CIP25FilesDetails): Effect.Effect<string, CIP25FilesDetailsError> =>
    Effect.try({
...
export const toJsValue = Effect.fn(
  (instance: CML.CIP25FilesDetails): Effect.Effect<any, CIP25FilesDetailsError> =>
    Effect.try({
...
export const name = Effect.fn(
  (instance: CML.CIP25FilesDetails): Effect.Effect<CML.CIP25String64, CIP25FilesDetailsError> =>
    Effect.try({
      try: () => instance.name(),
      catch: () =>
        new CIP25FilesDetailsError({
...
export const src = Effect.fn(
  (instance: CML.CIP25FilesDetails): Effect.Effect<CML.CIP25ChunkableString, CIP25FilesDetailsError> =>
    Effect.try({
      try: () => instance.src(),
      catch: () =>
        new CIP25FilesDetailsError({
 ...
 * @category Constructors
 */
export const _new = Effect.fn(function* (name: CML.CIP25String64, mediaType: CML.CIP25String64, src: CML.CIP25ChunkableString) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (name: CML.CIP25String64, mediaType: CML.CIP25String64, src: CML.CIP25ChunkableString) =>
