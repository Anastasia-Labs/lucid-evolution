 ...
 * @category Errors
 */
export class CIP25FilesDetailsError extends Data.TaggedError("CIP25FilesDetailsError")<{
  message?: string;
}> {}
 ...
 * @category Methods
 */
export const free: (instance: CML.CIP25FilesDetails) => Effect.Effect<void, CIP25FilesDetailsError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP25FilesDetails) => Effect.Effect<Uint8Array, CIP25FilesDetailsError> = Effect.fn(
  (instance: CML.CIP25FilesDetails) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborBytesUnsafe = (instance: CML.CIP25FilesDetails): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.CIP25FilesDetails, CIP25FilesDetailsError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
    try: () => CML.CIP25FilesDetails.from_cbor_bytes(cborBytes),
    catch: () => new CIP25FilesDetailsError({
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.CIP25FilesDetails =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.CIP25FilesDetails) => Effect.Effect<string, CIP25FilesDetailsError> = Effect.fn(
  (instance: CML.CIP25FilesDetails) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.CIP25FilesDetails, CIP25FilesDetailsError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP25FilesDetails) => Effect.Effect<string, CIP25FilesDetailsError> = Effect.fn(
  (instance: CML.CIP25FilesDetails) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP25FilesDetails) => Effect.Effect<any, CIP25FilesDetailsError> = Effect.fn(
  (instance: CML.CIP25FilesDetails) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP25FilesDetails, CIP25FilesDetailsError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const name: (instance: CML.CIP25FilesDetails) => Effect.Effect<CML.CIP25String64, CIP25FilesDetailsError> = Effect.fn(
  (instance: CML.CIP25FilesDetails) =>
    Effect.try({
      try: () => instance.name(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const nameUnsafe = (instance: CML.CIP25FilesDetails): CML.CIP25String64 =>
 ...
 * @category Methods
 */
export const mediaType: (instance: CML.CIP25FilesDetails) => Effect.Effect<CML.CIP25String64, CIP25FilesDetailsError> = Effect.fn(
  (instance: CML.CIP25FilesDetails) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const mediaTypeUnsafe = (instance: CML.CIP25FilesDetails): CML.CIP25String64 =>
 ...
 * @category Methods
 */
export const src: (instance: CML.CIP25FilesDetails) => Effect.Effect<CML.CIP25ChunkableString, CIP25FilesDetailsError> = Effect.fn(
  (instance: CML.CIP25FilesDetails) =>
    Effect.try({
      try: () => instance.src(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const srcUnsafe = (instance: CML.CIP25FilesDetails): CML.CIP25ChunkableString =>
  Effect.runSync(src(instance));
 ...
 * @category Constructors
 */
export const _new: (name: CML.CIP25String64, mediaType: CML.CIP25String64, src: CML.CIP25ChunkableString) => Effect.Effect<CML.CIP25FilesDetails, CIP25FilesDetailsError> = Effect.fn(function* (name: CML.CIP25String64, mediaType: CML.CIP25String64, src: CML.CIP25ChunkableString) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (name: CML.CIP25String64, mediaType: CML.CIP25String64, src: CML.CIP25ChunkableString): CML.CIP25FilesDetails =>
