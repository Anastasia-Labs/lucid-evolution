 ...
 * @category Constructors
 */
export const unsafeNewSingleHostAddr = (port: number, ipv4: CML.Ipv4, ipv6: CML.Ipv6) =>
 ...
 * @category Constructors
 */
export const unsafeNewSingleHostName = (port: number | undefined, dnsName: CML.DNSName) =>
 ...
 * @category Methods
 */
export const unsafeAsSingleHostAddr = (instance: CML.Relay): CML.SingleHostAddr | undefined =>
 ...
 * @category Methods
 */
export const unsafeAsSingleHostName = (instance: CML.Relay): CML.SingleHostName | undefined =>
 ...
 * @category Methods
 */
export const unsafeAsMultiHostName = (instance: CML.Relay): CML.MultiHostName | undefined =>
