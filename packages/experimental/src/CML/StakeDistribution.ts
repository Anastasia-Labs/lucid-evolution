 ...
 * @category Methods
 */
export const free: (instance: CML.StakeDistribution) => Effect.Effect<void, StakeDistributionError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.StakeDistribution) => Effect.Effect<Uint8Array, StakeDistributionError> = Effect.fn(
  (instance: CML.StakeDistribution) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.StakeDistribution, StakeDistributionError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.StakeDistribution =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.StakeDistribution) => Effect.Effect<string, StakeDistributionError> = Effect.fn(
  (instance: CML.StakeDistribution) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.StakeDistribution, StakeDistributionError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newSingleKey: (stakeholderId: CML.StakeholderId) => Effect.Effect<CML.StakeDistribution, StakeDistributionError> = Effect.fn(function* (stakeholderId: CML.StakeholderId) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newSingleKeyUnsafe = (stakeholderId: CML.StakeholderId): CML.StakeDistribution =>
 ...
 * @category Constructors
 */
export const newBootstrapEra: () => Effect.Effect<CML.StakeDistribution, StakeDistributionError> = Effect.fn(function* () {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const kind: (instance: CML.StakeDistribution) => Effect.Effect<CML.StakeDistributionKind, StakeDistributionError> = Effect.fn(
  (instance: CML.StakeDistribution) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asSingleKey: (instance: CML.StakeDistribution) => Effect.Effect<CML.StakeholderId | undefined, StakeDistributionError> = Effect.fn(
  (instance: CML.StakeDistribution) =>
    Effect.try({
