 ...
 * @category Methods
 */
export const free: (instance: CML.RedeemerVal) => Effect.Effect<void, RedeemerValError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.RedeemerVal) => Effect.Effect<Uint8Array, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.RedeemerVal) => Effect.Effect<Uint8Array, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.RedeemerVal, RedeemerValError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.RedeemerVal) => Effect.Effect<string, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.RedeemerVal) => Effect.Effect<string, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.RedeemerVal, RedeemerValError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.RedeemerVal) => Effect.Effect<string, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.RedeemerVal) => Effect.Effect<any, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.RedeemerVal, RedeemerValError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const data: (instance: CML.RedeemerVal) => Effect.Effect<CML.PlutusData, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
      try: () => instance.data(),
      catch: () =>
 ...
 * @category Methods
 */
export const exUnits: (instance: CML.RedeemerVal) => Effect.Effect<CML.ExUnits, RedeemerValError> = Effect.fn(
  (instance: CML.RedeemerVal) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const _new: (data: CML.PlutusData, exUnits: CML.ExUnits) => Effect.Effect<CML.RedeemerVal, RedeemerValError> = Effect.fn(function* (data: CML.PlutusData, exUnits: CML.ExUnits) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (data: CML.PlutusData, exUnits: CML.ExUnits): CML.RedeemerVal =>
