 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.ResignCommitteeColdCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.ResignCommitteeColdCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCborHex = (instance: CML.ResignCommitteeColdCert): string =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.ResignCommitteeColdCert): string =>
 ...
 * @category Methods
 */
export const unsafeCommitteeColdCredential = (instance: CML.ResignCommitteeColdCert): CML.Credential =>
 ...
 * @category Methods
 */
export const unsafeAnchor = (instance: CML.ResignCommitteeColdCert): CML.Anchor | undefined =>
 ...
 * @category Constructors
 */
export const unsafe_new = (committeeColdCredential: CML.Credential, anchor: CML.Anchor) =>
