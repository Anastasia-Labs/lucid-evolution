 ...
 * @category Methods
 */
export const free: (instance: CML.DatumOption) => Effect.Effect<void, DatumOptionError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.DatumOption) => Effect.Effect<Uint8Array, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.DatumOption) => Effect.Effect<Uint8Array, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.DatumOption, DatumOptionError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.DatumOption) => Effect.Effect<string, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.DatumOption) => Effect.Effect<string, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.DatumOption, DatumOptionError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.DatumOption) => Effect.Effect<string, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.DatumOption) => Effect.Effect<any, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.DatumOption, DatumOptionError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newHash: (datumHash: CML.DatumHash) => Effect.Effect<CML.DatumOption, DatumOptionError> = Effect.fn(function* (datumHash: CML.DatumHash) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newDatum: (datum: CML.PlutusData) => Effect.Effect<CML.DatumOption, DatumOptionError> = Effect.fn(function* (datum: CML.PlutusData) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const kind: (instance: CML.DatumOption) => Effect.Effect<CML.DatumOptionKind, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asHash: (instance: CML.DatumOption) => Effect.Effect<CML.DatumHash | undefined, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
 ...
 * @category Methods
 */
export const asDatum: (instance: CML.DatumOption) => Effect.Effect<CML.PlutusData | undefined, DatumOptionError> = Effect.fn(
  (instance: CML.DatumOption) =>
    Effect.try({
