...
) => Effect.Effect<void, Bip32PublicKeyError> = Effect.fn(
  (instance: CML.Bip32PublicKey) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const derive: (
  instance: CML.Bip32PublicKey,
  index: number,
) => Effect.Effect<CML.Bip32PublicKey, Bip32PublicKeyError> = Effect.fn(
...
export const toRawKey: (
  instance: CML.Bip32PublicKey,
) => Effect.Effect<CML.PublicKey, Bip32PublicKeyError> = Effect.fn(
  (instance: CML.Bip32PublicKey) =>
    Effect.try({
...
export const toRawBytes: (
  instance: CML.Bip32PublicKey,
) => Effect.Effect<Uint8Array, Bip32PublicKeyError> = Effect.fn(
  (instance: CML.Bip32PublicKey) =>
    Effect.try({
...
export const toBech32: (
  instance: CML.Bip32PublicKey,
) => Effect.Effect<string, Bip32PublicKeyError> = Effect.fn(
  (instance: CML.Bip32PublicKey) =>
    Effect.try({
