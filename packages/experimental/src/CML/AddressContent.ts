 ...
 */
export const hashAndCreateUnsafe = (addrType: CML.ByronAddrType, spendingData: CML.SpendingData, attributes: CML.AddrAttributes) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newRedeemUnsafe = (pubkey: CML.PublicKey, protocolMagic: CML.ProtocolMagic) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newSimpleUnsafe = (xpub: CML.Bip32PublicKey, protocolMagic: CML.ProtocolMagic) =>
 ...
 * @category ConstructorsUnsafe
 */
export const icarusFromKeyUnsafe = (key: CML.Bip32PublicKey, protocolMagic: CML.ProtocolMagic) =>
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (addressId: CML.AddressId, addrAttributes: CML.AddrAttributes, addrType: CML.ByronAddrType) =>
