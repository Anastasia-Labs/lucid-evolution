 ...
 * @category Methods
 */
export const free: (instance: CML.ScriptDataHash) => Effect.Effect<void, ScriptDataHashError> = Effect.fn(
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.ScriptDataHash, prefix: string) => Effect.Effect<string, ScriptDataHashError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const toBech32Unsafe = (instance: CML.ScriptDataHash, prefix: string): string =>
 ...
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.ScriptDataHash, ScriptDataHashError> = Effect.fn(function* (bech32Str: string) {
  return yield* Effect.try({
    try: () => CML.ScriptDataHash.from_bech32(bech32Str),
    catch: () => new ScriptDataHashError({
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.ScriptDataHash) => Effect.Effect<Uint8Array, ScriptDataHashError> = Effect.fn(
  (instance: CML.ScriptDataHash) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.ScriptDataHash, ScriptDataHashError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.ScriptDataHash) => Effect.Effect<string, ScriptDataHashError> = Effect.fn(
  (instance: CML.ScriptDataHash) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.ScriptDataHash, ScriptDataHashError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
