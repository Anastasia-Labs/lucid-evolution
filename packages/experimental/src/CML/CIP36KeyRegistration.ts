 ...
 * @category Methods
 */
export const free: (instance: CML.CIP36KeyRegistration) => Effect.Effect<void, CIP36KeyRegistrationError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP36KeyRegistration) => Effect.Effect<Uint8Array, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborBytesUnsafe = (instance: CML.CIP36KeyRegistration): Uint8Array =>
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.CIP36KeyRegistration) => Effect.Effect<Uint8Array, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.CIP36KeyRegistration): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.CIP36KeyRegistration, CIP36KeyRegistrationError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.CIP36KeyRegistration =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.CIP36KeyRegistration) => Effect.Effect<string, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.CIP36KeyRegistration) => Effect.Effect<string, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.CIP36KeyRegistration): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.CIP36KeyRegistration, CIP36KeyRegistrationError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborHexUnsafe = (cborBytes: string): CML.CIP36KeyRegistration =>
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP36KeyRegistration) => Effect.Effect<string, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP36KeyRegistration) => Effect.Effect<any, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP36KeyRegistration, CIP36KeyRegistrationError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const delegation: (instance: CML.CIP36KeyRegistration) => Effect.Effect<CML.CIP36DelegationDistribution, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const delegationUnsafe = (instance: CML.CIP36KeyRegistration): CML.CIP36DelegationDistribution =>
 ...
 * @category Methods
 */
export const stakeCredential: (instance: CML.CIP36KeyRegistration) => Effect.Effect<CML.PublicKey, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const stakeCredentialUnsafe = (instance: CML.CIP36KeyRegistration): CML.PublicKey =>
 ...
 * @category Methods
 */
export const paymentAddress: (instance: CML.CIP36KeyRegistration) => Effect.Effect<CML.Address, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const paymentAddressUnsafe = (instance: CML.CIP36KeyRegistration): CML.Address =>
 ...
 * @category Methods
 */
export const nonce: (instance: CML.CIP36KeyRegistration) => Effect.Effect<bigint, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
      try: () => instance.nonce(),
      catch: () =>
 ...
 * @category Methods
 */
export const setVotingPurpose: (instance: CML.CIP36KeyRegistration, votingPurpose: bigint) => Effect.Effect<void, CIP36KeyRegistrationError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setVotingPurposeUnsafe = (instance: CML.CIP36KeyRegistration, votingPurpose: bigint): void =>
 ...
 * @category Methods
 */
export const votingPurpose: (instance: CML.CIP36KeyRegistration) => Effect.Effect<bigint, CIP36KeyRegistrationError> = Effect.fn(
  (instance: CML.CIP36KeyRegistration) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const votingPurposeUnsafe = (instance: CML.CIP36KeyRegistration): bigint =>
