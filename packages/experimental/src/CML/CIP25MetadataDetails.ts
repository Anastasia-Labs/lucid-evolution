 ...
 * @category Errors
 */
export class CIP25MetadataDetailsError extends Data.TaggedError("CIP25MetadataDetailsError")<{
  message?: string;
}> {}
 ...
 * @category Methods
 */
export const free: (instance: CML.CIP25MetadataDetails) => Effect.Effect<void, CIP25MetadataDetailsError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP25MetadataDetails) => Effect.Effect<Uint8Array, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborBytesUnsafe = (instance: CML.CIP25MetadataDetails): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.CIP25MetadataDetails, CIP25MetadataDetailsError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
    try: () => CML.CIP25MetadataDetails.from_cbor_bytes(cborBytes),
    catch: () => new CIP25MetadataDetailsError({
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.CIP25MetadataDetails =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.CIP25MetadataDetails) => Effect.Effect<string, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.CIP25MetadataDetails, CIP25MetadataDetailsError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborHexUnsafe = (cborBytes: string): CML.CIP25MetadataDetails =>
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP25MetadataDetails) => Effect.Effect<string, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP25MetadataDetails) => Effect.Effect<any, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP25MetadataDetails, CIP25MetadataDetailsError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const name: (instance: CML.CIP25MetadataDetails) => Effect.Effect<CML.CIP25String64, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
      try: () => instance.name(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const nameUnsafe = (instance: CML.CIP25MetadataDetails): CML.CIP25String64 =>
 ...
 * @category Methods
 */
export const image: (instance: CML.CIP25MetadataDetails) => Effect.Effect<CML.CIP25ChunkableString, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
      try: () => instance.image(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const imageUnsafe = (instance: CML.CIP25MetadataDetails): CML.CIP25ChunkableString =>
 ...
 * @category Methods
 */
export const setMediaType: (instance: CML.CIP25MetadataDetails, mediaType: CML.CIP25String64) => Effect.Effect<void, CIP25MetadataDetailsError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setMediaTypeUnsafe = (instance: CML.CIP25MetadataDetails, mediaType: CML.CIP25String64): void =>
  Effect.runSync(setMediaType(instance, mediaType));
 ...
 * @category Methods
 */
export const mediaType: (instance: CML.CIP25MetadataDetails) => Effect.Effect<CML.CIP25String64 | undefined, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const mediaTypeUnsafe = (instance: CML.CIP25MetadataDetails): CML.CIP25String64 | undefined =>
  Effect.runSync(mediaType(instance));
 ...
 * @category Methods
 */
export const setDescription: (instance: CML.CIP25MetadataDetails, description: CML.CIP25ChunkableString) => Effect.Effect<void, CIP25MetadataDetailsError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setDescriptionUnsafe = (instance: CML.CIP25MetadataDetails, description: CML.CIP25ChunkableString): void =>
  Effect.runSync(setDescription(instance, description));
 ...
 * @category Methods
 */
export const description: (instance: CML.CIP25MetadataDetails) => Effect.Effect<CML.CIP25ChunkableString | undefined, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const descriptionUnsafe = (instance: CML.CIP25MetadataDetails): CML.CIP25ChunkableString | undefined =>
 ...
 * @category Methods
 */
export const setFiles: (instance: CML.CIP25MetadataDetails, files: CML.FilesDetailsList) => Effect.Effect<void, CIP25MetadataDetailsError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const setFilesUnsafe = (instance: CML.CIP25MetadataDetails, files: CML.FilesDetailsList): void =>
  Effect.runSync(setFiles(instance, files));
 ...
 * @category Methods
 */
export const files: (instance: CML.CIP25MetadataDetails) => Effect.Effect<CML.FilesDetailsList | undefined, CIP25MetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MetadataDetails) =>
    Effect.try({
      try: () => instance.files(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const filesUnsafe = (instance: CML.CIP25MetadataDetails): CML.FilesDetailsList | undefined =>
  Effect.runSync(files(instance));
 ...
 * @category Constructors
 */
export const _new: (name: CML.CIP25String64, image: CML.CIP25ChunkableString) => Effect.Effect<CML.CIP25MetadataDetails, CIP25MetadataDetailsError> = Effect.fn(function* (name: CML.CIP25String64, image: CML.CIP25ChunkableString) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (name: CML.CIP25String64, image: CML.CIP25ChunkableString): CML.CIP25MetadataDetails =>
