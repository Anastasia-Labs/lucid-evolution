...
export const free = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<void, CIP25MetadataDetailsError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<Uint8Array, CIP25MetadataDetailsError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.CIP25MetadataDetails): Uint8Array =>
...
export const toCborHex = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<string, CIP25MetadataDetailsError> =>
    Effect.try({
...
export const toJsValue = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<any, CIP25MetadataDetailsError> =>
    Effect.try({
...
export const name = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<CML.CIP25String64, CIP25MetadataDetailsError> =>
    Effect.try({
      try: () => instance.name(),
      catch: () =>
        new CIP25MetadataDetailsError({
 ...
 * @category Methods
 */
export const unsafeName = (instance: CML.CIP25MetadataDetails): CML.CIP25String64 =>
...
export const image = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<CML.CIP25ChunkableString, CIP25MetadataDetailsError> =>
    Effect.try({
      try: () => instance.image(),
      catch: () =>
        new CIP25MetadataDetailsError({
 ...
 * @category Methods
 */
export const unsafeImage = (instance: CML.CIP25MetadataDetails): CML.CIP25ChunkableString =>
...
export const setMediaType = Effect.fn(
  (instance: CML.CIP25MetadataDetails, mediaType: CML.CIP25String64): Effect.Effect<void, CIP25MetadataDetailsError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeSetMediaType = (instance: CML.CIP25MetadataDetails, mediaType: CML.CIP25String64): void =>
...
export const mediaType = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<CML.CIP25String64 | undefined, CIP25MetadataDetailsError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeMediaType = (instance: CML.CIP25MetadataDetails): CML.CIP25String64 | undefined =>
...
export const setDescription = Effect.fn(
  (instance: CML.CIP25MetadataDetails, description: CML.CIP25ChunkableString): Effect.Effect<void, CIP25MetadataDetailsError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeSetDescription = (instance: CML.CIP25MetadataDetails, description: CML.CIP25ChunkableString): void =>
...
export const description = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<CML.CIP25ChunkableString | undefined, CIP25MetadataDetailsError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeDescription = (instance: CML.CIP25MetadataDetails): CML.CIP25ChunkableString | undefined =>
...
export const setFiles = Effect.fn(
  (instance: CML.CIP25MetadataDetails, files: CML.FilesDetailsList): Effect.Effect<void, CIP25MetadataDetailsError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeSetFiles = (instance: CML.CIP25MetadataDetails, files: CML.FilesDetailsList): void =>
...
export const files = Effect.fn(
  (instance: CML.CIP25MetadataDetails): Effect.Effect<CML.FilesDetailsList | undefined, CIP25MetadataDetailsError> =>
    Effect.try({
      try: () => instance.files(),
      catch: () =>
        new CIP25MetadataDetailsError({
 ...
 * @category Methods
 */
export const unsafeFiles = (instance: CML.CIP25MetadataDetails): CML.FilesDetailsList | undefined =>
 ...
 * @category Constructors
 */
export const _new = Effect.fn(function* (name: CML.CIP25String64, image: CML.CIP25ChunkableString) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const unsafe_new = (name: CML.CIP25String64, image: CML.CIP25ChunkableString) =>
