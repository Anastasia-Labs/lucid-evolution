...
) => Effect.Effect<void, NewConstitutionError> = Effect.fn(
  (instance: CML.NewConstitution) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.NewConstitution,
) => Effect.Effect<Uint8Array, NewConstitutionError> = Effect.fn(
  (instance: CML.NewConstitution) =>
    Effect.try({
...
) => Effect.Effect<CML.NewConstitution, NewConstitutionError> = Effect.fn(
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.NewConstitution => Effect.runSync(fromCborBytes(cborBytes));
...
export const toCborHex: (
  instance: CML.NewConstitution,
) => Effect.Effect<string, NewConstitutionError> = Effect.fn(
  (instance: CML.NewConstitution) =>
    Effect.try({
...
export const toJsValue: (
  instance: CML.NewConstitution,
) => Effect.Effect<any, NewConstitutionError> = Effect.fn(
  (instance: CML.NewConstitution) =>
    Effect.try({
...
export const actionId: (
  ...
  Effect.fn((instance: CML.NewConstitution) =>
    Effect.try({
...
export const constitution: (
  instance: CML.NewConstitution,
) => Effect.Effect<CML.Constitution, NewConstitutionError> = Effect.fn(
  (instance: CML.NewConstitution) =>
    Effect.try({
...
export const _newUnsafe = (
  actionId: CML.GovActionId | undefined,
  constitution: CML.Constitution,
): CML.NewConstitution => Effect.runSync(_new(actionId, constitution));
