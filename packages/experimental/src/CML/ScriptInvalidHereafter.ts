 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.ScriptInvalidHereafter): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.ScriptInvalidHereafter): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.ScriptInvalidHereafter): string =>
 ...
 * @category Constructors
 */
export const unsafe_new = (after: bigint) =>
