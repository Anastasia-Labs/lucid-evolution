 ...
 * @category Methods
 */
export const free: (instance: CML.SpendingData) => Effect.Effect<void, SpendingDataError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.SpendingData) => Effect.Effect<Uint8Array, SpendingDataError> = Effect.fn(
  (instance: CML.SpendingData) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.SpendingData, SpendingDataError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.SpendingData) => Effect.Effect<string, SpendingDataError> = Effect.fn(
  (instance: CML.SpendingData) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.SpendingData, SpendingDataError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newSpendingDataPubKey: (pubkey: CML.Bip32PublicKey) => Effect.Effect<CML.SpendingData, SpendingDataError> = Effect.fn(function* (pubkey: CML.Bip32PublicKey) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newSpendingDataPubKeyUnsafe = (pubkey: CML.Bip32PublicKey): CML.SpendingData =>
 ...
 * @category Constructors
 */
export const newSpendingDataScript: (script: CML.ByronScript) => Effect.Effect<CML.SpendingData, SpendingDataError> = Effect.fn(function* (script: CML.ByronScript) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newSpendingDataScriptUnsafe = (script: CML.ByronScript): CML.SpendingData =>
 ...
 * @category Constructors
 */
export const newSpendingDataRedeem: (redeem: CML.PublicKey) => Effect.Effect<CML.SpendingData, SpendingDataError> = Effect.fn(function* (redeem: CML.PublicKey) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newSpendingDataRedeemUnsafe = (redeem: CML.PublicKey): CML.SpendingData =>
 ...
 * @category Methods
 */
export const kind: (instance: CML.SpendingData) => Effect.Effect<CML.SpendingDataKind, SpendingDataError> = Effect.fn(
  (instance: CML.SpendingData) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asSpendingDataPubKey: (instance: CML.SpendingData) => Effect.Effect<CML.Bip32PublicKey | undefined, SpendingDataError> = Effect.fn(
  (instance: CML.SpendingData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asSpendingDataPubKeyUnsafe = (instance: CML.SpendingData): CML.Bip32PublicKey | undefined =>
 ...
 * @category Methods
 */
export const asSpendingDataScript: (instance: CML.SpendingData) => Effect.Effect<CML.ByronScript | undefined, SpendingDataError> = Effect.fn(
  (instance: CML.SpendingData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asSpendingDataScriptUnsafe = (instance: CML.SpendingData): CML.ByronScript | undefined =>
 ...
 * @category Methods
 */
export const asSpendingDataRedeem: (instance: CML.SpendingData) => Effect.Effect<CML.PublicKey | undefined, SpendingDataError> = Effect.fn(
  (instance: CML.SpendingData) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asSpendingDataRedeemUnsafe = (instance: CML.SpendingData): CML.PublicKey | undefined =>
