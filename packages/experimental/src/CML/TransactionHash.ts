 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionHash) => Effect.Effect<void, TransactionHashError> = Effect.fn(
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.TransactionHash, prefix: string) => Effect.Effect<string, TransactionHashError> = Effect.fn(
 ...
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.TransactionHash, TransactionHashError> = Effect.fn(function* (bech32Str: string) {
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.TransactionHash) => Effect.Effect<Uint8Array, TransactionHashError> = Effect.fn(
  (instance: CML.TransactionHash) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.TransactionHash, TransactionHashError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.TransactionHash) => Effect.Effect<string, TransactionHashError> = Effect.fn(
  (instance: CML.TransactionHash) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.TransactionHash, TransactionHashError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
