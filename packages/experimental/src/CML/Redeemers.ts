 ...
 * @category ConstructorsUnsafe
 */
export const newArrLegacyRedeemerUnsafe = (arrLegacyRedeemer: CML.LegacyRedeemerList) =>
 ...
 * @category ConstructorsUnsafe
 */
export const newMapRedeemerKeyToRedeemerValUnsafe = (mapRedeemerKeyToRedeemerVal: CML.MapRedeemerKeyToRedeemerVal) =>
