 ...
 * @category Methods
 */
export const free: (instance: CML.GovActionIdList) => Effect.Effect<void, GovActionIdListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.GovActionIdList, GovActionIdListError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.GovActionIdList =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.GovActionIdList) => Effect.Effect<number, GovActionIdListError> = Effect.fn(
  (instance: CML.GovActionIdList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.GovActionIdList, index: number) => Effect.Effect<CML.GovActionId, GovActionIdListError> = Effect.fn(
 ...
 * @category Methods
 */
export const add: (instance: CML.GovActionIdList, elem: CML.GovActionId) => Effect.Effect<void, GovActionIdListError> = Effect.fn(
