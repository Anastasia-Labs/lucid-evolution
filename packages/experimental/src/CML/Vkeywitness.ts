 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.Vkeywitness): Uint8Array =>
...
export const ed25519Signature = Effect.fn(
  (instance: CML.Vkeywitness): Effect.Effect<CML.Ed25519Signature, VkeywitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeEd25519Signature = (instance: CML.Vkeywitness): CML.Ed25519Signature =>
 ...
 * @category Constructors
 */
export const _new = Effect.fn(function* (vkey: CML.PublicKey, ed25519Signature: CML.Ed25519Signature) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const unsafe_new = (vkey: CML.PublicKey, ed25519Signature: CML.Ed25519Signature) =>
