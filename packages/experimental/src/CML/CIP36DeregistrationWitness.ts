...
export const free = Effect.fn(
  (instance: CML.CIP36DeregistrationWitness): Effect.Effect<void, CIP36DeregistrationWitnessError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes = Effect.fn(
  (instance: CML.CIP36DeregistrationWitness): Effect.Effect<Uint8Array, CIP36DeregistrationWitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.CIP36DeregistrationWitness): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.CIP36DeregistrationWitness): Uint8Array =>
...
export const toCborHex = Effect.fn(
  (instance: CML.CIP36DeregistrationWitness): Effect.Effect<string, CIP36DeregistrationWitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeToCborHex = (instance: CML.CIP36DeregistrationWitness): string =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.CIP36DeregistrationWitness): string =>
 ...
 * @category Methods
 */
export const unsafeToJson = (instance: CML.CIP36DeregistrationWitness): string =>
...
export const toJsValue = Effect.fn(
  (instance: CML.CIP36DeregistrationWitness): Effect.Effect<any, CIP36DeregistrationWitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeToJsValue = (instance: CML.CIP36DeregistrationWitness): any =>
...
export const stakeWitness = Effect.fn(
  (instance: CML.CIP36DeregistrationWitness): Effect.Effect<CML.Ed25519Signature, CIP36DeregistrationWitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeStakeWitness = (instance: CML.CIP36DeregistrationWitness): CML.Ed25519Signature =>
