...
) => Effect.Effect<void, AlonzoFormatTxOutError> = Effect.fn(
  (instance: CML.AlonzoFormatTxOut) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.AlonzoFormatTxOut,
) => Effect.Effect<Uint8Array, AlonzoFormatTxOutError> = Effect.fn(
  (instance: CML.AlonzoFormatTxOut) =>
    Effect.try({
...
) => Effect.Effect<CML.AlonzoFormatTxOut, AlonzoFormatTxOutError> = Effect.fn(
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.AlonzoFormatTxOut => Effect.runSync(fromCborBytes(cborBytes));
...
export const toCborHex: (
  instance: CML.AlonzoFormatTxOut,
) => Effect.Effect<string, AlonzoFormatTxOutError> = Effect.fn(
  (instance: CML.AlonzoFormatTxOut) =>
    Effect.try({
...
export const toJsValue: (
  instance: CML.AlonzoFormatTxOut,
) => Effect.Effect<any, AlonzoFormatTxOutError> = Effect.fn(
  (instance: CML.AlonzoFormatTxOut) =>
    Effect.try({
...
export const address: (
  instance: CML.AlonzoFormatTxOut,
) => Effect.Effect<CML.Address, AlonzoFormatTxOutError> = Effect.fn(
  (instance: CML.AlonzoFormatTxOut) =>
    Effect.try({
...
export const amount: (
  instance: CML.AlonzoFormatTxOut,
) => Effect.Effect<CML.Value, AlonzoFormatTxOutError> = Effect.fn(
  (instance: CML.AlonzoFormatTxOut) =>
    Effect.try({
      try: () => instance.amount(),
      catch: () =>
...
export const datumHash: (
  ...
  Effect.fn((instance: CML.AlonzoFormatTxOut) =>
    Effect.try({
...
export const _newUnsafe = (
  address: CML.Address,
  amount: CML.Value,
): CML.AlonzoFormatTxOut => Effect.runSync(_new(address, amount));
