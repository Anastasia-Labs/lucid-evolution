 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.AlonzoFormatTxOut): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.AlonzoFormatTxOut): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.AlonzoFormatTxOut): string =>
 ...
 * @category Methods
 */
export const unsafeSetDatumHash = (instance: CML.AlonzoFormatTxOut, datumHash: CML.DatumHash): void =>
 ...
 * @category Methods
 */
export const unsafeDatumHash = (instance: CML.AlonzoFormatTxOut): CML.DatumHash | undefined =>
