 ...
 * @category Methods
 */
export const unsafeLen = (instance: CML.MapStakeCredentialToDeltaCoin): number =>
 ...
 * @category Methods
 */
export const unsafeInsert = (instance: CML.MapStakeCredentialToDeltaCoin, key: CML.Credential, value: CML.Int): CML.Int | undefined =>
 ...
 * @category Methods
 */
export const unsafeGet = (instance: CML.MapStakeCredentialToDeltaCoin, key: CML.Credential): CML.Int | undefined =>
 ...
 * @category Methods
 */
export const unsafeKeys = (instance: CML.MapStakeCredentialToDeltaCoin): CML.StakeCredentialList =>
