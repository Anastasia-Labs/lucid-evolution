 ...
 * @category Methods
 */
export const free: (instance: CML.UpdateDrepCert) => Effect.Effect<void, UpdateDrepCertError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.UpdateDrepCert) => Effect.Effect<Uint8Array, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.UpdateDrepCert) => Effect.Effect<Uint8Array, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.UpdateDrepCert): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.UpdateDrepCert, UpdateDrepCertError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.UpdateDrepCert =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.UpdateDrepCert) => Effect.Effect<string, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.UpdateDrepCert) => Effect.Effect<string, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.UpdateDrepCert): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.UpdateDrepCert, UpdateDrepCertError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.UpdateDrepCert) => Effect.Effect<string, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.UpdateDrepCert) => Effect.Effect<any, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.UpdateDrepCert, UpdateDrepCertError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const drepCredential: (instance: CML.UpdateDrepCert) => Effect.Effect<CML.Credential, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const drepCredentialUnsafe = (instance: CML.UpdateDrepCert): CML.Credential =>
 ...
 * @category Methods
 */
export const anchor: (instance: CML.UpdateDrepCert) => Effect.Effect<CML.Anchor | undefined, UpdateDrepCertError> = Effect.fn(
  (instance: CML.UpdateDrepCert) =>
    Effect.try({
      try: () => instance.anchor(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const anchorUnsafe = (instance: CML.UpdateDrepCert): CML.Anchor | undefined =>
 ...
 * @category Constructors
 */
export const _new: (drepCredential: CML.Credential, anchor: CML.Anchor) => Effect.Effect<CML.UpdateDrepCert, UpdateDrepCertError> = Effect.fn(function* (drepCredential: CML.Credential, anchor: CML.Anchor) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (drepCredential: CML.Credential, anchor: CML.Anchor): CML.UpdateDrepCert =>
