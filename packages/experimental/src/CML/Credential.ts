 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.Credential): Uint8Array =>
...
export const kind = Effect.fn(
  (instance: CML.Credential): Effect.Effect<CML.CredentialKind, CredentialError> =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
        new CredentialError({
...
export const asPubKey = Effect.fn(
  (instance: CML.Credential): Effect.Effect<CML.Ed25519KeyHash | undefined, CredentialError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeAsPubKey = (instance: CML.Credential): CML.Ed25519KeyHash | undefined =>
...
export const asScript = Effect.fn(
  (instance: CML.Credential): Effect.Effect<CML.ScriptHash | undefined, CredentialError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeAsScript = (instance: CML.Credential): CML.ScriptHash | undefined =>
