 ...
 * @category Functions
 */
export const emip3EncryptWithPassword: (password: string, salt: string, nonce: string, data: string) => Effect.Effect<string, Emip3EncryptWithPasswordError> = Effect.fn(function* (password: string, salt: string, nonce: string, data: string) {
