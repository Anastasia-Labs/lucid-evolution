 ...
 * @category Functions
 */
export const minScriptFee = Effect.fn(function* (tx: CML.Transaction, exUnitPrices: CML.ExUnitPrices) {
 ...
 * @category Functions
 */
export const unsafeMinScriptFee = (tx: CML.Transaction, exUnitPrices: CML.ExUnitPrices): bigint =>
