 ...
 * @category Functions
 */
export const hashTransaction: (txBody: CML.TransactionBody) => Effect.Effect<CML.TransactionHash, HashTransactionError> = Effect.fn(function* (txBody: CML.TransactionBody) {
 ...
 */
export const hashTransactionUnsafe = (txBody: CML.TransactionBody): CML.TransactionHash =>
