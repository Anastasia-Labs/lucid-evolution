 ...
 * @category Functions
 */
export const makeIcarusBootstrapWitness = Effect.fn(function* (txBodyHash: CML.TransactionHash, addr: CML.ByronAddress, key: CML.Bip32PrivateKey) {
 ...
 * @category Functions
 */
export const unsafeMakeIcarusBootstrapWitness = (txBodyHash: CML.TransactionHash, addr: CML.ByronAddress, key: CML.Bip32PrivateKey): CML.BootstrapWitness =>
