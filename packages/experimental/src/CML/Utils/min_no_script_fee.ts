 ...
 * @category Functions
 */
export const minNoScriptFee: (tx: CML.Transaction, linearFee: CML.LinearFee) => Effect.Effect<bigint, MinNoScriptFeeError> = Effect.fn(function* (tx: CML.Transaction, linearFee: CML.LinearFee) {
 ...
 */
export const minNoScriptFeeUnsafe = (tx: CML.Transaction, linearFee: CML.LinearFee): bigint =>
