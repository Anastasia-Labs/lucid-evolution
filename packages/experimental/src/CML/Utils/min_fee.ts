 ...
 * @category Functions
 */
export const minFee = Effect.fn(function* (tx: CML.Transaction, linearFee: CML.LinearFee, exUnitPrices: CML.ExUnitPrices, totalRefScriptSize: bigint) {
 ...
 * @category Functions
 */
export const unsafeMinFee = (tx: CML.Transaction, linearFee: CML.LinearFee, exUnitPrices: CML.ExUnitPrices, totalRefScriptSize: bigint): bigint =>
