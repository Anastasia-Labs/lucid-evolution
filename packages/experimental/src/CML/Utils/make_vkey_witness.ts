 ...
 * @category Functions
 */
export const makeVkeyWitness: (txBodyHash: CML.TransactionHash, sk: CML.PrivateKey) => Effect.Effect<CML.Vkeywitness, MakeVkeyWitnessError> = Effect.fn(function* (txBodyHash: CML.TransactionHash, sk: CML.PrivateKey) {
