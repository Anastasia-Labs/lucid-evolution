 ...
 * @category Errors
 */
export class CalcScriptDataHashFromWitnessError extends Data.TaggedError("CalcScriptDataHashFromWitnessError")<{
  message?: string;
}> {}
 ...
 * @category Functions
 */
export const calcScriptDataHashFromWitness: (witnesses: CML.TransactionWitnessSet, costModels: CML.CostModels) => Effect.Effect<CML.ScriptDataHash | undefined, CalcScriptDataHashFromWitnessError> = Effect.fn(function* (witnesses: CML.TransactionWitnessSet, costModels: CML.CostModels) {
  return yield* Effect.try({
    try: () => CML.calc_script_data_hash_from_witness(witnesses, costModels),
    catch: () => new CalcScriptDataHashFromWitnessError({
 ...
 */
export const calcScriptDataHashFromWitnessUnsafe = (witnesses: CML.TransactionWitnessSet, costModels: CML.CostModels): CML.ScriptDataHash | undefined =>
