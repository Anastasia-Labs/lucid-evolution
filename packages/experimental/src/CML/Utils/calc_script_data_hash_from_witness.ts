 ...
 * @category Functions
 */
export const calcScriptDataHashFromWitness = Effect.fn(function* (witnesses: CML.TransactionWitnessSet, costModels: CML.CostModels) {
 ...
 * @category Functions
 */
export const unsafeCalcScriptDataHashFromWitness = (witnesses: CML.TransactionWitnessSet, costModels: CML.CostModels): CML.ScriptDataHash | undefined =>
