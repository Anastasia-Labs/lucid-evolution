 ...
 * @category Functions
 */
export const encodeJsonStrToPlutusDatum = Effect.fn(function* (json: string, schema: CML.CardanoNodePlutusDatumSchema) {
 ...
 * @category Functions
 */
export const unsafeEncodeJsonStrToPlutusDatum = (json: string, schema: CML.CardanoNodePlutusDatumSchema): CML.PlutusData =>
