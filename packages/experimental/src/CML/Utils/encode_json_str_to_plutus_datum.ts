 ...
 * @category Functions
 */
export const encodeJsonStrToPlutusDatum: (
  json: string,
  schema: CML.CardanoNodePlutusDatumSchema,
) => Effect.Effect<CML.PlutusData, EncodeJsonStrToPlutusDatumError> = Effect.fn(
  function* (json: string, schema: CML.CardanoNodePlutusDatumSchema) {
