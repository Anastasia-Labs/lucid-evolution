 ...
 * @category Functions
 */
export const hashAuxiliaryData: (auxiliaryData: CML.AuxiliaryData) => Effect.Effect<CML.AuxiliaryDataHash, HashAuxiliaryDataError> = Effect.fn(function* (auxiliaryData: CML.AuxiliaryData) {
