 ...
 * @category Functions
 */
export const calcScriptDataHash = Effect.fn(function* (redeemers: CML.Redeemers, datums: CML.PlutusDataList, costModels: CML.CostModels, usedLangs: CML.LanguageList) {
 ...
 * @category Functions
 */
export const unsafeCalcScriptDataHash = (redeemers: CML.Redeemers, datums: CML.PlutusDataList, costModels: CML.CostModels, usedLangs: CML.LanguageList): CML.ScriptDataHash | undefined =>
