 ...
 * @category Errors
 */
export class EncodeJsonStrToMetadatumError extends Data.TaggedError("EncodeJsonStrToMetadatumError")<{
  message?: string;
}> {}
 ...
 * @category Functions
 */
export const encodeJsonStrToMetadatum: (json: string, schema: CML.MetadataJsonSchema) => Effect.Effect<CML.TransactionMetadatum, EncodeJsonStrToMetadatumError> = Effect.fn(function* (json: string, schema: CML.MetadataJsonSchema) {
  return yield* Effect.try({
    try: () => CML.encode_json_str_to_metadatum(json, schema),
    catch: () => new EncodeJsonStrToMetadatumError({
 ...
 */
export const encodeJsonStrToMetadatumUnsafe = (json: string, schema: CML.MetadataJsonSchema): CML.TransactionMetadatum =>
