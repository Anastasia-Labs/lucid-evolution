 ...
 * @category Functions
 */
export const unsafeMakeDaedalusBootstrapWitness = (txBodyHash: CML.TransactionHash, addr: CML.ByronAddress, key: CML.LegacyDaedalusPrivateKey): CML.BootstrapWitness =>
