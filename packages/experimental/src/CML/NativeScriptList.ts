 ...
 * @category Methods
 */
export const free: (instance: CML.NativeScriptList) => Effect.Effect<void, NativeScriptListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.NativeScriptList, NativeScriptListError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.NativeScriptList =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.NativeScriptList) => Effect.Effect<number, NativeScriptListError> = Effect.fn(
  (instance: CML.NativeScriptList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.NativeScriptList, index: number) => Effect.Effect<CML.NativeScript, NativeScriptListError> = Effect.fn(
 ...
 * @category Methods
 */
export const add: (instance: CML.NativeScriptList, elem: CML.NativeScript) => Effect.Effect<void, NativeScriptListError> = Effect.fn(
