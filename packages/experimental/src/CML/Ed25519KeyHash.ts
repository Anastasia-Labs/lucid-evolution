...
export const toBech32 = Effect.fn(
  (instance: CML.Ed25519KeyHash, prefix: string): Effect.Effect<string, Ed25519KeyHashError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeToBech32 = (instance: CML.Ed25519KeyHash, prefix: string): string =>
...
export const toRawBytes = Effect.fn(
  (instance: CML.Ed25519KeyHash): Effect.Effect<Uint8Array, Ed25519KeyHashError> =>
    Effect.try({
