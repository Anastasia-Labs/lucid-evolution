 ...
 * @category Methods
 */
export const unsafeGet = (instance: CML.CommitteeColdCredentialList, index: number): CML.Credential =>
 ...
 * @category Methods
 */
export const unsafeAdd = (instance: CML.CommitteeColdCredentialList, elem: CML.Credential): void =>
