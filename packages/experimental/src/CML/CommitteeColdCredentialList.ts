 ...
 * @category Methods
 */
export const free: (instance: CML.CommitteeColdCredentialList) => Effect.Effect<void, CommitteeColdCredentialListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.CommitteeColdCredentialList, CommitteeColdCredentialListError> = Effect.fn(function* () {
 ...
 * @category Methods
 */
export const len: (instance: CML.CommitteeColdCredentialList) => Effect.Effect<number, CommitteeColdCredentialListError> = Effect.fn(
  (instance: CML.CommitteeColdCredentialList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.CommitteeColdCredentialList, index: number) => Effect.Effect<CML.Credential, CommitteeColdCredentialListError> = Effect.fn(
  (instance: CML.CommitteeColdCredentialList, index: number) =>
    Effect.try({
 ...
 * @category Methods
 */
export const add: (instance: CML.CommitteeColdCredentialList, elem: CML.Credential) => Effect.Effect<void, CommitteeColdCredentialListError> = Effect.fn(
