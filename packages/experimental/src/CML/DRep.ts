 ...
 * @category Methods
 */
export const free: (instance: CML.DRep) => Effect.Effect<void, DRepError> =
  Effect.fn((instance: CML.DRep) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
        new DRepError({
...
export const toCborBytes: (
  instance: CML.DRep,
) => Effect.Effect<Uint8Array, DRepError> = Effect.fn((instance: CML.DRep) =>
  Effect.try({
...
) => Effect.Effect<CML.DRep, DRepError> = Effect.fn(function* (
  cborBytes: Uint8Array,
) {
...
export const toCborHex: (
  instance: CML.DRep,
) => Effect.Effect<string, DRepError> = Effect.fn((instance: CML.DRep) =>
  Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.DRep) => Effect.Effect<string, DRepError> =
  Effect.fn((instance: CML.DRep) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.DRep) => Effect.Effect<any, DRepError> =
  Effect.fn((instance: CML.DRep) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.DRep, DRepError> =
 ...
 * @category Constructors
 */
export const newAlwaysAbstain: () => Effect.Effect<CML.DRep, DRepError> =
  Effect.fn(function* () {
    return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newAlwaysNoConfidence: () => Effect.Effect<CML.DRep, DRepError> =
  Effect.fn(function* () {
    return yield* Effect.try({
...
export const kind: (
  instance: CML.DRep,
) => Effect.Effect<CML.DRepKind, DRepError> = Effect.fn((instance: CML.DRep) =>
  Effect.try({
    try: () => instance.kind(),
    catch: () =>
      new DRepError({
...
export const asKey: (
  instance: CML.DRep,
) => Effect.Effect<CML.Ed25519KeyHash | undefined, DRepError> = Effect.fn(
  (instance: CML.DRep) =>
    Effect.try({
      try: () => instance.as_key(),
      catch: () =>
...
export const asScript: (
  instance: CML.DRep,
) => Effect.Effect<CML.ScriptHash | undefined, DRepError> = Effect.fn(
  (instance: CML.DRep) =>
    Effect.try({
