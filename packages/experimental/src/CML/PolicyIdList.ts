...
export const get = Effect.fn(
  (instance: CML.PolicyIdList, index: number): Effect.Effect<CML.ScriptHash, PolicyIdListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeGet = (instance: CML.PolicyIdList, index: number): CML.ScriptHash =>
...
export const add = Effect.fn(
  (instance: CML.PolicyIdList, elem: CML.ScriptHash): Effect.Effect<void, PolicyIdListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeAdd = (instance: CML.PolicyIdList, elem: CML.ScriptHash): void =>
