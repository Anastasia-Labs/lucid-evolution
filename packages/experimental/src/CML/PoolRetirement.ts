...
) => Effect.Effect<void, PoolRetirementError> = Effect.fn(
  (instance: CML.PoolRetirement) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.PoolRetirement,
) => Effect.Effect<Uint8Array, PoolRetirementError> = Effect.fn(
  (instance: CML.PoolRetirement) =>
    Effect.try({
...
) => Effect.Effect<CML.PoolRetirement, PoolRetirementError> = Effect.fn(
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.PoolRetirement => Effect.runSync(fromCborBytes(cborBytes));
...
export const toCborHex: (
  instance: CML.PoolRetirement,
) => Effect.Effect<string, PoolRetirementError> = Effect.fn(
  (instance: CML.PoolRetirement) =>
    Effect.try({
...
export const toJsValue: (
  instance: CML.PoolRetirement,
) => Effect.Effect<any, PoolRetirementError> = Effect.fn(
  (instance: CML.PoolRetirement) =>
    Effect.try({
...
export const pool: (
  instance: CML.PoolRetirement,
) => Effect.Effect<CML.Ed25519KeyHash, PoolRetirementError> = Effect.fn(
  (instance: CML.PoolRetirement) =>
    Effect.try({
      try: () => instance.pool(),
      catch: () =>
...
export const epoch: (
  instance: CML.PoolRetirement,
) => Effect.Effect<bigint, PoolRetirementError> = Effect.fn(
  (instance: CML.PoolRetirement) =>
    Effect.try({
      try: () => instance.epoch(),
      catch: () =>
...
export const _new: (
  ...
  function* (pool: CML.Ed25519KeyHash, epoch: bigint) {
    return yield* Effect.try({
...
export const _newUnsafe = (
  pool: CML.Ed25519KeyHash,
  epoch: bigint,
): CML.PoolRetirement => Effect.runSync(_new(pool, epoch));
