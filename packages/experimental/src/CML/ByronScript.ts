 ...
 * @category Methods
 */
export const free: (instance: CML.ByronScript) => Effect.Effect<void, ByronScriptError> = Effect.fn(
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.ByronScript, prefix: string) => Effect.Effect<string, ByronScriptError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const toBech32Unsafe = (instance: CML.ByronScript, prefix: string): string =>
 ...
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.ByronScript, ByronScriptError> = Effect.fn(function* (bech32Str: string) {
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.ByronScript) => Effect.Effect<Uint8Array, ByronScriptError> = Effect.fn(
  (instance: CML.ByronScript) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.ByronScript, ByronScriptError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.ByronScript) => Effect.Effect<string, ByronScriptError> = Effect.fn(
  (instance: CML.ByronScript) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.ByronScript, ByronScriptError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
