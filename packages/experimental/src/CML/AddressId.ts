 ...
 * @category Methods
 */
export const free: (instance: CML.AddressId) => Effect.Effect<void, AddressIdError> = Effect.fn(
 ...
 * @category Methods
 */
export const toBech32: (instance: CML.AddressId, prefix: string) => Effect.Effect<string, AddressIdError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const toBech32Unsafe = (instance: CML.AddressId, prefix: string): string =>
 ...
 */
export const fromBech32: (bech32Str: string) => Effect.Effect<CML.AddressId, AddressIdError> = Effect.fn(function* (bech32Str: string) {
  return yield* Effect.try({
    try: () => CML.AddressId.from_bech32(bech32Str),
    catch: () => new AddressIdError({
 ...
 * @category Methods
 */
export const toRawBytes: (instance: CML.AddressId) => Effect.Effect<Uint8Array, AddressIdError> = Effect.fn(
  (instance: CML.AddressId) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromRawBytes: (bytes: Uint8Array) => Effect.Effect<CML.AddressId, AddressIdError> = Effect.fn(function* (bytes: Uint8Array) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toHex: (instance: CML.AddressId) => Effect.Effect<string, AddressIdError> = Effect.fn(
  (instance: CML.AddressId) =>
    Effect.try({
      try: () => instance.to_hex(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromHex: (input: string) => Effect.Effect<CML.AddressId, AddressIdError> = Effect.fn(function* (input: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const _new: (addrType: CML.ByronAddrType, spendingData: CML.SpendingData, attrs: CML.AddrAttributes) => Effect.Effect<CML.AddressId, AddressIdError> = Effect.fn(function* (addrType: CML.ByronAddrType, spendingData: CML.SpendingData, attrs: CML.AddrAttributes) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (addrType: CML.ByronAddrType, spendingData: CML.SpendingData, attrs: CML.AddrAttributes): CML.AddressId =>
