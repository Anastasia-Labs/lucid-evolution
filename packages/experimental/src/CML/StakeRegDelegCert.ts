 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.StakeRegDelegCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.StakeRegDelegCert): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.StakeRegDelegCert): string =>
 ...
 * @category Methods
 */
export const unsafeStakeCredential = (instance: CML.StakeRegDelegCert): CML.Credential =>
 ...
 * @category Methods
 */
export const unsafePool = (instance: CML.StakeRegDelegCert): CML.Ed25519KeyHash =>
 ...
 * @category Constructors
 */
export const unsafe_new = (stakeCredential: CML.Credential, pool: CML.Ed25519KeyHash, deposit: bigint) =>
