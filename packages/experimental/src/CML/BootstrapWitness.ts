 ...
 * @category Methods
 */
export const free: (instance: CML.BootstrapWitness) => Effect.Effect<void, BootstrapWitnessError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.BootstrapWitness) => Effect.Effect<Uint8Array, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.BootstrapWitness) => Effect.Effect<Uint8Array, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.BootstrapWitness): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.BootstrapWitness, BootstrapWitnessError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.BootstrapWitness =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.BootstrapWitness) => Effect.Effect<string, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.BootstrapWitness) => Effect.Effect<string, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.BootstrapWitness): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.BootstrapWitness, BootstrapWitnessError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.BootstrapWitness) => Effect.Effect<string, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.BootstrapWitness) => Effect.Effect<any, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.BootstrapWitness, BootstrapWitnessError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const publicKey: (instance: CML.BootstrapWitness) => Effect.Effect<CML.PublicKey, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const publicKeyUnsafe = (instance: CML.BootstrapWitness): CML.PublicKey =>
 ...
 * @category Methods
 */
export const signature: (instance: CML.BootstrapWitness) => Effect.Effect<CML.Ed25519Signature, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const signatureUnsafe = (instance: CML.BootstrapWitness): CML.Ed25519Signature =>
 ...
 * @category Methods
 */
export const chainCode: (instance: CML.BootstrapWitness) => Effect.Effect<Uint8Array, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category Methods
 */
export const attributes: (instance: CML.BootstrapWitness) => Effect.Effect<CML.AddrAttributes, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const attributesUnsafe = (instance: CML.BootstrapWitness): CML.AddrAttributes =>
 ...
 * @category Constructors
 */
export const _new: (publicKey: CML.PublicKey, signature: CML.Ed25519Signature, chainCode: Uint8Array, attributes: CML.AddrAttributes) => Effect.Effect<CML.BootstrapWitness, BootstrapWitnessError> = Effect.fn(function* (publicKey: CML.PublicKey, signature: CML.Ed25519Signature, chainCode: Uint8Array, attributes: CML.AddrAttributes) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (publicKey: CML.PublicKey, signature: CML.Ed25519Signature, chainCode: Uint8Array, attributes: CML.AddrAttributes): CML.BootstrapWitness =>
 ...
 * @category Methods
 */
export const toAddress: (instance: CML.BootstrapWitness) => Effect.Effect<CML.AddressContent, BootstrapWitnessError> = Effect.fn(
  (instance: CML.BootstrapWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toAddressUnsafe = (instance: CML.BootstrapWitness): CML.AddressContent =>
