 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.ScriptInvalidBefore): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.ScriptInvalidBefore): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.ScriptInvalidBefore): string =>
 ...
 * @category Constructors
 */
export const unsafe_new = (before: bigint) =>
