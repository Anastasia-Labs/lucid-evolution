 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.HardForkInitiationAction): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.HardForkInitiationAction): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCborHex = (instance: CML.HardForkInitiationAction): string =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.HardForkInitiationAction): string =>
 ...
 * @category Methods
 */
export const unsafeActionId = (instance: CML.HardForkInitiationAction): CML.GovActionId | undefined =>
 ...
 * @category Methods
 */
export const unsafeVersion = (instance: CML.HardForkInitiationAction): CML.ProtocolVersion =>
 ...
 * @category Constructors
 */
export const unsafe_new = (actionId: CML.GovActionId | undefined, version: CML.ProtocolVersion) =>
