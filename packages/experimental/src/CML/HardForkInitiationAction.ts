 ...
 * @category Methods
 */
export const free: (instance: CML.HardForkInitiationAction) => Effect.Effect<void, HardForkInitiationActionError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.HardForkInitiationAction) => Effect.Effect<Uint8Array, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.HardForkInitiationAction) => Effect.Effect<Uint8Array, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.HardForkInitiationAction, HardForkInitiationActionError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.HardForkInitiationAction =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.HardForkInitiationAction) => Effect.Effect<string, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.HardForkInitiationAction) => Effect.Effect<string, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.HardForkInitiationAction, HardForkInitiationActionError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborHexUnsafe = (cborBytes: string): CML.HardForkInitiationAction =>
 ...
 * @category Methods
 */
export const toJson: (instance: CML.HardForkInitiationAction) => Effect.Effect<string, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.HardForkInitiationAction) => Effect.Effect<any, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.HardForkInitiationAction, HardForkInitiationActionError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const actionId: (instance: CML.HardForkInitiationAction) => Effect.Effect<CML.GovActionId | undefined, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 * @category Methods
 */
export const version: (instance: CML.HardForkInitiationAction) => Effect.Effect<CML.ProtocolVersion, HardForkInitiationActionError> = Effect.fn(
  (instance: CML.HardForkInitiationAction) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const _new: (actionId: CML.GovActionId | undefined, version: CML.ProtocolVersion) => Effect.Effect<CML.HardForkInitiationAction, HardForkInitiationActionError> = Effect.fn(function* (actionId: CML.GovActionId | undefined, version: CML.ProtocolVersion) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (actionId: CML.GovActionId | undefined, version: CML.ProtocolVersion): CML.HardForkInitiationAction =>
