 ...
 * @category Constructors
 */
export const unsafe_new = (networkId: number, protocolMagic: CML.ProtocolMagic) =>
 ...
 * @category Methods
 */
export const unsafeProtocolMagic = (instance: CML.NetworkInfo): CML.ProtocolMagic =>
 ...
 * @category Constructors
 */
export const unsafeSanchoTestnet = () =>
