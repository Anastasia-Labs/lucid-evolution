 ...
 * @category Methods
 */
export const free: (instance: CML.StakeDeregistration) => Effect.Effect<void, StakeDeregistrationError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.StakeDeregistration) => Effect.Effect<Uint8Array, StakeDeregistrationError> = Effect.fn(
  (instance: CML.StakeDeregistration) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.StakeDeregistration) => Effect.Effect<Uint8Array, StakeDeregistrationError> = Effect.fn(
  (instance: CML.StakeDeregistration) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.StakeDeregistration, StakeDeregistrationError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.StakeDeregistration =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.StakeDeregistration) => Effect.Effect<string, StakeDeregistrationError> = Effect.fn(
  (instance: CML.StakeDeregistration) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.StakeDeregistration) => Effect.Effect<string, StakeDeregistrationError> = Effect.fn(
  (instance: CML.StakeDeregistration) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.StakeDeregistration, StakeDeregistrationError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.StakeDeregistration) => Effect.Effect<string, StakeDeregistrationError> = Effect.fn(
  (instance: CML.StakeDeregistration) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.StakeDeregistration) => Effect.Effect<any, StakeDeregistrationError> = Effect.fn(
  (instance: CML.StakeDeregistration) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.StakeDeregistration, StakeDeregistrationError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const stakeCredential: (instance: CML.StakeDeregistration) => Effect.Effect<CML.Credential, StakeDeregistrationError> = Effect.fn(
  (instance: CML.StakeDeregistration) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const _new: (stakeCredential: CML.Credential) => Effect.Effect<CML.StakeDeregistration, StakeDeregistrationError> = Effect.fn(function* (stakeCredential: CML.Credential) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (stakeCredential: CML.Credential): CML.StakeDeregistration =>
