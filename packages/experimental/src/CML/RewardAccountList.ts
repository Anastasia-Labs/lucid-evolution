 ...
 * @category Methods
 */
export const free: (instance: CML.RewardAccountList) => Effect.Effect<void, RewardAccountListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.RewardAccountList, RewardAccountListError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.RewardAccountList =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.RewardAccountList) => Effect.Effect<number, RewardAccountListError> = Effect.fn(
  (instance: CML.RewardAccountList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.RewardAccountList, index: number) => Effect.Effect<CML.RewardAddress, RewardAccountListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const getUnsafe = (instance: CML.RewardAccountList, index: number): CML.RewardAddress =>
 ...
 * @category Methods
 */
export const add: (instance: CML.RewardAccountList, elem: CML.RewardAddress) => Effect.Effect<void, RewardAccountListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addUnsafe = (instance: CML.RewardAccountList, elem: CML.RewardAddress): void =>
