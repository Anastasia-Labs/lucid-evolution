 ...
 * @category Methods
 */
export const free: (instance: CML.VoteRegDelegCert) => Effect.Effect<void, VoteRegDelegCertError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.VoteRegDelegCert) => Effect.Effect<Uint8Array, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.VoteRegDelegCert) => Effect.Effect<Uint8Array, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.VoteRegDelegCert, VoteRegDelegCertError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.VoteRegDelegCert =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.VoteRegDelegCert) => Effect.Effect<string, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.VoteRegDelegCert) => Effect.Effect<string, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.VoteRegDelegCert, VoteRegDelegCertError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.VoteRegDelegCert) => Effect.Effect<string, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.VoteRegDelegCert) => Effect.Effect<any, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.VoteRegDelegCert, VoteRegDelegCertError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const stakeCredential: (instance: CML.VoteRegDelegCert) => Effect.Effect<CML.Credential, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 * @category Methods
 */
export const dRep: (instance: CML.VoteRegDelegCert) => Effect.Effect<CML.DRep, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
      try: () => instance.d_rep(),
      catch: () =>
 ...
 * @category Methods
 */
export const deposit: (instance: CML.VoteRegDelegCert) => Effect.Effect<bigint, VoteRegDelegCertError> = Effect.fn(
  (instance: CML.VoteRegDelegCert) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const _new: (stakeCredential: CML.Credential, dRep: CML.DRep, deposit: bigint) => Effect.Effect<CML.VoteRegDelegCert, VoteRegDelegCertError> = Effect.fn(function* (stakeCredential: CML.Credential, dRep: CML.DRep, deposit: bigint) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (stakeCredential: CML.Credential, dRep: CML.DRep, deposit: bigint): CML.VoteRegDelegCert =>
