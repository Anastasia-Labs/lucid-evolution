 ...
 * @category Methods
 */
export const unsafeUpdateExUnits = (instance: CML.RedeemerSetBuilder, key: CML.RedeemerWitnessKey, exUnits: CML.ExUnits): void =>
 ...
 * @category Methods
 */
export const unsafeAddSpend = (instance: CML.RedeemerSetBuilder, result: CML.InputBuilderResult): void =>
 ...
 * @category Methods
 */
export const unsafeAddMint = (instance: CML.RedeemerSetBuilder, result: CML.MintBuilderResult): void =>
 ...
 * @category Methods
 */
export const unsafeAddReward = (instance: CML.RedeemerSetBuilder, result: CML.WithdrawalBuilderResult): void =>
 ...
 * @category Methods
 */
export const unsafeAddCert = (instance: CML.RedeemerSetBuilder, result: CML.CertificateBuilderResult): void =>
 ...
 * @category Methods
 */
export const unsafeAddProposal = (instance: CML.RedeemerSetBuilder, result: CML.ProposalBuilderResult): void =>
 ...
 * @category Methods
 */
export const unsafeAddVote = (instance: CML.RedeemerSetBuilder, result: CML.VoteBuilderResult): void =>
 ...
 * @category Methods
 */
export const unsafeBuild = (instance: CML.RedeemerSetBuilder, defaultToDummyExunits: boolean): CML.Redeemers =>
