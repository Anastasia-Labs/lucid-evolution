 ...
 * @category Methods
 */
export const unsafeWithAddress = (instance: CML.TransactionOutputBuilder, address: CML.Address): CML.TransactionOutputBuilder =>
 ...
 * @category Methods
 */
export const unsafeWithCommunicationData = (instance: CML.TransactionOutputBuilder, datum: CML.PlutusData): CML.TransactionOutputBuilder =>
 ...
 * @category Methods
 */
export const unsafeWithData = (instance: CML.TransactionOutputBuilder, datum: CML.DatumOption): CML.TransactionOutputBuilder =>
 ...
 * @category Methods
 */
export const unsafeWithReferenceScript = (instance: CML.TransactionOutputBuilder, scriptRef: CML.Script): CML.TransactionOutputBuilder =>
 ...
 * @category Methods
 */
export const unsafeNext = (instance: CML.TransactionOutputBuilder): CML.TransactionOutputAmountBuilder =>
