 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionOutputBuilder) => Effect.Effect<void, TransactionOutputBuilderError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.TransactionOutputBuilder, TransactionOutputBuilderError> = Effect.fn(function* () {
 ...
 * @category Methods
 */
export const withAddress: (instance: CML.TransactionOutputBuilder, address: CML.Address) => Effect.Effect<CML.TransactionOutputBuilder, TransactionOutputBuilderError> = Effect.fn(
  (instance: CML.TransactionOutputBuilder, address: CML.Address) =>
    Effect.try({
 ...
 * @category Methods
 */
export const withCommunicationData: (instance: CML.TransactionOutputBuilder, datum: CML.PlutusData) => Effect.Effect<CML.TransactionOutputBuilder, TransactionOutputBuilderError> = Effect.fn(
  (instance: CML.TransactionOutputBuilder, datum: CML.PlutusData) =>
    Effect.try({
 ...
 * @category Methods
 */
export const withData: (instance: CML.TransactionOutputBuilder, datum: CML.DatumOption) => Effect.Effect<CML.TransactionOutputBuilder, TransactionOutputBuilderError> = Effect.fn(
 ...
 * @category Methods
 */
export const withReferenceScript: (instance: CML.TransactionOutputBuilder, scriptRef: CML.Script) => Effect.Effect<CML.TransactionOutputBuilder, TransactionOutputBuilderError> = Effect.fn(
  (instance: CML.TransactionOutputBuilder, scriptRef: CML.Script) =>
    Effect.try({
 ...
 * @category Methods
 */
export const next: (instance: CML.TransactionOutputBuilder) => Effect.Effect<CML.TransactionOutputAmountBuilder, TransactionOutputBuilderError> = Effect.fn(
  (instance: CML.TransactionOutputBuilder) =>
    Effect.try({
      try: () => instance.next(),
      catch: () =>
