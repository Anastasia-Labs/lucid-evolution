 ...
 * @category Errors
 */
export class SignedTxBuilderError extends Data.TaggedError("SignedTxBuilderError")<{
  message?: string;
}> {}
 ...
 * @category Methods
 */
export const free: (instance: CML.SignedTxBuilder) => Effect.Effect<void, SignedTxBuilderError> = Effect.fn(
 ...
 */
export const newWithData: (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean, auxiliaryData: CML.AuxiliaryData) => Effect.Effect<CML.SignedTxBuilder, SignedTxBuilderError> = Effect.fn(function* (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean, auxiliaryData: CML.AuxiliaryData) {
  return yield* Effect.try({
    try: () => CML.SignedTxBuilder.new_with_data(body, witnessSet, isValid, auxiliaryData),
    catch: () => new SignedTxBuilderError({
 ...
 */
export const newWithDataUnsafe = (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean, auxiliaryData: CML.AuxiliaryData): CML.SignedTxBuilder =>
 ...
 * @category Constructors
 */
export const newWithoutData: (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean) => Effect.Effect<CML.SignedTxBuilder, SignedTxBuilderError> = Effect.fn(function* (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newWithoutDataUnsafe = (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean): CML.SignedTxBuilder =>
 ...
 * @category Methods
 */
export const buildChecked: (instance: CML.SignedTxBuilder) => Effect.Effect<CML.Transaction, SignedTxBuilderError> = Effect.fn(
  (instance: CML.SignedTxBuilder) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const buildCheckedUnsafe = (instance: CML.SignedTxBuilder): CML.Transaction =>
  Effect.runSync(buildChecked(instance));
 ...
 * @category Methods
 */
export const buildUnchecked: (instance: CML.SignedTxBuilder) => Effect.Effect<CML.Transaction, SignedTxBuilderError> = Effect.fn(
  (instance: CML.SignedTxBuilder) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const buildUncheckedUnsafe = (instance: CML.SignedTxBuilder): CML.Transaction =>
  Effect.runSync(buildUnchecked(instance));
 ...
 * @category Methods
 */
export const addVkey: (instance: CML.SignedTxBuilder, vkey: CML.Vkeywitness) => Effect.Effect<void, SignedTxBuilderError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addVkeyUnsafe = (instance: CML.SignedTxBuilder, vkey: CML.Vkeywitness): void =>
  Effect.runSync(addVkey(instance, vkey));
 ...
 * @category Methods
 */
export const addBootstrap: (instance: CML.SignedTxBuilder, bootstrap: CML.BootstrapWitness) => Effect.Effect<void, SignedTxBuilderError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addBootstrapUnsafe = (instance: CML.SignedTxBuilder, bootstrap: CML.BootstrapWitness): void =>
 ...
 * @category Methods
 */
export const body: (instance: CML.SignedTxBuilder) => Effect.Effect<CML.TransactionBody, SignedTxBuilderError> = Effect.fn(
  (instance: CML.SignedTxBuilder) =>
    Effect.try({
      try: () => instance.body(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const bodyUnsafe = (instance: CML.SignedTxBuilder): CML.TransactionBody =>
 ...
 * @category Methods
 */
export const witnessSet: (instance: CML.SignedTxBuilder) => Effect.Effect<CML.TransactionWitnessSetBuilder, SignedTxBuilderError> = Effect.fn(
  (instance: CML.SignedTxBuilder) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const witnessSetUnsafe = (instance: CML.SignedTxBuilder): CML.TransactionWitnessSetBuilder =>
 ...
 * @category Methods
 */
export const isValid: (instance: CML.SignedTxBuilder) => Effect.Effect<boolean, SignedTxBuilderError> = Effect.fn(
  (instance: CML.SignedTxBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const auxiliaryData: (instance: CML.SignedTxBuilder) => Effect.Effect<CML.AuxiliaryData | undefined, SignedTxBuilderError> = Effect.fn(
  (instance: CML.SignedTxBuilder) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const auxiliaryDataUnsafe = (instance: CML.SignedTxBuilder): CML.AuxiliaryData | undefined =>
