 ...
 */
export const newWithData = Effect.fn(function* (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean, auxiliaryData: CML.AuxiliaryData) {
 ...
 */
export const newWithDataUnsafe = (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean, auxiliaryData: CML.AuxiliaryData) =>
 ...
 * @category Constructors
 */
export const newWithoutData = Effect.fn(function* (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newWithoutDataUnsafe = (body: CML.TransactionBody, witnessSet: CML.TransactionWitnessSetBuilder, isValid: boolean) =>
...
export const buildChecked = Effect.fn(
  (instance: CML.SignedTxBuilder): Effect.Effect<CML.Transaction, SignedTxBuilderError> =>
    Effect.try({
...
export const addVkey = Effect.fn(
  (instance: CML.SignedTxBuilder, vkey: CML.Vkeywitness): Effect.Effect<void, SignedTxBuilderError> =>
    Effect.try({
...
export const addBootstrap = Effect.fn(
  (instance: CML.SignedTxBuilder, bootstrap: CML.BootstrapWitness): Effect.Effect<void, SignedTxBuilderError> =>
    Effect.try({
...
export const body = Effect.fn(
  (instance: CML.SignedTxBuilder): Effect.Effect<CML.TransactionBody, SignedTxBuilderError> =>
    Effect.try({
      try: () => instance.body(),
      catch: () =>
        new SignedTxBuilderError({
...
export const witnessSet = Effect.fn(
  (instance: CML.SignedTxBuilder): Effect.Effect<CML.TransactionWitnessSetBuilder, SignedTxBuilderError> =>
    Effect.try({
...
export const isValid = Effect.fn(
  (instance: CML.SignedTxBuilder): Effect.Effect<boolean, SignedTxBuilderError> =>
    Effect.try({
...
export const auxiliaryData = Effect.fn(
  (instance: CML.SignedTxBuilder): Effect.Effect<CML.AuxiliaryData | undefined, SignedTxBuilderError> =>
    Effect.try({
