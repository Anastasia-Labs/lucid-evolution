 ...
 * @category Methods
 */
export const free: (instance: CML.TransactionUnspentOutput) => Effect.Effect<void, TransactionUnspentOutputError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.TransactionUnspentOutput) => Effect.Effect<Uint8Array, TransactionUnspentOutputError> = Effect.fn(
  (instance: CML.TransactionUnspentOutput) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.TransactionUnspentOutput, TransactionUnspentOutputError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.TransactionUnspentOutput =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.TransactionUnspentOutput) => Effect.Effect<string, TransactionUnspentOutputError> = Effect.fn(
  (instance: CML.TransactionUnspentOutput) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.TransactionUnspentOutput, TransactionUnspentOutputError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborHexUnsafe = (cborBytes: string): CML.TransactionUnspentOutput =>
 ...
 * @category Constructors
 */
export const _new: (input: CML.TransactionInput, output: CML.TransactionOutput) => Effect.Effect<CML.TransactionUnspentOutput, TransactionUnspentOutputError> = Effect.fn(function* (input: CML.TransactionInput, output: CML.TransactionOutput) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (input: CML.TransactionInput, output: CML.TransactionOutput): CML.TransactionUnspentOutput =>
 ...
 * @category Methods
 */
export const input: (instance: CML.TransactionUnspentOutput) => Effect.Effect<CML.TransactionInput, TransactionUnspentOutputError> = Effect.fn(
  (instance: CML.TransactionUnspentOutput) =>
    Effect.try({
      try: () => instance.input(),
      catch: () =>
 ...
 * @category Methods
 */
export const output: (instance: CML.TransactionUnspentOutput) => Effect.Effect<CML.TransactionOutput, TransactionUnspentOutputError> = Effect.fn(
  (instance: CML.TransactionUnspentOutput) =>
    Effect.try({
      try: () => instance.output(),
      catch: () =>
