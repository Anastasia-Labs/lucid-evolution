...
export const free = Effect.fn(
  (instance: CML.PlutusV3ScriptList): Effect.Effect<void, PlutusV3ScriptListError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const len = Effect.fn(
  (instance: CML.PlutusV3ScriptList): Effect.Effect<number, PlutusV3ScriptListError> =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
        new PlutusV3ScriptListError({
...
export const get = Effect.fn(
  (instance: CML.PlutusV3ScriptList, index: number): Effect.Effect<CML.PlutusV3Script, PlutusV3ScriptListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeGet = (instance: CML.PlutusV3ScriptList, index: number): CML.PlutusV3Script =>
...
export const add = Effect.fn(
  (instance: CML.PlutusV3ScriptList, elem: CML.PlutusV3Script): Effect.Effect<void, PlutusV3ScriptListError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeAdd = (instance: CML.PlutusV3ScriptList, elem: CML.PlutusV3Script): void =>
