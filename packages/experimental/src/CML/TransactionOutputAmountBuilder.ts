 ...
 * @category Methods
 */
export const unsafeFree = (instance: CML.TransactionOutputAmountBuilder): void =>
 ...
 * @category Methods
 */
export const unsafeWithValue = (instance: CML.TransactionOutputAmountBuilder, amount: CML.Value): CML.TransactionOutputAmountBuilder =>
 ...
 * @category Methods
 */
export const unsafeWithAssetAndMinRequiredCoin = (instance: CML.TransactionOutputAmountBuilder, multiasset: CML.MultiAsset, coinsPerUtxoByte: bigint): CML.TransactionOutputAmountBuilder =>
 ...
 * @category Methods
 */
export const unsafeBuild = (instance: CML.TransactionOutputAmountBuilder): CML.SingleOutputBuilderResult =>
