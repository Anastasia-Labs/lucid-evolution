 ...
 * @category Methods
 */
export const free: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<void, CIP36DelegationDistributionError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<Uint8Array, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborBytesUnsafe = (instance: CML.CIP36DelegationDistribution): Uint8Array =>
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<Uint8Array, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.CIP36DelegationDistribution): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.CIP36DelegationDistribution, CIP36DelegationDistributionError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.CIP36DelegationDistribution =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<string, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborHexUnsafe = (instance: CML.CIP36DelegationDistribution): string =>
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<string, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.CIP36DelegationDistribution): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.CIP36DelegationDistribution, CIP36DelegationDistributionError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborHexUnsafe = (cborBytes: string): CML.CIP36DelegationDistribution =>
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<string, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toJsonUnsafe = (instance: CML.CIP36DelegationDistribution): string =>
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<any, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toJsValueUnsafe = (instance: CML.CIP36DelegationDistribution): any =>
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP36DelegationDistribution, CIP36DelegationDistributionError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newWeighted: (delegations: CML.CIP36DelegationList) => Effect.Effect<CML.CIP36DelegationDistribution, CIP36DelegationDistributionError> = Effect.fn(function* (delegations: CML.CIP36DelegationList) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newWeightedUnsafe = (delegations: CML.CIP36DelegationList): CML.CIP36DelegationDistribution =>
 ...
 * @category Constructors
 */
export const newLegacy: (legacy: CML.PublicKey) => Effect.Effect<CML.CIP36DelegationDistribution, CIP36DelegationDistributionError> = Effect.fn(function* (legacy: CML.PublicKey) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newLegacyUnsafe = (legacy: CML.PublicKey): CML.CIP36DelegationDistribution =>
 ...
 * @category Methods
 */
export const kind: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<CML.DelegationDistributionKind, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category MethodsUnsafe
 */
export const kindUnsafe = (instance: CML.CIP36DelegationDistribution): CML.DelegationDistributionKind =>
 ...
 * @category Methods
 */
export const asWeighted: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<CML.CIP36DelegationList | undefined, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asWeightedUnsafe = (instance: CML.CIP36DelegationDistribution): CML.CIP36DelegationList | undefined =>
 ...
 * @category Methods
 */
export const asLegacy: (instance: CML.CIP36DelegationDistribution) => Effect.Effect<CML.PublicKey | undefined, CIP36DelegationDistributionError> = Effect.fn(
  (instance: CML.CIP36DelegationDistribution) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asLegacyUnsafe = (instance: CML.CIP36DelegationDistribution): CML.PublicKey | undefined =>
