 ...
 * @category Methods
 */
export const free: (instance: CML.SingleCertificateBuilder) => Effect.Effect<void, SingleCertificateBuilderError> = Effect.fn(
 ...
 */
export const _new: (cert: CML.Certificate) => Effect.Effect<CML.SingleCertificateBuilder, SingleCertificateBuilderError> = Effect.fn(function* (cert: CML.Certificate) {
 ...
 */
export const _newUnsafe = (cert: CML.Certificate): CML.SingleCertificateBuilder =>
 ...
 * @category Methods
 */
export const skipWitness: (instance: CML.SingleCertificateBuilder) => Effect.Effect<CML.CertificateBuilderResult, SingleCertificateBuilderError> = Effect.fn(
  (instance: CML.SingleCertificateBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const paymentKey: (instance: CML.SingleCertificateBuilder) => Effect.Effect<CML.CertificateBuilderResult, SingleCertificateBuilderError> = Effect.fn(
  (instance: CML.SingleCertificateBuilder) =>
    Effect.try({
 ...
 * @category Methods
 */
export const nativeScript: (instance: CML.SingleCertificateBuilder, _nativeScript: CML.NativeScript, witnessInfo: CML.NativeScriptWitnessInfo) => Effect.Effect<CML.CertificateBuilderResult, SingleCertificateBuilderError> = Effect.fn(
  (instance: CML.SingleCertificateBuilder, _nativeScript: CML.NativeScript, witnessInfo: CML.NativeScriptWitnessInfo) =>
    Effect.try({
 ...
 * @category Methods
 */
export const plutusScript: (instance: CML.SingleCertificateBuilder, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList) => Effect.Effect<CML.CertificateBuilderResult, SingleCertificateBuilderError> = Effect.fn(
  (instance: CML.SingleCertificateBuilder, partialWitness: CML.PartialPlutusWitness, requiredSigners: CML.Ed25519KeyHashList) =>
    Effect.try({
