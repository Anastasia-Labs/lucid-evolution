 ...
 * @category Methods
 */
export const free: (instance: CML.CIP25String64) => Effect.Effect<void, CIP25String64Error> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP25String64) => Effect.Effect<Uint8Array, CIP25String64Error> = Effect.fn(
  (instance: CML.CIP25String64) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.CIP25String64, CIP25String64Error> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.CIP25String64) => Effect.Effect<string, CIP25String64Error> = Effect.fn(
  (instance: CML.CIP25String64) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.CIP25String64, CIP25String64Error> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP25String64) => Effect.Effect<string, CIP25String64Error> = Effect.fn(
  (instance: CML.CIP25String64) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP25String64) => Effect.Effect<any, CIP25String64Error> = Effect.fn(
  (instance: CML.CIP25String64) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP25String64, CIP25String64Error> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const get: (instance: CML.CIP25String64) => Effect.Effect<string, CIP25String64Error> = Effect.fn(
  (instance: CML.CIP25String64) =>
    Effect.try({
      try: () => instance.get(),
      catch: () =>
 ...
 * @category Constructors
 */
export const _new: (s: string) => Effect.Effect<CML.CIP25String64, CIP25String64Error> = Effect.fn(function* (s: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toStr: (instance: CML.CIP25String64) => Effect.Effect<string, CIP25String64Error> = Effect.fn(
  (instance: CML.CIP25String64) =>
    Effect.try({
      try: () => instance.to_str(),
      catch: () =>
 ...
 * @category Methods
 */
export const getStr: (instance: CML.CIP25String64) => Effect.Effect<string, CIP25String64Error> = Effect.fn(
  (instance: CML.CIP25String64) =>
    Effect.try({
