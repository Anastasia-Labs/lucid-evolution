...
) => Effect.Effect<void, CIP25ChunkableStringError> = Effect.fn(
  (instance: CML.CIP25ChunkableString) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.CIP25ChunkableString,
) => Effect.Effect<Uint8Array, CIP25ChunkableStringError> = Effect.fn(
  (instance: CML.CIP25ChunkableString) =>
    Effect.try({
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.CIP25ChunkableString => Effect.runSync(fromCborBytes(cborBytes));
...
export const toCborHex: (
  instance: CML.CIP25ChunkableString,
) => Effect.Effect<string, CIP25ChunkableStringError> = Effect.fn(
  (instance: CML.CIP25ChunkableString) =>
    Effect.try({
...
export const fromCborHexUnsafe = (
  cborBytes: string,
): CML.CIP25ChunkableString => Effect.runSync(fromCborHex(cborBytes));
...
export const toJsValue: (
  instance: CML.CIP25ChunkableString,
) => Effect.Effect<any, CIP25ChunkableStringError> = Effect.fn(
  (instance: CML.CIP25ChunkableString) =>
    Effect.try({
...
export const newSingle: (
  ...
  Effect.fn(function* (single: CML.CIP25String64) {
    return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newSingleUnsafe = (
  single: CML.CIP25String64,
): CML.CIP25ChunkableString => Effect.runSync(newSingle(single));
 ...
 * @category Constructors
 */
export const newChunked: (
  chunked: CML.CIP25String64List,
) => Effect.Effect<CML.CIP25ChunkableString, CIP25ChunkableStringError> =
  Effect.fn(function* (chunked: CML.CIP25String64List) {
    return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newChunkedUnsafe = (
  chunked: CML.CIP25String64List,
): CML.CIP25ChunkableString => Effect.runSync(newChunked(chunked));
...
export const kind: (
  ...
  Effect.fn((instance: CML.CIP25ChunkableString) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
        new CIP25ChunkableStringError({
