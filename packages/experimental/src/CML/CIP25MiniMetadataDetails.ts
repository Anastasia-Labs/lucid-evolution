 ...
 * @category Methods
 */
export const free: (instance: CML.CIP25MiniMetadataDetails) => Effect.Effect<void, CIP25MiniMetadataDetailsError> = Effect.fn(
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP25MiniMetadataDetails) => Effect.Effect<string, CIP25MiniMetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MiniMetadataDetails) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP25MiniMetadataDetails) => Effect.Effect<any, CIP25MiniMetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MiniMetadataDetails) =>
    Effect.try({
 ...
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP25MiniMetadataDetails, CIP25MiniMetadataDetailsError> = Effect.fn(function* (json: string) {
 ...
 * @category Constructors
 */
export const _new: () => Effect.Effect<CML.CIP25MiniMetadataDetails, CIP25MiniMetadataDetailsError> = Effect.fn(function* () {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const setName: (instance: CML.CIP25MiniMetadataDetails, name: CML.CIP25String64) => Effect.Effect<void, CIP25MiniMetadataDetailsError> = Effect.fn(
 ...
 * @category Methods
 */
export const name: (instance: CML.CIP25MiniMetadataDetails) => Effect.Effect<CML.CIP25String64 | undefined, CIP25MiniMetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MiniMetadataDetails) =>
    Effect.try({
      try: () => instance.name(),
      catch: () =>
 ...
 * @category Methods
 */
export const setImage: (instance: CML.CIP25MiniMetadataDetails, image: CML.CIP25ChunkableString) => Effect.Effect<void, CIP25MiniMetadataDetailsError> = Effect.fn(
 ...
 * @category Methods
 */
export const image: (instance: CML.CIP25MiniMetadataDetails) => Effect.Effect<CML.CIP25ChunkableString | undefined, CIP25MiniMetadataDetailsError> = Effect.fn(
  (instance: CML.CIP25MiniMetadataDetails) =>
    Effect.try({
      try: () => instance.image(),
      catch: () =>
 ...
 * @category Constructors
 */
export const looseParse: (metadatum: CML.TransactionMetadatum) => Effect.Effect<CML.CIP25MiniMetadataDetails, CIP25MiniMetadataDetailsError> = Effect.fn(function* (metadatum: CML.TransactionMetadatum) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const looseParseUnsafe = (metadatum: CML.TransactionMetadatum): CML.CIP25MiniMetadataDetails =>
