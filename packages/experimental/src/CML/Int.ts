 ...
 * @category Methods
 */
export const free: (instance: CML.Int) => Effect.Effect<void, IntError> =
  Effect.fn((instance: CML.Int) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
        new IntError({
...
export const toCborBytes: (
  instance: CML.Int,
) => Effect.Effect<Uint8Array, IntError> = Effect.fn((instance: CML.Int) =>
  Effect.try({
...
) => Effect.Effect<CML.Int, IntError> = Effect.fn(function* (
  cborBytes: Uint8Array,
) {
 ...
 * @category Methods
 */
export const toJson: (instance: CML.Int) => Effect.Effect<string, IntError> =
  Effect.fn((instance: CML.Int) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsonValue: (instance: CML.Int) => Effect.Effect<any, IntError> =
  Effect.fn((instance: CML.Int) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.Int, IntError> =
 ...
 * @category Constructors
 */
export const _new: (x: bigint) => Effect.Effect<CML.Int, IntError> = Effect.fn(
  function* (x: bigint) {
    return yield* Effect.try({
      try: () => CML.Int.new(x),
      catch: () =>
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (x: bigint): CML.Int => Effect.runSync(_new(x));
 ...
 * @category Methods
 */
export const toStr: (instance: CML.Int) => Effect.Effect<string, IntError> =
  Effect.fn((instance: CML.Int) =>
    Effect.try({
      try: () => instance.to_str(),
      catch: () =>
 ...
 * @category Constructors
 */
export const fromStr: (string: string) => Effect.Effect<CML.Int, IntError> =
  Effect.fn(function* (string: string) {
    return yield* Effect.try({
