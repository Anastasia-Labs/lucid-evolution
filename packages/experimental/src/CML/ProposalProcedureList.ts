 ...
 * @category Methods
 */
export const free: (instance: CML.ProposalProcedureList) => Effect.Effect<void, ProposalProcedureListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.ProposalProcedureList, ProposalProcedureListError> = Effect.fn(function* () {
 ...
 * @category Methods
 */
export const len: (instance: CML.ProposalProcedureList) => Effect.Effect<number, ProposalProcedureListError> = Effect.fn(
  (instance: CML.ProposalProcedureList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.ProposalProcedureList, index: number) => Effect.Effect<CML.ProposalProcedure, ProposalProcedureListError> = Effect.fn(
  (instance: CML.ProposalProcedureList, index: number) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const getUnsafe = (instance: CML.ProposalProcedureList, index: number): CML.ProposalProcedure =>
 ...
 * @category Methods
 */
export const add: (instance: CML.ProposalProcedureList, elem: CML.ProposalProcedure) => Effect.Effect<void, ProposalProcedureListError> = Effect.fn(
 ...
 * @category MethodsUnsafe
 */
export const addUnsafe = (instance: CML.ProposalProcedureList, elem: CML.ProposalProcedure): void =>
