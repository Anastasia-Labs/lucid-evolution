 ...
 * @category Errors
 */
export class CIP36RegistrationWitnessError extends Data.TaggedError("CIP36RegistrationWitnessError")<{
  message?: string;
}> {}
 ...
 * @category Methods
 */
export const free: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<void, CIP36RegistrationWitnessError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<Uint8Array, CIP36RegistrationWitnessError> = Effect.fn(
  (instance: CML.CIP36RegistrationWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborBytesUnsafe = (instance: CML.CIP36RegistrationWitness): Uint8Array =>
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<Uint8Array, CIP36RegistrationWitnessError> = Effect.fn(
  (instance: CML.CIP36RegistrationWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.CIP36RegistrationWitness): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.CIP36RegistrationWitness, CIP36RegistrationWitnessError> = Effect.fn(function* (cborBytes: Uint8Array) {
  return yield* Effect.try({
    try: () => CML.CIP36RegistrationWitness.from_cbor_bytes(cborBytes),
    catch: () => new CIP36RegistrationWitnessError({
 ...
 */
export const fromCborBytesUnsafe = (cborBytes: Uint8Array): CML.CIP36RegistrationWitness =>
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<string, CIP36RegistrationWitnessError> = Effect.fn(
  (instance: CML.CIP36RegistrationWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCborHexUnsafe = (instance: CML.CIP36RegistrationWitness): string =>
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<string, CIP36RegistrationWitnessError> = Effect.fn(
  (instance: CML.CIP36RegistrationWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborHexUnsafe = (instance: CML.CIP36RegistrationWitness): string =>
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.CIP36RegistrationWitness, CIP36RegistrationWitnessError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const fromCborHexUnsafe = (cborBytes: string): CML.CIP36RegistrationWitness =>
 ...
 * @category Methods
 */
export const toJson: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<string, CIP36RegistrationWitnessError> = Effect.fn(
  (instance: CML.CIP36RegistrationWitness) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<any, CIP36RegistrationWitnessError> = Effect.fn(
  (instance: CML.CIP36RegistrationWitness) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.CIP36RegistrationWitness, CIP36RegistrationWitnessError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const stakeWitness: (instance: CML.CIP36RegistrationWitness) => Effect.Effect<CML.Ed25519Signature, CIP36RegistrationWitnessError> = Effect.fn(
  (instance: CML.CIP36RegistrationWitness) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const stakeWitnessUnsafe = (instance: CML.CIP36RegistrationWitness): CML.Ed25519Signature =>
 ...
 * @category Constructors
 */
export const _new: (stakeWitness: CML.Ed25519Signature) => Effect.Effect<CML.CIP36RegistrationWitness, CIP36RegistrationWitnessError> = Effect.fn(function* (stakeWitness: CML.Ed25519Signature) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (stakeWitness: CML.Ed25519Signature): CML.CIP36RegistrationWitness =>
