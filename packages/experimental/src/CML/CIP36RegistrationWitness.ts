...
export const free = Effect.fn(
  (instance: CML.CIP36RegistrationWitness): Effect.Effect<void, CIP36RegistrationWitnessError> =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes = Effect.fn(
  (instance: CML.CIP36RegistrationWitness): Effect.Effect<Uint8Array, CIP36RegistrationWitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.CIP36RegistrationWitness): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.CIP36RegistrationWitness): Uint8Array =>
...
export const toCborHex = Effect.fn(
  (instance: CML.CIP36RegistrationWitness): Effect.Effect<string, CIP36RegistrationWitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeToCborHex = (instance: CML.CIP36RegistrationWitness): string =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.CIP36RegistrationWitness): string =>
...
export const toJsValue = Effect.fn(
  (instance: CML.CIP36RegistrationWitness): Effect.Effect<any, CIP36RegistrationWitnessError> =>
    Effect.try({
...
export const stakeWitness = Effect.fn(
  (instance: CML.CIP36RegistrationWitness): Effect.Effect<CML.Ed25519Signature, CIP36RegistrationWitnessError> =>
    Effect.try({
 ...
 * @category Methods
 */
export const unsafeStakeWitness = (instance: CML.CIP36RegistrationWitness): CML.Ed25519Signature =>
