 ...
 * @category Methods
 */
export const free: (instance: CML.PoolParams) => Effect.Effect<void, PoolParamsError> = Effect.fn(
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.PoolParams) => Effect.Effect<Uint8Array, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.PoolParams) => Effect.Effect<Uint8Array, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.PoolParams, PoolParamsError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.PoolParams) => Effect.Effect<string, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.PoolParams) => Effect.Effect<string, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.PoolParams, PoolParamsError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.PoolParams) => Effect.Effect<string, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.PoolParams) => Effect.Effect<any, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.PoolParams, PoolParamsError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const operator: (instance: CML.PoolParams) => Effect.Effect<CML.Ed25519KeyHash, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Methods
 */
export const vrfKeyhash: (instance: CML.PoolParams) => Effect.Effect<CML.VRFKeyHash, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Methods
 */
export const pledge: (instance: CML.PoolParams) => Effect.Effect<bigint, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
      try: () => instance.pledge(),
      catch: () =>
 ...
 * @category Methods
 */
export const cost: (instance: CML.PoolParams) => Effect.Effect<bigint, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
      try: () => instance.cost(),
      catch: () =>
 ...
 * @category Methods
 */
export const margin: (instance: CML.PoolParams) => Effect.Effect<CML.UnitInterval, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
      try: () => instance.margin(),
      catch: () =>
 ...
 * @category Methods
 */
export const rewardAccount: (instance: CML.PoolParams) => Effect.Effect<CML.RewardAddress, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Methods
 */
export const poolOwners: (instance: CML.PoolParams) => Effect.Effect<CML.Ed25519KeyHashList, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Methods
 */
export const relays: (instance: CML.PoolParams) => Effect.Effect<CML.RelayList, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
      try: () => instance.relays(),
      catch: () =>
 ...
 * @category Methods
 */
export const poolMetadata: (instance: CML.PoolParams) => Effect.Effect<CML.PoolMetadata | undefined, PoolParamsError> = Effect.fn(
  (instance: CML.PoolParams) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const _new: (operator: CML.Ed25519KeyHash, vrfKeyhash: CML.VRFKeyHash, pledge: bigint, cost: bigint, margin: CML.UnitInterval, rewardAccount: CML.RewardAddress, poolOwners: CML.Ed25519KeyHashList, relays: CML.RelayList, poolMetadata: CML.PoolMetadata) => Effect.Effect<CML.PoolParams, PoolParamsError> = Effect.fn(function* (operator: CML.Ed25519KeyHash, vrfKeyhash: CML.VRFKeyHash, pledge: bigint, cost: bigint, margin: CML.UnitInterval, rewardAccount: CML.RewardAddress, poolOwners: CML.Ed25519KeyHashList, relays: CML.RelayList, poolMetadata: CML.PoolMetadata) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const _newUnsafe = (operator: CML.Ed25519KeyHash, vrfKeyhash: CML.VRFKeyHash, pledge: bigint, cost: bigint, margin: CML.UnitInterval, rewardAccount: CML.RewardAddress, poolOwners: CML.Ed25519KeyHashList, relays: CML.RelayList, poolMetadata: CML.PoolMetadata): CML.PoolParams =>
