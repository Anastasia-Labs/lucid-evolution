...
) => Effect.Effect<void, PoolVotingThresholdsError> = Effect.fn(
  (instance: CML.PoolVotingThresholds) =>
    Effect.try({
      try: () => instance.free(),
      catch: () =>
...
export const toCborBytes: (
  instance: CML.PoolVotingThresholds,
) => Effect.Effect<Uint8Array, PoolVotingThresholdsError> = Effect.fn(
  (instance: CML.PoolVotingThresholds) =>
    Effect.try({
...
export const fromCborBytesUnsafe = (
  cborBytes: Uint8Array,
): CML.PoolVotingThresholds => Effect.runSync(fromCborBytes(cborBytes));
...
export const toCborHex: (
  instance: CML.PoolVotingThresholds,
) => Effect.Effect<string, PoolVotingThresholdsError> = Effect.fn(
  (instance: CML.PoolVotingThresholds) =>
    Effect.try({
...
export const fromCborHexUnsafe = (
  cborBytes: string,
): CML.PoolVotingThresholds => Effect.runSync(fromCborHex(cborBytes));
...
export const toJsValue: (
  instance: CML.PoolVotingThresholds,
) => Effect.Effect<any, PoolVotingThresholdsError> = Effect.fn(
  (instance: CML.PoolVotingThresholds) =>
    Effect.try({
...
export const motionNoConfidence: (
  instance: CML.PoolVotingThresholds,
) => Effect.Effect<CML.UnitInterval, PoolVotingThresholdsError> = Effect.fn(
  (instance: CML.PoolVotingThresholds) =>
    Effect.try({
 ...
 * @category Methods
 */
export const securityRelevantParameterVotingThreshold: (
  instance: CML.PoolVotingThresholds,
) => Effect.Effect<CML.UnitInterval, PoolVotingThresholdsError> = Effect.fn(
  (instance: CML.PoolVotingThresholds) =>
    Effect.try({
