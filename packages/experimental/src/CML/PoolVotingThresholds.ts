 ...
 * @category Methods
 */
export const unsafeToCborBytes = (instance: CML.PoolVotingThresholds): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborBytes = (instance: CML.PoolVotingThresholds): Uint8Array =>
 ...
 * @category Methods
 */
export const unsafeToCanonicalCborHex = (instance: CML.PoolVotingThresholds): string =>
 ...
 * @category Methods
 */
export const unsafeMotionNoConfidence = (instance: CML.PoolVotingThresholds): CML.UnitInterval =>
 ...
 * @category Methods
 */
export const unsafeCommitteeNormal = (instance: CML.PoolVotingThresholds): CML.UnitInterval =>
 ...
 * @category Methods
 */
export const unsafeCommitteeNoConfidence = (instance: CML.PoolVotingThresholds): CML.UnitInterval =>
 ...
 * @category Methods
 */
export const unsafeHardForkInitiation = (instance: CML.PoolVotingThresholds): CML.UnitInterval =>
 ...
 * @category Methods
 */
export const unsafeSecurityRelevantParameterVotingThreshold = (instance: CML.PoolVotingThresholds): CML.UnitInterval =>
 ...
 * @category Constructors
 */
export const unsafe_new = (motionNoConfidence: CML.UnitInterval, committeeNormal: CML.UnitInterval, committeeNoConfidence: CML.UnitInterval, hardForkInitiation: CML.UnitInterval, securityRelevantParameterVotingThreshold: CML.UnitInterval) =>
