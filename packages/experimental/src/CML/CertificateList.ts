 ...
 * @category Methods
 */
export const free: (instance: CML.CertificateList) => Effect.Effect<void, CertificateListError> = Effect.fn(
 ...
 */
export const _new: () => Effect.Effect<CML.CertificateList, CertificateListError> = Effect.fn(function* () {
 ...
 */
export const _newUnsafe = (): CML.CertificateList =>
  Effect.runSync(_new());
 ...
 * @category Methods
 */
export const len: (instance: CML.CertificateList) => Effect.Effect<number, CertificateListError> = Effect.fn(
  (instance: CML.CertificateList) =>
    Effect.try({
      try: () => instance.len(),
      catch: () =>
 ...
 * @category Methods
 */
export const get: (instance: CML.CertificateList, index: number) => Effect.Effect<CML.Certificate, CertificateListError> = Effect.fn(
 ...
 * @category Methods
 */
export const add: (instance: CML.CertificateList, elem: CML.Certificate) => Effect.Effect<void, CertificateListError> = Effect.fn(
