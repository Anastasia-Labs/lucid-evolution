 ...
 * @category Methods
 */
export const free: (instance: CML.GovAction) => Effect.Effect<void, GovActionError> = Effect.fn(
 ...
 * @category Methods
 */
export const scriptHash: (instance: CML.GovAction) => Effect.Effect<CML.ScriptHash | undefined, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const scriptHashUnsafe = (instance: CML.GovAction): CML.ScriptHash | undefined =>
 ...
 * @category Methods
 */
export const toCborBytes: (instance: CML.GovAction) => Effect.Effect<Uint8Array, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborBytes: (instance: CML.GovAction) => Effect.Effect<Uint8Array, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const toCanonicalCborBytesUnsafe = (instance: CML.GovAction): Uint8Array =>
 ...
 */
export const fromCborBytes: (cborBytes: Uint8Array) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (cborBytes: Uint8Array) {
 ...
 * @category Methods
 */
export const toCborHex: (instance: CML.GovAction) => Effect.Effect<string, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toCanonicalCborHex: (instance: CML.GovAction) => Effect.Effect<string, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromCborHex: (cborBytes: string) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (cborBytes: string) {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const toJson: (instance: CML.GovAction) => Effect.Effect<string, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category Methods
 */
export const toJsValue: (instance: CML.GovAction) => Effect.Effect<any, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category Constructors
 */
export const fromJson: (json: string) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (json: string) {
  return yield* Effect.try({
 ...
 * @category Constructors
 */
export const newParameterChangeAction: (actionId: CML.GovActionId | undefined, update: CML.ProtocolParamUpdate, policyHash: CML.ScriptHash) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (actionId: CML.GovActionId | undefined, update: CML.ProtocolParamUpdate, policyHash: CML.ScriptHash) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newParameterChangeActionUnsafe = (actionId: CML.GovActionId | undefined, update: CML.ProtocolParamUpdate, policyHash: CML.ScriptHash): CML.GovAction =>
 ...
 * @category Constructors
 */
export const newHardForkInitiationAction: (actionId: CML.GovActionId | undefined, version: CML.ProtocolVersion) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (actionId: CML.GovActionId | undefined, version: CML.ProtocolVersion) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newHardForkInitiationActionUnsafe = (actionId: CML.GovActionId | undefined, version: CML.ProtocolVersion): CML.GovAction =>
 ...
 * @category Constructors
 */
export const newTreasuryWithdrawalsAction: (withdrawal: CML.MapRewardAccountToCoin, policyHash: CML.ScriptHash) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (withdrawal: CML.MapRewardAccountToCoin, policyHash: CML.ScriptHash) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newTreasuryWithdrawalsActionUnsafe = (withdrawal: CML.MapRewardAccountToCoin, policyHash: CML.ScriptHash): CML.GovAction =>
 ...
 * @category Constructors
 */
export const newNoConfidence: (actionId: CML.GovActionId) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (actionId: CML.GovActionId) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newNoConfidenceUnsafe = (actionId: CML.GovActionId): CML.GovAction =>
 ...
 * @category Constructors
 */
export const newUpdateCommittee: (actionId: CML.GovActionId | undefined, coldCredentials: CML.CommitteeColdCredentialList, credentials: CML.MapCommitteeColdCredentialToEpoch, unitInterval: CML.UnitInterval) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (actionId: CML.GovActionId | undefined, coldCredentials: CML.CommitteeColdCredentialList, credentials: CML.MapCommitteeColdCredentialToEpoch, unitInterval: CML.UnitInterval) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newUpdateCommitteeUnsafe = (actionId: CML.GovActionId | undefined, coldCredentials: CML.CommitteeColdCredentialList, credentials: CML.MapCommitteeColdCredentialToEpoch, unitInterval: CML.UnitInterval): CML.GovAction =>
 ...
 * @category Constructors
 */
export const newNewConstitution: (actionId: CML.GovActionId | undefined, constitution: CML.Constitution) => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* (actionId: CML.GovActionId | undefined, constitution: CML.Constitution) {
  return yield* Effect.try({
 ...
 * @category ConstructorsUnsafe
 */
export const newNewConstitutionUnsafe = (actionId: CML.GovActionId | undefined, constitution: CML.Constitution): CML.GovAction =>
 ...
 * @category Constructors
 */
export const newInfoAction: () => Effect.Effect<CML.GovAction, GovActionError> = Effect.fn(function* () {
  return yield* Effect.try({
 ...
 * @category Methods
 */
export const kind: (instance: CML.GovAction) => Effect.Effect<CML.GovActionKind, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
      try: () => instance.kind(),
      catch: () =>
 ...
 * @category Methods
 */
export const asParameterChangeAction: (instance: CML.GovAction) => Effect.Effect<CML.ParameterChangeAction | undefined, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asParameterChangeActionUnsafe = (instance: CML.GovAction): CML.ParameterChangeAction | undefined =>
 ...
 * @category Methods
 */
export const asHardForkInitiationAction: (instance: CML.GovAction) => Effect.Effect<CML.HardForkInitiationAction | undefined, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asHardForkInitiationActionUnsafe = (instance: CML.GovAction): CML.HardForkInitiationAction | undefined =>
 ...
 * @category Methods
 */
export const asTreasuryWithdrawalsAction: (instance: CML.GovAction) => Effect.Effect<CML.TreasuryWithdrawalsAction | undefined, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asTreasuryWithdrawalsActionUnsafe = (instance: CML.GovAction): CML.TreasuryWithdrawalsAction | undefined =>
 ...
 * @category Methods
 */
export const asNoConfidence: (instance: CML.GovAction) => Effect.Effect<CML.NoConfidence | undefined, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asNoConfidenceUnsafe = (instance: CML.GovAction): CML.NoConfidence | undefined =>
 ...
 * @category Methods
 */
export const asUpdateCommittee: (instance: CML.GovAction) => Effect.Effect<CML.UpdateCommittee | undefined, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asUpdateCommitteeUnsafe = (instance: CML.GovAction): CML.UpdateCommittee | undefined =>
 ...
 * @category Methods
 */
export const asNewConstitution: (instance: CML.GovAction) => Effect.Effect<CML.NewConstitution | undefined, GovActionError> = Effect.fn(
  (instance: CML.GovAction) =>
    Effect.try({
 ...
 * @category MethodsUnsafe
 */
export const asNewConstitutionUnsafe = (instance: CML.GovAction): CML.NewConstitution | undefined =>
