...
const Token = TSchema.Tuple([TSchema.ByteArray, TSchema.Integer, TSchema.Boolean])
...
assert(
  Data.isEqual(
    ...
    Data.mkConstr(0n, [Data.mkByte("deadbeef"), Data.mkByte("cafe"), Data.mkInt(1000n)])
  )
)
...
assert(Data.isEqual(spendEncoded, Data.mkConstr(1n, [Data.mkConstr(0n, [Data.mkByte("cafe0123"), Data.mkInt(500n)])])))
