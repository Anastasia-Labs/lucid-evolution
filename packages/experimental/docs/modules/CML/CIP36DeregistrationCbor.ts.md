...
```ts
export declare const fromJsonUnsafe: (json: string) => CML.CIP36DeregistrationCbor
```
...
) => Effect.Effect<CML.CIP36DeregistrationWitness, CIP36DeregistrationCborError>
```
...
```ts
export declare const free: (instance: CML.CIP36DeregistrationCbor) => Effect.Effect<void, CIP36DeregistrationCborError>
```
...
```ts
export declare const freeUnsafe: (instance: CML.CIP36DeregistrationCbor) => void
```
...
```ts
export declare const keyDeregistrationUnsafe: (instance: CML.CIP36DeregistrationCbor) => CML.CIP36KeyDeregistration
```
...
```ts
export declare const toJsValueUnsafe: (instance: CML.CIP36DeregistrationCbor) => any
```
...
```ts
export declare const toJsonUnsafe: (instance: CML.CIP36DeregistrationCbor) => string
```
