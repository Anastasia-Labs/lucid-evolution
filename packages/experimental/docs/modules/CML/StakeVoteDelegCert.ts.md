...
```ts
export declare const fromCborHex: (cborBytes: string) => Effect.Effect<CML.StakeVoteDelegCert, StakeVoteDelegCertError>
```
...
```ts
export declare const fromJson: (json: string) => Effect.Effect<CML.StakeVoteDelegCert, StakeVoteDelegCertError>
```
...
```ts
export declare const fromCborBytesUnsafe: (cborBytes: Uint8Array) => CML.StakeVoteDelegCert
```
...
```ts
export declare const fromCborHexUnsafe: (cborBytes: string) => CML.StakeVoteDelegCert
```
...
```ts
export declare const dRep: (instance: CML.StakeVoteDelegCert) => Effect.Effect<CML.DRep, StakeVoteDelegCertError>
```
...
```ts
export declare const free: (instance: CML.StakeVoteDelegCert) => Effect.Effect<void, StakeVoteDelegCertError>
```
...
```ts
export declare const toCborHex: (instance: CML.StakeVoteDelegCert) => Effect.Effect<string, StakeVoteDelegCertError>
```
...
```ts
export declare const toJsValue: (instance: CML.StakeVoteDelegCert) => Effect.Effect<any, StakeVoteDelegCertError>
```
...
```ts
export declare const toJson: (instance: CML.StakeVoteDelegCert) => Effect.Effect<string, StakeVoteDelegCertError>
```
...
```ts
export declare const poolUnsafe: (instance: CML.StakeVoteDelegCert) => CML.Ed25519KeyHash
```
...
```ts
export declare const stakeCredentialUnsafe: (instance: CML.StakeVoteDelegCert) => CML.Credential
```
...
```ts
export declare const toCanonicalCborBytesUnsafe: (instance: CML.StakeVoteDelegCert) => Uint8Array
```
...
```ts
export declare const toCanonicalCborHexUnsafe: (instance: CML.StakeVoteDelegCert) => string
```
...
```ts
export declare const toCborBytesUnsafe: (instance: CML.StakeVoteDelegCert) => Uint8Array
```
...
```ts
export declare const toCborHexUnsafe: (instance: CML.StakeVoteDelegCert) => string
```
