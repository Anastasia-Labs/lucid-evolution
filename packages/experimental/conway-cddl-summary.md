# Conway CDDL Module-to-CDDL Mapping

This section maps the TypeScript modules to their corresponding CDDL definitions for easier reference.

| TypeScript Module           | CDDL Definition                                       |
| --------------------------- | ----------------------------------------------------- |
| `Block`                     | `block`                                               |
| `Transaction`               | `transaction` ✅ Implemented (partial)                |
| `StakeRegistration`         | `stake_registration` ✅ Implemented                   |
| `StakeDeregistration`       | `stake_deregistration` ✅ Implemented                 |
| `StakeDelegation`           | `stake_delegation` ✅ Implemented                     |
| `PoolRegistration`          | `pool_registration` ✅ Implemented (partial)          |
| `PoolRetirement`            | `pool_retirement` ✅ Implemented                      |
| `RegCert`                   | `reg_cert` ✅ Implemented                             |
...
| `PlutusV1Script`            | `plutus_v1_script`                                    |
| `PlutusV2Script`            | `plutus_v2_script`                                    |
| `PlutusV3Script`            | `plutus_v3_script`                                    |
| `VotingProcedures`          | `voting_procedures`                                   |
| `ProposalProcedures`        | `proposal_procedures`                                 |
| `GovAction`                 | `gov_action`                                          |
| `Redeemers`                 | `redeemers`                                           |
| `TransactionWitnessSet`     | `transaction_witness_set`                             |
| `NativeScriptCDDL`          | Auxiliary module for native script CDDL handling      |
| `NativeScripts`             | Auxiliary module for managing native scripts          |
| `PoolParams`                | `pool_params`                                         |
| `TransactionInput`          | `transaction_input`                                   |
| `TransactionOutput`         | `transaction_output` ✅ Implemented                   |
| `ShelleyTransactionOutput`  | `shelley_transaction_output` ✅ Implemented           |
| `BabbageTransactionOutput`  | `babbage_transaction_output` ✅ Implemented (partial) |
| `DatumOption`               | `datum_option`                                        |
| `Data`                      | `data`                                                |
...
| `Relay`                     | `relay`                                               |
| `SingleHostAddr`            | `single_host_addr`                                    |
| `SingleHostName`            | `single_host_name`                                    |
| `MultiHostName`             | `multi_host_name`                                     |
| `PoolMetadata`              | `pool_metadata`                                       |
| `VKey`                      | `vkey` ✅ Implemented                                 |
| `VrfVKey`                   | `vrf_vkey` ✅ Implemented                             |
| `VrfCert`                   | `vrf_cert` ✅ Implemented                             |
| `OperationalCert`           | `operational_cert` ✅ Implemented                     |
...
| `GovActionId`               | `gov_action_id`                                       |
| `ProposalProcedure`         | `proposal_procedure`                                  |
| `ParameterChangeAction`     | `parameter_change_action`                             |
| `ProtocolParamUpdate`       | `protocol_param_update`                               |
...
| `NonnegativeInterval`       | `nonnegative_interval`                                |
| `PositiveInt`               | `positive_int`                                        |
| `CommitteeColdCredential`   | `committee_cold_credential`                           |
| `CommitteeHotCredential`    | `committee_hot_credential`                            |
